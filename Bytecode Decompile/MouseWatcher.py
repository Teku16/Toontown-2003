import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, DataNode, MouseWatcherGroup
...
class MouseWatcher(DataNode.DataNode, MouseWatcherGroup.MouseWatcherGroup, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_isOverRegion_ptrConstMouseWatcher(self):
        returnValue = libpanda._inPziw5cWJO(self.this)
        return returnValue

    def __overloaded_isOverRegion_ptrConstMouseWatcher_ptrConstLPoint2f(self, pos):
        returnValue = libpanda._inPziw5voLV(self.this, pos.this)
        return returnValue

    def __overloaded_isOverRegion_ptrConstMouseWatcher_float_float(self, x, y):
        returnValue = libpanda._inPziw5P62h(self.this, x, y)
        return returnValue

    def __overloaded_getOverRegion_ptrConstMouseWatcher(self):
    ...
    def __overloaded_getOverRegion_ptrConstMouseWatcher_ptrConstLPoint2f(self, pos):
    ...
    def __overloaded_getOverRegion_ptrConstMouseWatcher_float_float(self, x, y):
    ...
    def getOverRegion(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getOverRegion_ptrConstMouseWatcher()
        else:
            if numArgs == 1:
                import Point2
                if isinstance(_args[0], Point2.Point2):
                    return self.__overloaded_getOverRegion_ptrConstMouseWatcher_ptrConstLPoint2f(_args[0])
                else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            return self.__overloaded_getOverRegion_ptrConstMouseWatcher_float_float(_args[0], _args[1])
                        else:
    ...
    def isOverRegion(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_isOverRegion_ptrConstMouseWatcher()
        else:
            if numArgs == 1:
                import Point2
                if isinstance(_args[0], Point2.Point2):
                    return self.__overloaded_isOverRegion_ptrConstMouseWatcher_ptrConstLPoint2f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Point2.Point2> '
            else:
                if numArgs == 2:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            return self.__overloaded_isOverRegion_ptrConstMouseWatcher_float_float(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
