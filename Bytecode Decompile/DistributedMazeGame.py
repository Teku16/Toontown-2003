...
import FSM, State, Localizer, ToontownTimer, MazeGameGlobals, MazeData, MazeTreasure, Trajectory, RandomNumGen, MinigameAvatarScorePanel, MinigameGlobals
...
class DistributedMazeGame(DistributedMinigame):
    ...
    def onstage(self):
        ...
        self.goalBar = DirectWaitBar(parent=render2d, relief=SUNKEN, frameSize=(-0.35, 0.35, -0.15, 0.15), borderWidth=(0.02, 0.02), scale=0.42, pos=(0.84, 0, 0.5 - 0.28 * self.numPlayers + 0.05), barColor=(0, 0.7, 0, 1))
        self.goalBar.hide()
    ...
    def enterPlay(self):
        ...
        orthoDrive = OrthoDrive(self.TOON_SPEED, maxFrameMove=self.MAX_FRAME_MOVE, customCollisionCallback=self.__doMazeCollisions)
    ...
    def __spawnCameraTask(self):
        ...
        taskMgr.add(self.__cameraTask, self.CAMERA_TASK, priority=10)
