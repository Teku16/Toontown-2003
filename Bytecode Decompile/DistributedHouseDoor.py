...
import ToontownGlobals, DirectNotifyGlobal, FSM, DistributedDoor, ZoneUtil, Suit, DelayDelete, FADoorCodes, DoorTypes, ToontownDialog
    ...
    def enterClosing(self, ts):
        ...
        if hasattr(self, 'done'):
            ...
            if self.doorType == DoorTypes.EXT_STANDARD:
                ...
                whereTo = 'estate'
            request = {'loader': 'estateLoader', 'where': whereTo, 'how': 'doorIn', 'hoodId': ToontownGlobals.MyEstate, 'zoneId': zoneId, 'shardId': None, 'avId': -1, 'doorDoId': self.otherDoId}
