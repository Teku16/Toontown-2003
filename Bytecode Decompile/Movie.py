...
import PandaObject, MovieSOS, MovieHeal, MovieTrap, MovieLure, MovieSound, MovieThrow, MovieSquirt, MovieDrop, MovieSuitAttacks, MovieToonVictory, PlayByPlayText, BattleParticles, DelayDelete
from SuitBattleGlobals import *
import DirectNotifyGlobal, RewardPanel, whrandom, MovieUtil, Toon, ToontownDialog, copy, Localizer
...
class Movie(PandaObject.PandaObject):
    ...
    def playTutorialReward_1(self):
        self.tutRewardDialog_1 = ToontownDialog.ToontownDialog(text=Localizer.MovieTutorialReward1, command=self.playTutorialReward_2, style=ToontownDialog.Acknowledge, fadeScreen=None, pos=(0.65, 0, 0.5), scale=0.8)
        ...
        trackList += [Func(self.tutRewardDialog_1.show)]
    ...
    def playTutorialReward_2(self, value):
        ...
        self.tutRewardDialog_2 = ToontownDialog.ToontownDialog(text=Localizer.MovieTutorialReward2, command=self.playTutorialReward_3, style=ToontownDialog.Acknowledge, fadeScreen=None, pos=(0.65, 0, 0.5), scale=0.8)
        self.tutRewardDialog_2.hide()
        trackList = [
         Wait(1.0)]
        trackList += self.rewardPanel.getTrackIntervalList(toonbase.localToon, SQUIRT_TRACK, 0, 1)
        trackList += [Func(self.tutRewardDialog_2.show)]
    ...
    def __doToonAttacks(self):
        if base.config.GetBool('want-toon-attack-anims', 1):
            ...
            if len(ivals) == 0:
                ...
                return (
                 Track(ivals, name='toon-attacks'), Track(camIvals, name='toon-attacks-cam'))
        else:
            return (
             None, None)
        return
    ...
    def genAttackDicts(self, toons, suits, id0, tr0, le0, tg0, hp0, ac0, hpb0, kbb0, died0, id1, tr1, le1, tg1, hp1, ac1, hpb1, kbb1, died1, id2, tr2, le2, tg2, hp2, ac2, hpb2, kbb2, died2, id3, tr3, le3, tg3, hp3, ac3, hpb3, kbb3, died3, sid0, at0, stg0, dm0, sd0, sb0, st0, sid1, at1, stg1, dm1, sd1, sb1, st1, sid2, at2, stg2, dm2, sd2, sb2, st2, sid3, at3, stg3, dm3, sd3, sb3, st3):
        ...
        toonAttacks = (
         (
          id0, tr0, le0, tg0, hp0, ac0, hpb0, kbb0, died0), (id1, tr1, le1, tg1, hp1, ac1, hpb1, kbb1, died1), (id2, tr2, le2, tg2, hp2, ac2, hpb2, kbb2, died2), (id3, tr3, le3, tg3, hp3, ac3, hpb3, kbb3, died3))
