...
class LinearSinkForce(LinearDistanceForce.LinearDistanceForce, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLPoint3f___enum__FalloffType_float_float_bool(self, p, f, r, a, m):
    ...
    def __overloaded_constructor_ptrConstLinearSinkForce(self, copy):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], LinearSinkForce):
                    return self.__overloaded_constructor_ptrConstLinearSinkForce(_args[0])
                else:
