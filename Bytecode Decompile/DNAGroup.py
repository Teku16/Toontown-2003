import types, libtoontown, libtoontownDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, TypedReferenceCount, Namable
...
class DNAGroup(TypedReferenceCount.TypedReferenceCount, Namable.Namable, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstDNAGroup(self, group):
    ...
    def __overloaded_traverse_ptrDNAGroup_ptrNodePath_ptrDNAStorage(self, parent, store):
    ...
    def __overloaded_topLevelTraverse_ptrDNAGroup_ptrNodePath_ptrDNAStorage_int(self, parent, store, editing):
    ...
    def __overloaded_write_ptrConstDNAGroup_ptrOstream_ptrDNAStorage_int(self, out, store, indentLevel):
        returnValue = libtoontown._inPet4yzQ3X(self.this, out.this, store.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstDNAGroup_ptrOstream_ptrDNAStorage(self, out, store):
            ...
            if numArgs == 1:
                if isinstance(_args[0], types.StringType):
                    ...
                    if isinstance(_args[0], DNAGroup):
                        return self.__overloaded_constructor_ptrConstDNAGroup(_args[0])
                    else:
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                ...
                if isinstance(_args[1], DNAStorage.DNAStorage):
                    return self.__overloaded_write_ptrConstDNAGroup_ptrOstream_ptrDNAStorage(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    ...
                    if isinstance(_args[1], DNAStorage.DNAStorage):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_write_ptrConstDNAGroup_ptrOstream_ptrDNAStorage_int(_args[0], _args[1], _args[2])
                        else:
    ...
    def traverse(self, *_args):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], NodePath.NodePath):
                import DNAStorage
                if isinstance(_args[1], DNAStorage.DNAStorage):
                    return self.__overloaded_traverse_ptrDNAGroup_ptrNodePath_ptrDNAStorage(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <DNAStorage.DNAStorage> '
            else:
            ...
            if numArgs == 3:
                ...
                if isinstance(_args[0], NodePath.NodePath):
                    ...
                    if isinstance(_args[1], DNAStorage.DNAStorage):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_traverse_ptrDNAGroup_ptrNodePath_ptrDNAStorage_int(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <DNAStorage.DNAStorage> '
    ...
    def topLevelTraverse(self, *_args):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], NodePath.NodePath):
                import DNAStorage
                if isinstance(_args[1], DNAStorage.DNAStorage):
                    return self.__overloaded_topLevelTraverse_ptrDNAGroup_ptrNodePath_ptrDNAStorage(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <DNAStorage.DNAStorage> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath.NodePath> '
            ...
            if numArgs == 3:
                ...
                if isinstance(_args[0], NodePath.NodePath):
                    ...
                    if isinstance(_args[1], DNAStorage.DNAStorage):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_topLevelTraverse_ptrDNAGroup_ptrNodePath_ptrDNAStorage_int(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <DNAStorage.DNAStorage> '
