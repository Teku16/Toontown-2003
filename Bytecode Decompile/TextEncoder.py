...
class TextEncoder(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_upper_atomicstring(source):
        returnValue = libpandaexpress._inPJoxtt0pk(source)
        return returnValue

    __overloaded_upper_atomicstring = staticmethod(__overloaded_upper_atomicstring)

    def __overloaded_upper_atomicstring___enum__Encoding(source, encoding):
        returnValue = libpandaexpress._inPJoxtwe6q(source, encoding)
        return returnValue

    __overloaded_upper_atomicstring___enum__Encoding = staticmethod(__overloaded_upper_atomicstring___enum__Encoding)

    def __overloaded_lower_atomicstring(source):
        returnValue = libpandaexpress._inPJoxtiTMW(source)
        return returnValue

    __overloaded_lower_atomicstring = staticmethod(__overloaded_lower_atomicstring)

    def __overloaded_lower_atomicstring___enum__Encoding(source, encoding):
        returnValue = libpandaexpress._inPJoxt9Pec(source, encoding)
        return returnValue

    __overloaded_lower_atomicstring___enum__Encoding = staticmethod(__overloaded_lower_atomicstring___enum__Encoding)
    ...
    def __overloaded_setText_ptrTextEncoder_atomicstring(self, text):
        returnValue = libpandaexpress._inPJoxtNXzC(self.this, text)
        return returnValue

    def __overloaded_setText_ptrTextEncoder_atomicstring___enum__Encoding(self, text, encoding):
    ...
    def upper(*_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return TextEncoder.__overloaded_upper_atomicstring(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        return TextEncoder.__overloaded_upper_atomicstring___enum__Encoding(_args[0], _args[1])
                    else:
    ...
    def lower(*_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return TextEncoder.__overloaded_lower_atomicstring(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        return TextEncoder.__overloaded_lower_atomicstring___enum__Encoding(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
    ...
    def setText(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return self.__overloaded_setText_ptrTextEncoder_atomicstring(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setText_ptrTextEncoder_atomicstring___enum__Encoding(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
