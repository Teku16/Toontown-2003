...
class ConnectionWriter(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_send_ptrConnectionWriter_ptrConstDatagram_ptrConnection(self, datagram, connection):
        returnValue = libpanda._inP9ImM5_fV(self.this, datagram.this, connection.this)
        return returnValue

    def __overloaded_send_ptrConnectionWriter_ptrConstDatagram_ptrConnection_ptrConstNetAddress(self, datagram, connection, address):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], Datagram.Datagram):
                ...
                if isinstance(_args[1], Connection.Connection):
                    return self.__overloaded_send_ptrConnectionWriter_ptrConstDatagram_ptrConnection(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], Datagram.Datagram):
                    ...
                    if isinstance(_args[1], Connection.Connection):
                        ...
                        if isinstance(_args[2], NetAddress.NetAddress):
                            return self.__overloaded_send_ptrConnectionWriter_ptrConstDatagram_ptrConnection_ptrConstNetAddress(_args[0], _args[1], _args[2])
                        else:
