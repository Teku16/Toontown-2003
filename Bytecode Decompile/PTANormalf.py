import types, libpanda, libpandaDowncasts, FFIExternalObject, PointerToBaseRefCountObjvectorLVector3f
...
class PTANormalf(PointerToBaseRefCountObjvectorLVector3f.PointerToBaseRefCountObjvectorLVector3f, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstPTANormalf(self, copy):
        self.this = libpanda._inPUZN3tYAY(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_unsignedint_ptrConstLVector3f(self, n, value):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], PTANormalf):
                    return self.__overloaded_constructor_ptrConstPTANormalf(_args[0])
                else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], types.IntType):
                        ...
                        if isinstance(_args[1], Vec3.Vec3):
                            return self.__overloaded_constructor_unsignedint_ptrConstLVector3f(_args[0], _args[1])
                        else:
