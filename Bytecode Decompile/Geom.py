import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, DDrawable
...
class Geom(DDrawable.DDrawable, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_write_ptrConstGeom_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPMAKPC21S(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstGeom_ptrOstream(self, out):
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstGeom_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstGeom_ptrOstream_int(_args[0], _args[1])
                    else:
