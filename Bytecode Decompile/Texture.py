import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, ImageBuffer
...
class Texture(ImageBuffer.ImageBuffer, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_read_ptrTexture_ptrConstFilename_ptrConstFilename_int_int(self, fullpath, alphaFullpath, primaryFileNumChannels, alphaFileChannel):
        returnValue = libpanda._inPMAKPpATv(self.this, fullpath.this, alphaFullpath.this, primaryFileNumChannels, alphaFileChannel)
        return returnValue

    def __overloaded_read_ptrTexture_ptrConstFilename_ptrConstFilename_int(self, fullpath, alphaFullpath, primaryFileNumChannels):
        returnValue = libpanda._inPMAKPMdQT(self.this, fullpath.this, alphaFullpath.this, primaryFileNumChannels)
        return returnValue

    def __overloaded_read_ptrTexture_ptrConstFilename_ptrConstFilename(self, fullpath, alphaFullpath):
        returnValue = libpanda._inPMAKPDjPl(self.this, fullpath.this, alphaFullpath.this)
        return returnValue

    def __overloaded_read_ptrTexture_ptrConstFilename_int(self, fullpath, primaryFileNumChannels):
        returnValue = libpanda._inPMAKPtKjv(self.this, fullpath.this, primaryFileNumChannels)
        return returnValue

    def __overloaded_read_ptrTexture_ptrConstFilename(self, fullpath):
        returnValue = libpanda._inPMAKP3IDU(self.this, fullpath.this)
        return returnValue

    def __overloaded_write_ptrConstTexture_ptrConstFilename(self, fullpath):
        returnValue = libpanda._inPMAKPfjd6(self.this, fullpath.this)
        return returnValue

    def __overloaded_write_ptrConstTexture(self):
    ...
    def read(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Filename.Filename):
                return self.__overloaded_read_ptrTexture_ptrConstFilename(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Filename.Filename):
                    ...
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_read_ptrTexture_ptrConstFilename_int(_args[0], _args[1])
                    else:
                        if isinstance(_args[1], Filename.Filename):
                            return self.__overloaded_read_ptrTexture_ptrConstFilename_ptrConstFilename(_args[0], _args[1])
                        else:
                    ...
                    if isinstance(_args[0], Filename.Filename):
                        ...
                        if isinstance(_args[1], Filename.Filename):
                            if isinstance(_args[2], types.IntType):
                                return self.__overloaded_read_ptrTexture_ptrConstFilename_ptrConstFilename_int(_args[0], _args[1], _args[2])
                            else:
                            ...
                            if isinstance(_args[1], Filename.Filename):
                                if isinstance(_args[2], types.IntType):
                                    if isinstance(_args[3], types.IntType):
                                        return self.__overloaded_read_ptrTexture_ptrConstFilename_ptrConstFilename_int_int(_args[0], _args[1], _args[2], _args[3])
                                    else:
    ...
    def write(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_write_ptrConstTexture()
        else:
            if numArgs == 1:
                import Filename
                if isinstance(_args[0], Filename.Filename):
                    return self.__overloaded_write_ptrConstTexture_ptrConstFilename(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Filename.Filename> '
            else:
