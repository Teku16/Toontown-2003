...
class EventParameter(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstEventParameter(self, copy):
        self.this = libpandaexpress._inPekxouMqR(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstTypedReferenceCount(self, ptr):
        self.this = libpandaexpress._inPekxoqTUl(ptr.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_atomicstring(self, value):
        self.this = libpandaexpress._inPekxofaFB(value)
        self.userManagesMemory = 1

    def __overloaded_constructor_double(self, value):
        self.this = libpandaexpress._inPekxonJZK(value)
        self.userManagesMemory = 1

    def __overloaded_constructor_int(self, value):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                ...
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_constructor_int(_args[0])
                else:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        ...
                        if isinstance(_args[0], types.StringType):
                            ...
                            if isinstance(_args[0], TypedReferenceCount.TypedReferenceCount):
                                return self.__overloaded_constructor_ptrConstTypedReferenceCount(_args[0])
                            else:
                                if isinstance(_args[0], EventParameter):
                                    return self.__overloaded_constructor_ptrConstEventParameter(_args[0])
                                else:
