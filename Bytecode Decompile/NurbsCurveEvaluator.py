...
class NurbsCurveEvaluator(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setVertex_ptrNurbsCurveEvaluator_int_ptrConstLVecBase3f_float(self, i, vertex, weight):
        returnValue = libpanda._inPHc9WJSId(self.this, i, vertex.this, weight)
        return returnValue

    def __overloaded_setVertex_ptrNurbsCurveEvaluator_int_ptrConstLVecBase3f(self, i, vertex):
        returnValue = libpanda._inPHc9WQeoz(self.this, i, vertex.this)
        return returnValue

    def __overloaded_setVertex_ptrNurbsCurveEvaluator_int_ptrConstLVecBase4f(self, i, vertex):
    ...
    def __overloaded_setVertexSpace_ptrNurbsCurveEvaluator_int_ptrConstNodePath(self, i, space):
        returnValue = libpanda._inPHc9WweNU(self.this, i, space.this)
        return returnValue

    def __overloaded_setVertexSpace_ptrNurbsCurveEvaluator_int_atomicstring(self, i, space):
    ...
    def __overloaded_evaluate_ptrConstNurbsCurveEvaluator_ptrConstNodePath(self, relTo):
    ...
    def __overloaded_evaluate_ptrConstNurbsCurveEvaluator(self):
    ...
    def evaluate(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_evaluate_ptrConstNurbsCurveEvaluator()
        else:
            if numArgs == 1:
                import NodePath
                if isinstance(_args[0], NodePath.NodePath):
                    return self.__overloaded_evaluate_ptrConstNurbsCurveEvaluator_ptrConstNodePath(_args[0])
                else:
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], VBase4.VBase4):
                    return self.__overloaded_setVertex_ptrNurbsCurveEvaluator_int_ptrConstLVecBase4f(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase3.VBase3):
                        return self.__overloaded_setVertex_ptrNurbsCurveEvaluator_int_ptrConstLVecBase3f(_args[0], _args[1])
                    else:
                ...
                if isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], VBase3.VBase3):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setVertex_ptrNurbsCurveEvaluator_int_ptrConstLVecBase3f_float(_args[0], _args[1], _args[2])
                        else:
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], types.StringType):
                    return self.__overloaded_setVertexSpace_ptrNurbsCurveEvaluator_int_atomicstring(_args[0], _args[1])
                else:
                    if isinstance(_args[1], NodePath.NodePath):
                        return self.__overloaded_setVertexSpace_ptrNurbsCurveEvaluator_int_ptrConstNodePath(_args[0], _args[1])
                    else:
