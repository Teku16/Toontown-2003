...
class HprScaleLerpFunctor(LerpFunctor.LerpFunctor, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrNodePath_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(self, np, hstart, hend, sstart, send):
        self.this = libpanda._inPkJyo1FgG(np.this, hstart.this, hend.this, sstart.this, send.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(self, np, hstart, hend, sstart, send, wrt):
        self.this = libpanda._inPkJyoPeDL(np.this, hstart.this, hend.this, sstart.this, send.this, wrt.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float(self, np, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez):
        self.this = libpanda._inPkJyoMBe9(np.this, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float_ptrNodePath(self, np, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez, wrt):
                    ...
                    if isinstance(_args[2], VBase3.VBase3):
                        ...
                        if isinstance(_args[3], VBase3.VBase3):
                            ...
                            if isinstance(_args[4], VBase3.VBase3):
                                return self.__overloaded_constructor_ptrNodePath_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(_args[0], _args[1], _args[2], _args[3], _args[4])
                            else:
                            ...
                            if isinstance(_args[3], VBase3.VBase3):
                                ...
                                if isinstance(_args[4], VBase3.VBase3):
                                    ...
                                    if isinstance(_args[5], NodePath.NodePath):
                                        return self.__overloaded_constructor_ptrNodePath_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                                    else:
                                                            ...
                                                            if isinstance(_args[10], types.FloatType) or isinstance(_args[10], types.IntType):
                                                                if isinstance(_args[11], types.FloatType) or isinstance(_args[11], types.IntType):
                                                                    if isinstance(_args[12], types.FloatType) or isinstance(_args[12], types.IntType):
                                                                        return self.__overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8], _args[9], _args[10], _args[11], _args[12])
                                                                    else:
                                                                    ...
                                                                    if isinstance(_args[11], types.FloatType) or isinstance(_args[11], types.IntType):
                                                                        if isinstance(_args[12], types.FloatType) or isinstance(_args[12], types.IntType):
                                                                            ...
                                                                            if isinstance(_args[13], NodePath.NodePath):
                                                                                return self.__overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float_ptrNodePath(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8], _args[9], _args[10], _args[11], _args[12], _args[13])
                                                                            else:
