...
import DirectNotifyGlobal, Place, PandaObject, StateData, FSM, State, TownBattle, Suit, Elevator, ToontownGlobals, ToontownBattleGlobals
...
class SuitInterior(Place.Place):
    ...
    def enter(self, requestStatus):
        ...
        self.__zoneId = requestStatus['zoneId']
