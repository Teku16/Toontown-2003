...
class DirectOptionMenu(DirectButton):
    ...
    def __init__(self, parent=aspect2d, **kw):
        optiondefs = (
         (
          'items', [], self.setItems), ('initialitem', None, INITOPT), ('popupMarkerBorder', (0.1, 0.1), None), ('highlightColor', (0.5, 0.5, 0.5, 1), None), ('text_align', TextNode.ALeft, None), ('pressEffect', 0, INITOPT))
        self.defineoptions(kw, optiondefs)
        DirectButton.__init__(self, parent)
        self.initFrameSize = self['frameSize']
        self.popupMarker = self.createcomponent('popupMarker', (), None, DirectFrame, (self,), frameSize=(-0.5, 0.5, -0.2, 0.2), scale=0.4, relief=RAISED)
