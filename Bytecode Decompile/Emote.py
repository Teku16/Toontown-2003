...
def doYes(toon):
    ...
    for lod in toon.getLODNames():
        ...
        track = Sequence(LerpHprInterval(h, 0.1, Vec3(0, -30, 0)), LerpHprInterval(h, 0.15, Vec3(0, 20, 0)), LerpHprInterval(h, 0.15, Vec3(0, -20, 0)), LerpHprInterval(h, 0.15, Vec3(0, 20, 0)), LerpHprInterval(h, 0.15, Vec3(0, -20, 0)), LerpHprInterval(h, 0.15, Vec3(0, 20, 0)), LerpHprInterval(h, 0.1, Vec3(0, 0, 0)))
        tracks.append(track)
...
def doNo(toon):
    ...
    for lod in toon.getLODNames():
        h = toon.getPart('head', lod)
        track = Sequence(LerpHprInterval(h, 0.1, Vec3(40, 0, 0)), LerpHprInterval(h, 0.15, Vec3(-40, 0, 0)), LerpHprInterval(h, 0.15, Vec3(40, 0, 0)), LerpHprInterval(h, 0.15, Vec3(-40, 0, 0)), LerpHprInterval(h, 0.15, Vec3(20, 0, 0)), LerpHprInterval(h, 0.15, Vec3(-20, 0, 0)), LerpHprInterval(h, 0.1, Vec3(0, 0, 0)))
        tracks.append(track)
...
EmoteFunc = [
 [
  doWave, 0], [doHappy, 0], [doSad, 0], [doAnnoyed, 0], [doSleep, 0], [doShrug, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doNothing, 0], [doYes, 0], [doNo, 0], [doOk, 0]]
BodyEmotes = [
 0, 1, 2, 3, 4, 5]
HeadEmotes = [
 17, 18, 19]
