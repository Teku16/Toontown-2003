...
import ToontownGlobals, cPickle, ToonInterior, DirectNotifyGlobal, FSM, DistributedObject, State, DNADoor, random, ToonInteriorColors, ZoneUtil, AvatarDNA, ToonHead
SIGN_LEFT = -4
SIGN_RIGHT = 4
SIGN_BOTTOM = -3.5
SIGN_TOP = 1.5
