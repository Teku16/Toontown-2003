import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, PiecewiseCurve, NurbsCurveInterface
...
class NurbsCurve(PiecewiseCurve.PiecewiseCurve, NurbsCurveInterface.NurbsCurveInterface, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_calcLength_ptrConstParametricCurve(self):
        upcastSelf = self
        returnValue = libpanda._inPHc9WbQeF(upcastSelf.this)
        return returnValue

    def __overloaded_calcLength_ptrConstParametricCurve_float_float(self, _from, to):
        upcastSelf = self
    ...
    def __overloaded_writeEgg_ptrParametricCurve_ptrFilename___enum__CoordinateSystem(self, filename, cs):
        upcastSelf = self
        returnValue = libpanda._inPHc9W_qGa(upcastSelf.this, filename.this, cs)
        return returnValue

    def __overloaded_writeEgg_ptrParametricCurve_ptrFilename(self, filename):
        upcastSelf = self
        returnValue = libpanda._inPHc9Wx_vA(upcastSelf.this, filename.this)
        return returnValue

    def __overloaded_writeEgg_ptrParametricCurve_ptrOstream_ptrConstFilename___enum__CoordinateSystem(self, out, filename, cs):
        upcastSelf = self
    ...
    def writeEgg(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Filename.Filename):
                return self.__overloaded_writeEgg_ptrParametricCurve_ptrFilename(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Filename.Filename):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_writeEgg_ptrParametricCurve_ptrFilename___enum__CoordinateSystem(_args[0], _args[1])
                    else:
                    ...
                    if isinstance(_args[0], Ostream.Ostream):
                        ...
                        if isinstance(_args[1], Filename.Filename):
                            if isinstance(_args[2], types.IntType):
                                return self.__overloaded_writeEgg_ptrParametricCurve_ptrOstream_ptrConstFilename___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                            else:
    ...
    def calcLength(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_calcLength_ptrConstParametricCurve()
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_calcLength_ptrConstParametricCurve_float_float(_args[0], _args[1])
                    else:
