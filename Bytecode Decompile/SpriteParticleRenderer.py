...
class SpriteParticleRenderer(BaseParticleRenderer.BaseParticleRenderer, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstSpriteParticleRenderer(self, copy):
        self.this = libpandaphysics._inPKBUAQL04(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrTexture(self, tex):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                ...
                if isinstance(_args[0], Texture.Texture):
                    return self.__overloaded_constructor_ptrTexture(_args[0])
                else:
                    if isinstance(_args[0], SpriteParticleRenderer):
                        return self.__overloaded_constructor_ptrConstSpriteParticleRenderer(_args[0])
                    else:
