...
class DriveInterface(DataNode.DataNode, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setPos_ptrDriveInterface_ptrConstLVecBase3f(self, vec):
        returnValue = libpanda._inPziw5Dmwj(self.this, vec.this)
        return returnValue

    def __overloaded_setPos_ptrDriveInterface_float_float_float(self, x, y, z):
    ...
    def __overloaded_setHpr_ptrDriveInterface_ptrConstLVecBase3f(self, hpr):
        returnValue = libpanda._inPziw5Ecoy(self.this, hpr.this)
        return returnValue

    def __overloaded_setHpr_ptrDriveInterface_float_float_float(self, h, p, r):
    ...
    def setPos(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase3.VBase3):
                return self.__overloaded_setPos_ptrDriveInterface_ptrConstLVecBase3f(_args[0])
            else:
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setPos_ptrDriveInterface_float_float_float(_args[0], _args[1], _args[2])
                        else:
    ...
    def setHpr(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return self.__overloaded_setHpr_ptrDriveInterface_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
        else:
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setHpr_ptrDriveInterface_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
