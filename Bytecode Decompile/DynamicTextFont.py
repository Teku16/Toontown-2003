...
class DynamicTextFont(TextFont.TextFont, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstFilename_int(self, fontFilename, faceIndex):
        self.this = libpanda._inPmUk_NkXk(fontFilename.this, faceIndex)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstFilename(self, fontFilename):
        self.this = libpanda._inPmUk_jio2(fontFilename.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_atomicstring_int_int(self, fontData, dataLength, faceIndex):
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Filename.Filename):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_constructor_ptrConstFilename_int(_args[0], _args[1])
                    else:
                    ...
                    if isinstance(_args[0], types.StringType):
                        if isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.IntType):
                                return self.__overloaded_constructor_atomicstring_int_int(_args[0], _args[1], _args[2])
                            else:
