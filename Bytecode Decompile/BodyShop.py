...
import whrandom, random, Localizer, DirectNotifyGlobal
...
class BodyShop(PandaObject.PandaObject, StateData.StateData):
    ...
    def load(self):
        ...
        self.headLButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image_scale=(-1, 1, 1), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), pos=(-0.9, 0, 0.3), text=Localizer.BodyShopHead, text_scale=0.0625, text_pos=(0.025, 0), text_fg=(0.8, 0.1, 0, 1), command=self.__swapHead, extraArgs=[-1])
        self.headRButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text=Localizer.BodyShopHead, text_scale=0.0625, text_pos=(-0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=(0, 0, 0.3), command=self.__swapHead, extraArgs=[1])
        self.torsoLButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image_scale=(-1, 1, 1), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text=Localizer.BodyShopBody, text_scale=0.0625, text_pos=(0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=(-0.9, 0, -0.1), command=self.__swapTorso, extraArgs=[-1])
        self.torsoRButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text=Localizer.BodyShopBody, text_scale=0.0625, text_pos=(-0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=(0, 0, -0.1), command=self.__swapTorso, extraArgs=[1])
        self.legLButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image_scale=(-1, 1, 1), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text=Localizer.BodyShopLegs, text_scale=0.0625, text_pos=(0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=(-0.9, 0, -0.5), command=self.__swapLegs, extraArgs=[-1])
        self.legRButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text=Localizer.BodyShopLegs, text_scale=0.0625, text_pos=(-0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=(0, 0, -0.5), command=self.__swapLegs, extraArgs=[1])
        self.headLButton.hide()
        self.headRButton.hide()
        self.torsoLButton.hide()
        self.torsoRButton.hide()
