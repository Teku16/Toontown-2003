...
class MouseWatcherRegion(TypedReferenceCount.TypedReferenceCount, Namable.Namable, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_atomicstring_ptrConstLVecBase4f(self, name, frame):
        self.this = libpanda._inPziw5XN0b(name, frame.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_atomicstring_float_float_float_float(self, name, left, right, bottom, top):
    ...
    def __overloaded_setFrame_ptrMouseWatcherRegion_ptrConstLVecBase4f(self, frame):
        returnValue = libpanda._inPziw5uRlo(self.this, frame.this)
        return returnValue

    def __overloaded_setFrame_ptrMouseWatcherRegion_float_float_float_float(self, left, right, bottom, top):
    ...
    def __overloaded_write_ptrConstMouseWatcherRegion_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPziw5ijOS(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstMouseWatcherRegion_ptrOstream(self, out):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.StringType):
                ...
                if isinstance(_args[1], VBase4.VBase4):
                    return self.__overloaded_constructor_atomicstring_ptrConstLVecBase4f(_args[0], _args[1])
                else:
                        ...
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                    return self.__overloaded_constructor_atomicstring_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4])
                                else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstMouseWatcherRegion_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstMouseWatcherRegion_ptrOstream_int(_args[0], _args[1])
                    else:
    ...
    def setFrame(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setFrame_ptrMouseWatcherRegion_ptrConstLVecBase4f(_args[0])
            else:
            ...
            if numArgs == 4:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setFrame_ptrMouseWatcherRegion_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
                                raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
