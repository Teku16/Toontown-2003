...
donaldSteerTrack = Track([donaldSteerInterval, donaldLoopInterval], name='steerTrack')
...
mtrack = MultiTrack([boatTrack, dockTrack, soundTrack, soundTrack2, waterEventTrack, donaldSteerTrack])
print mtrack
...
t1 = Track([(0.0, i1), (2.0, i2), (4.0, i3), (5.0, i4), (6.0, i5), (7.0, i4), (8.0, i6)], name='demo')
print t1
startTime = 0.0
...
t2 = Track([(0.0, i1), (1.0, i2, TRACK_START), (2.0, i3, PREVIOUS_END), (1.0, i4, PREVIOUS_END), (3.0, i5, PREVIOUS_START), (10.0, i6, TRACK_START), (12.0, i7)], name='startTimeDemo')
print t2
