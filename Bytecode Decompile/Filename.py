...
class Filename(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstFilename(self, copy):
        self.this = libpandaexpress._inPJoxt0xIC(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstFilename_ptrConstFilename(self, dirname, basename):
        self.this = libpandaexpress._inPJoxtw3ik(dirname.this, basename.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_atomicstring(self, filename):
    ...
    def __overloaded_fromOsSpecific_atomicstring___enum__Type(osSpecific, type):
    ...
    __overloaded_fromOsSpecific_atomicstring___enum__Type = staticmethod(__overloaded_fromOsSpecific_atomicstring___enum__Type)

    def __overloaded_fromOsSpecific_atomicstring(osSpecific):
    ...
    __overloaded_fromOsSpecific_atomicstring = staticmethod(__overloaded_fromOsSpecific_atomicstring)

    def __overloaded_expandFrom_atomicstring___enum__Type(userString, type):
    ...
    __overloaded_expandFrom_atomicstring___enum__Type = staticmethod(__overloaded_expandFrom_atomicstring___enum__Type)

    def __overloaded_expandFrom_atomicstring(userString):
    ...
    __overloaded_expandFrom_atomicstring = staticmethod(__overloaded_expandFrom_atomicstring)

    def __overloaded_temporary_atomicstring_atomicstring___enum__Type(dirname, prefix, type):
    ...
    __overloaded_temporary_atomicstring_atomicstring___enum__Type = staticmethod(__overloaded_temporary_atomicstring_atomicstring___enum__Type)

    def __overloaded_temporary_atomicstring_atomicstring(dirname, prefix):
    ...
    __overloaded_temporary_atomicstring_atomicstring = staticmethod(__overloaded_temporary_atomicstring_atomicstring)

    def __overloaded_assign_ptrFilename_ptrConstFilename(self, copy):
    ...
    def __overloaded_assign_ptrFilename_atomicstring(self, filename):
    ...
    def __overloaded_makeAbsolute_ptrFilename(self):
        returnValue = libpandaexpress._inPJoxt_eKM(self.this)
        return returnValue

    def __overloaded_makeAbsolute_ptrFilename_ptrConstFilename(self, startDirectory):
    ...
    def __overloaded_compareTimestamps_ptrConstFilename_ptrConstFilename_bool_bool(self, other, thisMissingIsOld, otherMissingIsOld):
        returnValue = libpandaexpress._inPJoxtQRcf(self.this, other.this, thisMissingIsOld, otherMissingIsOld)
        return returnValue

    def __overloaded_compareTimestamps_ptrConstFilename_ptrConstFilename_bool(self, other, thisMissingIsOld):
        returnValue = libpandaexpress._inPJoxtjhlq(self.this, other.this, thisMissingIsOld)
        return returnValue

    def __overloaded_compareTimestamps_ptrConstFilename_ptrConstFilename(self, other):
        returnValue = libpandaexpress._inPJoxtwwx_(self.this, other.this)
        return returnValue

    def __overloaded_resolveFilename_ptrFilename_ptrConstDSearchPath_atomicstring(self, searchpath, defaultExtension):
        returnValue = libpandaexpress._inPJoxtKd7B(self.this, searchpath.this, defaultExtension)
        return returnValue

    def __overloaded_resolveFilename_ptrFilename_ptrConstDSearchPath(self, searchpath):
        returnValue = libpandaexpress._inPJoxtk2zY(self.this, searchpath.this)
        return returnValue

    def __overloaded_makeRelativeTo_ptrFilename_ptrFilename_bool(self, directory, allowBackups):
        returnValue = libpandaexpress._inPJoxteEHg(self.this, directory.this, allowBackups)
        return returnValue

    def __overloaded_makeRelativeTo_ptrFilename_ptrFilename(self, directory):
    ...
    def __overloaded_openWrite_ptrConstFilename_ptrOfstream_bool(self, stream, truncate):
        returnValue = libpandaexpress._inPJoxtqfrI(self.this, stream.this, truncate)
        return returnValue

    def __overloaded_openWrite_ptrConstFilename_ptrOfstream(self, stream):
    ...
    def fromOsSpecific(*_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return Filename.__overloaded_fromOsSpecific_atomicstring(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        return Filename.__overloaded_fromOsSpecific_atomicstring___enum__Type(_args[0], _args[1])
                    else:
    ...
    def expandFrom(*_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return Filename.__overloaded_expandFrom_atomicstring(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        return Filename.__overloaded_expandFrom_atomicstring___enum__Type(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.StringType):
                if isinstance(_args[1], types.StringType):
                    return Filename.__overloaded_temporary_atomicstring_atomicstring(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.StringType):
                        if isinstance(_args[2], types.IntType):
                            return Filename.__overloaded_temporary_atomicstring_atomicstring___enum__Type(_args[0], _args[1], _args[2])
                        else:
            ...
            if numArgs == 1:
                if isinstance(_args[0], types.StringType):
                    ...
                    if isinstance(_args[0], Filename):
                        return self.__overloaded_constructor_ptrConstFilename(_args[0])
                    else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], Filename):
                        if isinstance(_args[1], Filename):
                            return self.__overloaded_constructor_ptrConstFilename_ptrConstFilename(_args[0], _args[1])
                        else:
    ...
    def openWrite(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ofstream.Ofstream):
                return self.__overloaded_openWrite_ptrConstFilename_ptrOfstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ofstream.Ofstream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_openWrite_ptrConstFilename_ptrOfstream_bool(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ofstream.Ofstream> '
    ...
    def compareTimestamps(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Filename):
                return self.__overloaded_compareTimestamps_ptrConstFilename_ptrConstFilename(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Filename> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], Filename):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTimestamps_ptrConstFilename_ptrConstFilename_bool(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Filename> '
                ...
                if numArgs == 3:
                    if isinstance(_args[0], Filename):
                        if isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.IntType):
                                return self.__overloaded_compareTimestamps_ptrConstFilename_ptrConstFilename_bool_bool(_args[0], _args[1], _args[2])
                            else:
                                raise TypeError, 'Invalid argument 2, expected one of: <types.IntType> '
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
    ...
    def resolveFilename(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], DSearchPath.DSearchPath):
                return self.__overloaded_resolveFilename_ptrFilename_ptrConstDSearchPath(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], DSearchPath.DSearchPath):
                    if isinstance(_args[1], types.StringType):
                        return self.__overloaded_resolveFilename_ptrFilename_ptrConstDSearchPath_atomicstring(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.StringType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <DSearchPath.DSearchPath> '
    ...
    def makeRelativeTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Filename):
                return self.__overloaded_makeRelativeTo_ptrFilename_ptrFilename(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Filename> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], Filename):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_makeRelativeTo_ptrFilename_ptrFilename_bool(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Filename> '
    ...
    def makeAbsolute(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_makeAbsolute_ptrFilename()
        else:
            if numArgs == 1:
                if isinstance(_args[0], Filename):
                    return self.__overloaded_makeAbsolute_ptrFilename_ptrConstFilename(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Filename> '
            else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return self.__overloaded_assign_ptrFilename_atomicstring(_args[0])
            else:
                if isinstance(_args[0], Filename):
                    return self.__overloaded_assign_ptrFilename_ptrConstFilename(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> <Filename> '
        else:
