...
class VBase2D(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_assign_ptrLVecBase2d_ptrConstLVecBase2d(self, copy):
    ...
    def __overloaded_assign_ptrLVecBase2d_double(self, fillValue):
    ...
    def __overloaded___getitem___ptrLVecBase2d_int(self, i):
        returnValue = libpanda._inPUZN35ZXF(self.this, i)
        return returnValue

    def __overloaded___getitem___ptrConstLVecBase2d_int(self, i):
    ...
    def __overloaded_compareTo_ptrConstLVecBase2d_ptrConstLVecBase2d(self, other):
        returnValue = libpanda._inPUZN3dKgs(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLVecBase2d_ptrConstLVecBase2d_double(self, other, threshold):
        returnValue = libpanda._inPUZN3f1W3(self.this, other.this, threshold)
        return returnValue

    def __overloaded___sub___ptrConstLVecBase2d(self):
    ...
    def __overloaded___sub___ptrConstLVecBase2d_ptrConstLVecBase2d(self, other):
    ...
    def __overloaded_almostEqual_ptrConstLVecBase2d_ptrConstLVecBase2d(self, other):
        returnValue = libpanda._inPUZN3kTK9(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLVecBase2d_ptrConstLVecBase2d_double(self, other, threshold):
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase2D):
                return self.__overloaded_almostEqual_ptrConstLVecBase2d_ptrConstLVecBase2d(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], VBase2D):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLVecBase2d_ptrConstLVecBase2d_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase2D> '
    ...
    def __sub__(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded___sub___ptrConstLVecBase2d()
        else:
            if numArgs == 1:
                if isinstance(_args[0], VBase2D):
                    return self.__overloaded___sub___ptrConstLVecBase2d_ptrConstLVecBase2d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase2D> '
            else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLVecBase2d_double(_args[0])
            else:
                if isinstance(_args[0], VBase2D):
                    return self.__overloaded_assign_ptrLVecBase2d_ptrConstLVecBase2d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase2D> '
        else:
    ...
    def __getitem__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded___getitem___ptrConstLVecBase2d_int(_args[0])
            else:
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase2D):
                return self.__overloaded_compareTo_ptrConstLVecBase2d_ptrConstLVecBase2d(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase2D> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], VBase2D):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLVecBase2d_ptrConstLVecBase2d_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase2D> '
