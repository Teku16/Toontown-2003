...
class Notify(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_getCategory_ptrNotify_atomicstring(self, fullname):
    ...
    def __overloaded_getCategory_ptrNotify_atomicstring_ptrNotifyCategory(self, basename, parentCategory):
    ...
    def __overloaded_getCategory_ptrNotify_atomicstring_atomicstring(self, basename, parentFullname):
    ...
    def getCategory(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return self.__overloaded_getCategory_ptrNotify_atomicstring(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    ...
                    if isinstance(_args[1], types.StringType):
                        return self.__overloaded_getCategory_ptrNotify_atomicstring_atomicstring(_args[0], _args[1])
                    else:
                        if isinstance(_args[1], NotifyCategory.NotifyCategory):
                            return self.__overloaded_getCategory_ptrNotify_atomicstring_ptrNotifyCategory(_args[0], _args[1])
                        else:
