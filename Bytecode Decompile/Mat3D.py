...
class Mat3D(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLMatrix3d(self, other):
        self.this = libpanda._inPUZN3nwPr(other.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_double_double_double_double_double_double_double_double_double(self, e00, e01, e02, e10, e11, e12, e20, e21, e22):
    ...
    def __overloaded_translateMat_ptrConstLVecBase2d(trans):
    ...
    __overloaded_translateMat_ptrConstLVecBase2d = staticmethod(__overloaded_translateMat_ptrConstLVecBase2d)

    def __overloaded_translateMat_double_double(tx, ty):
    ...
    __overloaded_translateMat_double_double = staticmethod(__overloaded_translateMat_double_double)

    def __overloaded_rotateMat_double(angle):
    ...
    __overloaded_rotateMat_double = staticmethod(__overloaded_rotateMat_double)
    ...
    def __overloaded_scaleMat_ptrConstLVecBase2d(scale):
    ...
    __overloaded_scaleMat_ptrConstLVecBase2d = staticmethod(__overloaded_scaleMat_ptrConstLVecBase2d)
    ...
    def __overloaded_scaleMat_double_double(sx, sy):
    ...
    __overloaded_scaleMat_double_double = staticmethod(__overloaded_scaleMat_double_double)
    ...
    def __overloaded_assign_ptrLMatrix3d_ptrConstLMatrix3d(self, other):
    ...
    def __overloaded_assign_ptrLMatrix3d_double(self, fillValue):
    ...
    def __overloaded_setRow_ptrLMatrix3d_int_ptrConstLVecBase2d(self, row, v):
        returnValue = libpanda._inPUZN3MjRK(self.this, row, v.this)
        return returnValue

    def __overloaded_setRow_ptrLMatrix3d_int_ptrConstLVecBase3d(self, row, v):
        returnValue = libpanda._inPUZN34jBs(self.this, row, v.this)
        return returnValue

    def __overloaded_setCol_ptrLMatrix3d_int_ptrConstLVecBase2d(self, col, v):
        returnValue = libpanda._inPUZN3hFlR(self.this, col, v.this)
        return returnValue

    def __overloaded_setCol_ptrLMatrix3d_int_ptrConstLVecBase3d(self, col, v):
        returnValue = libpanda._inPUZN3dGVz(self.this, col, v.this)
        return returnValue

    def __overloaded_getRow_ptrConstLMatrix3d_ptrLVecBase3d_int(self, resultVec, row):
        returnValue = libpanda._inPUZN3FRjb(self.this, resultVec.this, row)
        return returnValue

    def __overloaded_getRow_ptrConstLMatrix3d_int(self, row):
    ...
    def __overloaded___call___ptrLMatrix3d_int_int(self, row, col):
        returnValue = libpanda._inPUZN3YAPO(self.this, row, col)
        return returnValue

    def __overloaded___call___ptrConstLMatrix3d_int_int(self, row, col):
    ...
    def __overloaded_compareTo_ptrConstLMatrix3d_ptrConstLMatrix3d(self, other):
        returnValue = libpanda._inPUZN3s_3g(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLMatrix3d_ptrConstLMatrix3d_double(self, other, threshold):
    ...
    def __overloaded___mul___ptrConstLMatrix3d_ptrConstLMatrix3d(self, other):
    ...
    def __overloaded___mul___ptrConstLMatrix3d_double(self, scalar):
    ...
    def __overloaded___imul___ptrLMatrix3d_ptrConstLMatrix3d(self, other):
    ...
    def __overloaded___imul___ptrLMatrix3d_double(self, scalar):
    ...
    def __overloaded_almostEqual_ptrConstLMatrix3d_ptrConstLMatrix3d(self, other):
        returnValue = libpanda._inPUZN3rIZO(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLMatrix3d_ptrConstLMatrix3d_double(self, other, threshold):
    ...
    def __overloaded_write_ptrConstLMatrix3d_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPUZN3Ihab(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstLMatrix3d_ptrOstream(self, out):
    ...
    def scaleMat(*_args):
        numArgs = len(_args)
        if numArgs == 1:
            import VBase3D, VBase2D
            if isinstance(_args[0], VBase3D.VBase3D):
                return Mat3D.__overloaded_scaleMat_ptrConstLVecBase3d(_args[0])
            else:
                if isinstance(_args[0], VBase2D.VBase2D):
                    return Mat3D.__overloaded_scaleMat_ptrConstLVecBase2d(_args[0])
                else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return Mat3D.__overloaded_scaleMat_double_double(_args[0], _args[1])
                    else:
                    ...
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                return Mat3D.__overloaded_scaleMat_double_double_double(_args[0], _args[1], _args[2])
                            else:
    ...
    def translateMat(*_args):
        ...
        if numArgs == 1:
            import VBase2D
            if isinstance(_args[0], VBase2D.VBase2D):
                return Mat3D.__overloaded_translateMat_ptrConstLVecBase2d(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return Mat3D.__overloaded_translateMat_double_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], VBase3D.VBase3D):
                    return Mat3D.__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], VBase3D.VBase3D):
                        if isinstance(_args[2], types.IntType):
                            return Mat3D.__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                        else:
    ...
    def rotateMat(*_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return Mat3D.__overloaded_rotateMat_double(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    import VBase3D
                    if isinstance(_args[1], VBase3D.VBase3D):
                        return Mat3D.__overloaded_rotateMat_double_ptrLVecBase3d(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3D.VBase3D> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
                ...
                if numArgs == 3:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        ...
                        if isinstance(_args[1], VBase3D.VBase3D):
                            if isinstance(_args[2], types.IntType):
                                return Mat3D.__overloaded_rotateMat_double_ptrLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                            else:
                                raise TypeError, 'Invalid argument 2, expected one of: <types.IntType> '
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <VBase3D.VBase3D> '
                                            ...
                                            if isinstance(_args[6], types.FloatType) or isinstance(_args[6], types.IntType):
                                                if isinstance(_args[7], types.FloatType) or isinstance(_args[7], types.IntType):
                                                    if isinstance(_args[8], types.FloatType) or isinstance(_args[8], types.IntType):
                                                        return self.__overloaded_constructor_double_double_double_double_double_double_double_double_double(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8])
                                                    else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstLMatrix3d_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstLMatrix3d_ptrOstream_int(_args[0], _args[1])
                    else:
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Mat3D):
                return self.__overloaded_almostEqual_ptrConstLMatrix3d_ptrConstLMatrix3d(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Mat3D> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], Mat3D):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLMatrix3d_ptrConstLMatrix3d_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat3D> '
    ...
    def __imul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded___imul___ptrLMatrix3d_double(_args[0])
            else:
                if isinstance(_args[0], Mat3D):
                    return self.__overloaded___imul___ptrLMatrix3d_ptrConstLMatrix3d(_args[0])
                else:
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Mat3D):
                return self.__overloaded_compareTo_ptrConstLMatrix3d_ptrConstLMatrix3d(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Mat3D> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], Mat3D):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLMatrix3d_ptrConstLMatrix3d_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat3D> '
    ...
    def __call__(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.IntType):
                    return self.__overloaded___call___ptrConstLMatrix3d_int_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
    ...
    def setRow(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                import VBase3D, VBase2D
                if isinstance(_args[1], VBase3D.VBase3D):
                    return self.__overloaded_setRow_ptrLMatrix3d_int_ptrConstLVecBase3d(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase2D.VBase2D):
                        return self.__overloaded_setRow_ptrLMatrix3d_int_ptrConstLVecBase2d(_args[0], _args[1])
                    else:
    ...
    def setCol(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                import VBase3D, VBase2D
                if isinstance(_args[1], VBase3D.VBase3D):
                    return self.__overloaded_setCol_ptrLMatrix3d_int_ptrConstLVecBase3d(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase2D.VBase2D):
                        return self.__overloaded_setCol_ptrLMatrix3d_int_ptrConstLVecBase2d(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3D.VBase3D> <VBase2D.VBase2D> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLMatrix3d_double(_args[0])
            else:
                if isinstance(_args[0], Mat3D):
                    return self.__overloaded_assign_ptrLMatrix3d_ptrConstLMatrix3d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <Mat3D> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def getRow(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_getRow_ptrConstLMatrix3d_int(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], VBase3D.VBase3D):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_getRow_ptrConstLMatrix3d_ptrLVecBase3d_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
    ...
    def __mul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded___mul___ptrConstLMatrix3d_double(_args[0])
            else:
                if isinstance(_args[0], Mat3D):
                    return self.__overloaded___mul___ptrConstLMatrix3d_ptrConstLMatrix3d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <Mat3D> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '