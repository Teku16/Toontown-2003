...
class NodePath(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstNodePath(self, copy):
        self.this = libpanda._inPkJyoWaJj(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstNodePath_ptrPandaNode(self, parent, childNode):
        self.this = libpanda._inPkJyoYAhm(parent.this, childNode.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrPandaNode(self, node):
        self.this = libpanda._inPkJyoH4wM(node.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_atomicstring(self, topNodeName):
    ...
    def __overloaded_reparentTo_ptrNodePath_ptrConstNodePath_int(self, other, sort):
        returnValue = libpanda._inPkJyo4WHK(self.this, other.this, sort)
        return returnValue

    def __overloaded_reparentTo_ptrNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyozsyP(self.this, other.this)
        return returnValue

    def __overloaded_wrtReparentTo_ptrNodePath_ptrConstNodePath_int(self, other, sort):
        returnValue = libpanda._inPkJyokn7s(self.this, other.this, sort)
        return returnValue

    def __overloaded_wrtReparentTo_ptrNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyowFTN(self.this, other.this)
        return returnValue

    def __overloaded_instanceTo_ptrConstNodePath_ptrConstNodePath_int(self, other, sort):
    ...
    def __overloaded_instanceTo_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_instanceUnderNode_ptrConstNodePath_ptrConstNodePath_atomicstring_int(self, other, name, sort):
    ...
    def __overloaded_instanceUnderNode_ptrConstNodePath_ptrConstNodePath_atomicstring(self, other, name):
    ...
    def __overloaded_copyTo_ptrConstNodePath_ptrConstNodePath_int(self, other, sort):
    ...
    def __overloaded_copyTo_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_attachNewNode_ptrConstNodePath_ptrPandaNode_int(self, node, sort):
    ...
    def __overloaded_attachNewNode_ptrConstNodePath_ptrPandaNode(self, node):
    ...
    def __overloaded_attachNewNode_ptrConstNodePath_atomicstring_int(self, name, sort):
    ...
    def __overloaded_attachNewNode_ptrConstNodePath_atomicstring(self, name):
    ...
    def __overloaded_ls_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyovoLL(self.this)
        return returnValue

    def __overloaded_ls_ptrConstNodePath_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPkJyo1zyE(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_ls_ptrConstNodePath_ptrOstream(self, out):
        returnValue = libpanda._inPkJyou02a(self.this, out.this)
        return returnValue

    def __overloaded_getState_ptrConstNodePath(self):
    ...
    def __overloaded_getState_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_setState_ptrConstNodePath_ptrConstNodePath_ptrConstRenderState(self, other, state):
        returnValue = libpanda._inPkJyoVxuD(self.this, other.this, state.this)
        return returnValue

    def __overloaded_setState_ptrConstNodePath_ptrConstRenderState(self, state):
    ...
    def __overloaded_getTransform_ptrConstNodePath(self):
    ...
    def __overloaded_getTransform_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_setTransform_ptrConstNodePath_ptrConstNodePath_ptrConstTransformState(self, other, transform):
        returnValue = libpanda._inPkJyoaNiA(self.this, other.this, transform.this)
        return returnValue

    def __overloaded_setTransform_ptrConstNodePath_ptrConstTransformState(self, transform):
    ...
    def __overloaded_setPos_ptrNodePath_ptrConstLVecBase3f(self, pos):
        returnValue = libpanda._inPkJyouVV9(self.this, pos.this)
        return returnValue

    def __overloaded_setPos_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f(self, other, pos):
        returnValue = libpanda._inPkJyo3got(self.this, other.this, pos.this)
        return returnValue

    def __overloaded_setPos_ptrNodePath_ptrConstNodePath_float_float_float(self, other, x, y, z):
        returnValue = libpanda._inPkJyo1iUk(self.this, other.this, x, y, z)
        return returnValue

    def __overloaded_setPos_ptrNodePath_float_float_float(self, x, y, z):
        returnValue = libpanda._inPkJyoc4_K(self.this, x, y, z)
        return returnValue

    def __overloaded_setX_ptrNodePath_ptrConstNodePath_float(self, other, x):
        returnValue = libpanda._inPkJyoRez_(self.this, other.this, x)
        return returnValue

    def __overloaded_setX_ptrNodePath_float(self, x):
        returnValue = libpanda._inPkJyocaZh(self.this, x)
        return returnValue

    def __overloaded_setY_ptrNodePath_ptrConstNodePath_float(self, other, y):
        returnValue = libpanda._inPkJyozKzv(self.this, other.this, y)
        return returnValue

    def __overloaded_setY_ptrNodePath_float(self, y):
        returnValue = libpanda._inPkJyo2gZR(self.this, y)
        return returnValue

    def __overloaded_setZ_ptrNodePath_ptrConstNodePath_float(self, other, z):
        returnValue = libpanda._inPkJyoU5zf(self.this, other.this, z)
        return returnValue

    def __overloaded_setZ_ptrNodePath_float(self, z):
        returnValue = libpanda._inPkJyoYzZB(self.this, z)
        return returnValue

    def __overloaded_getPos_ptrConstNodePath(self):
    ...
    def __overloaded_getPos_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_getX_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyo1lol(self.this)
        return returnValue

    def __overloaded_getX_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyorQU6(self.this, other.this)
        return returnValue

    def __overloaded_getY_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyoaSpV(self.this)
        return returnValue

    def __overloaded_getY_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoJEUq(self.this, other.this)
        return returnValue

    def __overloaded_getZ_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyoxcoF(self.this)
        return returnValue

    def __overloaded_getZ_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoo5Ua(self.this, other.this)
        return returnValue

    def __overloaded_setHpr_ptrNodePath_ptrConstLVecBase3f(self, hpr):
        returnValue = libpanda._inPkJyoEdk4(self.this, hpr.this)
        return returnValue

    def __overloaded_setHpr_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f(self, other, hpr):
        returnValue = libpanda._inPkJyoJo3o(self.this, other.this, hpr.this)
        return returnValue

    def __overloaded_setHpr_ptrNodePath_ptrConstNodePath_float_float_float(self, other, h, p, r):
        returnValue = libpanda._inPkJyoablf(self.this, other.this, h, p, r)
        return returnValue

    def __overloaded_setHpr_ptrNodePath_float_float_float(self, h, p, r):
        returnValue = libpanda._inPkJyoGhOG(self.this, h, p, r)
        return returnValue

    def __overloaded_setH_ptrNodePath_ptrConstNodePath_float(self, other, h):
        returnValue = libpanda._inPkJyo1Wu_(self.this, other.this, h)
        return returnValue

    def __overloaded_setH_ptrNodePath_float(self, h):
        returnValue = libpanda._inPkJyo4SUh(self.this, h)
        return returnValue

    def __overloaded_setP_ptrNodePath_ptrConstNodePath_float(self, other, p):
        returnValue = libpanda._inPkJyoDyw_(self.this, other.this, p)
        return returnValue

    def __overloaded_setP_ptrNodePath_float(self, p):
        returnValue = libpanda._inPkJyou_Xh(self.this, p)
        return returnValue

    def __overloaded_setR_ptrNodePath_ptrConstNodePath_float(self, other, r):
        returnValue = libpanda._inPkJyoGVwf(self.this, other.this, r)
        return returnValue

    def __overloaded_setR_ptrNodePath_float(self, r):
        returnValue = libpanda._inPkJyoqXXB(self.this, r)
        return returnValue

    def __overloaded_getHpr_ptrConstNodePath(self):
    ...
    def __overloaded_getHpr_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_getHpr_ptrConstNodePath_ptrConstNodePath_float(self, other, roll):
    ...
    def __overloaded_getHpr_ptrConstNodePath_float(self, roll):
    ...
    def __overloaded_getH_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyoRtjl(self.this)
        return returnValue

    def __overloaded_getH_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoHZP6(self.this, other.this)
        return returnValue

    def __overloaded_getP_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyoDJll(self.this)
        return returnValue

    def __overloaded_getP_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoV1R6(self.this, other.this)
        return returnValue

    def __overloaded_getR_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyoHwlF(self.this)
        return returnValue

    def __overloaded_getR_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoWcRa(self.this, other.this)
        return returnValue

    def __overloaded_setQuat_ptrNodePath_ptrConstLQuaternionf(self, quat):
        returnValue = libpanda._inPkJyowJgI(self.this, quat.this)
        return returnValue

    def __overloaded_setQuat_ptrNodePath_ptrConstNodePath_ptrConstLQuaternionf(self, other, quat):
        returnValue = libpanda._inPkJyoJI60(self.this, other.this, quat.this)
        return returnValue

    def __overloaded_getQuat_ptrConstNodePath(self):
    ...
    def __overloaded_getQuat_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_setScale_ptrNodePath_ptrConstLVecBase3f(self, scale):
        returnValue = libpanda._inPkJyoYaRp(self.this, scale.this)
        return returnValue

    def __overloaded_setScale_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f(self, other, scale):
        returnValue = libpanda._inPkJyouef1(self.this, other.this, scale.this)
        return returnValue

    def __overloaded_setScale_ptrNodePath_ptrConstNodePath_float_float_float(self, other, sx, sy, sz):
        returnValue = libpanda._inPkJyoyK_k(self.this, other.this, sx, sy, sz)
        return returnValue

    def __overloaded_setScale_ptrNodePath_float(self, scale):
        returnValue = libpanda._inPkJyouTLn(self.this, scale)
        return returnValue

    def __overloaded_setScale_ptrNodePath_float_float_float(self, sx, sy, sz):
        returnValue = libpanda._inPkJyoMsGl(self.this, sx, sy, sz)
        return returnValue

    def __overloaded_setSx_ptrNodePath_ptrConstNodePath_float(self, other, sx):
        returnValue = libpanda._inPkJyopi3_(self.this, other.this, sx)
        return returnValue

    def __overloaded_setSx_ptrNodePath_float(self, sx):
        returnValue = libpanda._inPkJyoFtIx(self.this, sx)
        return returnValue

    def __overloaded_setSy_ptrNodePath_ptrConstNodePath_float(self, other, sy):
        returnValue = libpanda._inPkJyohVB_(self.this, other.this, sy)
        return returnValue

    def __overloaded_setSy_ptrNodePath_float(self, sy):
        returnValue = libpanda._inPkJyodaRx(self.this, sy)
        return returnValue

    def __overloaded_setSz_ptrNodePath_ptrConstNodePath_float(self, other, sz):
        returnValue = libpanda._inPkJyo5EL_(self.this, other.this, sz)
        return returnValue

    def __overloaded_setSz_ptrNodePath_float(self, sz):
        returnValue = libpanda._inPkJyoVLbx(self.this, sz)
        return returnValue

    def __overloaded_getScale_ptrConstNodePath(self):
    ...
    def __overloaded_getScale_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_getSx_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyon63U(self.this)
        return returnValue

    def __overloaded_getSx_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoDXrr(self.this, other.this)
        return returnValue

    def __overloaded_getSy_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyovrBV(self.this)
        return returnValue

    def __overloaded_getSy_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoLE1r(self.this, other.this)
        return returnValue

    def __overloaded_getSz_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyoXULV(self.this)
        return returnValue

    def __overloaded_getSz_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoT18r(self.this, other.this)
        return returnValue

    def __overloaded_setPosHpr_ptrNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f(self, pos, hpr):
        returnValue = libpanda._inPkJyo_KIO(self.this, pos.this, hpr.this)
        return returnValue

    def __overloaded_setPosHpr_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f(self, other, pos, hpr):
        returnValue = libpanda._inPkJyobgSC(self.this, other.this, pos.this, hpr.this)
        return returnValue

    def __overloaded_setPosHpr_ptrNodePath_ptrConstNodePath_float_float_float_float_float_float(self, other, x, y, z, h, p, r):
        returnValue = libpanda._inPkJyogbI1(self.this, other.this, x, y, z, h, p, r)
        return returnValue

    def __overloaded_setPosHpr_ptrNodePath_float_float_float_float_float_float(self, x, y, z, h, p, r):
        returnValue = libpanda._inPkJyoFbxa(self.this, x, y, z, h, p, r)
        return returnValue

    def __overloaded_setHprScale_ptrNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f(self, hpr, scale):
        returnValue = libpanda._inPkJyoeWuA(self.this, hpr.this, scale.this)
        return returnValue

    def __overloaded_setHprScale_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f(self, other, hpr, scale):
        returnValue = libpanda._inPkJyoSEr7(self.this, other.this, hpr.this, scale.this)
        return returnValue

    def __overloaded_setHprScale_ptrNodePath_ptrConstNodePath_float_float_float_float_float_float(self, other, h, p, r, sx, sy, sz):
        returnValue = libpanda._inPkJyo4kfC(self.this, other.this, h, p, r, sx, sy, sz)
        return returnValue

    def __overloaded_setHprScale_ptrNodePath_float_float_float_float_float_float(self, h, p, r, sx, sy, sz):
        returnValue = libpanda._inPkJyoXIYi(self.this, h, p, r, sx, sy, sz)
        return returnValue

    def __overloaded_setPosHprScale_ptrNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(self, pos, hpr, scale):
        returnValue = libpanda._inPkJyoWLWQ(self.this, pos.this, hpr.this, scale.this)
        return returnValue

    def __overloaded_setPosHprScale_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(self, other, pos, hpr, scale):
        returnValue = libpanda._inPkJyo6XbK(self.this, other.this, pos.this, hpr.this, scale.this)
        return returnValue

    def __overloaded_setPosHprScale_ptrNodePath_ptrConstNodePath_float_float_float_float_float_float_float_float_float(self, other, x, y, z, h, p, r, sx, sy, sz):
        returnValue = libpanda._inPkJyoVHTJ(self.this, other.this, x, y, z, h, p, r, sx, sy, sz)
        return returnValue

    def __overloaded_setPosHprScale_ptrNodePath_float_float_float_float_float_float_float_float_float(self, x, y, z, h, p, r, sx, sy, sz):
        returnValue = libpanda._inPkJyog3Bw(self.this, x, y, z, h, p, r, sx, sy, sz)
        return returnValue

    def __overloaded_setPosQuatScale_ptrNodePath_ptrConstLVecBase3f_ptrConstLQuaternionf_ptrConstLVecBase3f(self, pos, quat, scale):
        returnValue = libpanda._inPkJyolcNQ(self.this, pos.this, quat.this, scale.this)
        return returnValue

    def __overloaded_setPosQuatScale_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLQuaternionf_ptrConstLVecBase3f(self, other, pos, quat, scale):
        returnValue = libpanda._inPkJyoAbZX(self.this, other.this, pos.this, quat.this, scale.this)
        return returnValue

    def __overloaded_setMat_ptrNodePath_ptrConstLMatrix4f(self, mat):
        returnValue = libpanda._inPkJyo6Rbe(self.this, mat.this)
        return returnValue

    def __overloaded_setMat_ptrNodePath_ptrConstNodePath_ptrConstLMatrix4f(self, other, mat):
    ...
    def __overloaded_getMat_ptrConstNodePath(self):
    ...
    def __overloaded_getMat_ptrConstNodePath_ptrConstNodePath(self, other):
    ...
    def __overloaded_setColorScale_ptrNodePath_ptrConstLVecBase4f(self, scale):
        returnValue = libpanda._inPkJyoiG1C(self.this, scale.this)
        return returnValue

    def __overloaded_setColorScale_ptrNodePath_float_float_float_float(self, sx, sy, sz, sa):
    ...
    def __overloaded_lookAt_ptrNodePath_ptrConstLPoint3f_ptrConstLVector3f(self, point, up):
        returnValue = libpanda._inPkJyovdrT(self.this, point.this, up.this)
        return returnValue

    def __overloaded_lookAt_ptrNodePath_ptrConstLPoint3f(self, point):
        returnValue = libpanda._inPkJyoOO_M(self.this, point.this)
        return returnValue

    def __overloaded_lookAt_ptrNodePath_ptrConstNodePath_ptrConstLPoint3f_ptrConstLVector3f(self, other, point, up):
        returnValue = libpanda._inPkJyoCkNd(self.this, other.this, point.this, up.this)
        return returnValue

    def __overloaded_lookAt_ptrNodePath_ptrConstNodePath_ptrConstLPoint3f(self, other, point):
        returnValue = libpanda._inPkJyosdPC(self.this, other.this, point.this)
        return returnValue

    def __overloaded_lookAt_ptrNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyo72Ls(self.this, other.this)
        return returnValue

    def __overloaded_lookAt_ptrNodePath_ptrConstNodePath_float_float_float(self, other, x, y, z):
        returnValue = libpanda._inPkJyovoUy(self.this, other.this, x, y, z)
        return returnValue

    def __overloaded_lookAt_ptrNodePath_float_float_float(self, x, y, z):
        returnValue = libpanda._inPkJyoTR_Y(self.this, x, y, z)
        return returnValue

    def __overloaded_headsUp_ptrNodePath_ptrConstLPoint3f_ptrConstLVector3f(self, point, up):
        returnValue = libpanda._inPkJyo45wG(self.this, point.this, up.this)
        return returnValue

    def __overloaded_headsUp_ptrNodePath_ptrConstLPoint3f(self, point):
        returnValue = libpanda._inPkJyoJ5su(self.this, point.this)
        return returnValue

    def __overloaded_headsUp_ptrNodePath_ptrConstNodePath_ptrConstLPoint3f_ptrConstLVector3f(self, other, point, up):
        returnValue = libpanda._inPkJyoA0_3(self.this, other.this, point.this, up.this)
        return returnValue

    def __overloaded_headsUp_ptrNodePath_ptrConstNodePath_ptrConstLPoint3f(self, other, point):
        returnValue = libpanda._inPkJyo1SnX(self.this, other.this, point.this)
        return returnValue

    def __overloaded_headsUp_ptrNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyowIWV(self.this, other.this)
        return returnValue

    def __overloaded_headsUp_ptrNodePath_ptrConstNodePath_float_float_float(self, other, x, y, z):
        returnValue = libpanda._inPkJyozOob(self.this, other.this, x, y, z)
        return returnValue

    def __overloaded_headsUp_ptrNodePath_float_float_float(self, x, y, z):
    ...
    def __overloaded_setColor_ptrNodePath_ptrConstLVecBase4f_int(self, color, priority):
        returnValue = libpanda._inPkJyobdvm(self.this, color.this, priority)
        return returnValue

    def __overloaded_setColor_ptrNodePath_ptrConstLVecBase4f(self, color):
        returnValue = libpanda._inPkJyoU3Zs(self.this, color.this)
        return returnValue

    def __overloaded_setColor_ptrNodePath_float_float_float_float_int(self, r, g, b, a, priority):
        returnValue = libpanda._inPkJyo366r(self.this, r, g, b, a, priority)
        return returnValue

    def __overloaded_setColor_ptrNodePath_float_float_float_float(self, r, g, b, a):
        returnValue = libpanda._inPkJyoxcaQ(self.this, r, g, b, a)
        return returnValue

    def __overloaded_setColor_ptrNodePath_float_float_float(self, r, g, b):
        returnValue = libpanda._inPkJyoQ4OM(self.this, r, g, b)
        return returnValue

    def __overloaded_setColorOff_ptrNodePath_int(self, priority):
        returnValue = libpanda._inPkJyox27z(self.this, priority)
        return returnValue

    def __overloaded_setColorOff_ptrNodePath(self):
    ...
    def __overloaded_setBin_ptrNodePath_atomicstring_int_int(self, binName, drawOrder, priority):
        returnValue = libpanda._inPkJyoxqDK(self.this, binName, drawOrder, priority)
        return returnValue

    def __overloaded_setBin_ptrNodePath_atomicstring_int(self, binName, drawOrder):
    ...
    def __overloaded_setTexture_ptrNodePath_ptrTexture_int(self, tex, priority):
        returnValue = libpanda._inPkJyoEEvx(self.this, tex.this, priority)
        return returnValue

    def __overloaded_setTexture_ptrNodePath_ptrTexture(self, tex):
        returnValue = libpanda._inPkJyodhTm(self.this, tex.this)
        return returnValue

    def __overloaded_setTextureOff_ptrNodePath_int(self, priority):
        returnValue = libpanda._inPkJyow4bU(self.this, priority)
        return returnValue

    def __overloaded_setTextureOff_ptrNodePath(self):
    ...
    def __overloaded_findAllTextures_ptrConstNodePath(self):
    ...
    def __overloaded_findAllTextures_ptrConstNodePath_atomicstring(self, name):
    ...
    def __overloaded_setMaterial_ptrNodePath_ptrMaterial_int(self, tex, priority):
        returnValue = libpanda._inPkJyocZam(self.this, tex.this, priority)
        return returnValue

    def __overloaded_setMaterial_ptrNodePath_ptrMaterial(self, tex):
        returnValue = libpanda._inPkJyo3Xcl(self.this, tex.this)
        return returnValue

    def __overloaded_setMaterialOff_ptrNodePath_int(self, priority):
        returnValue = libpanda._inPkJyogcpR(self.this, priority)
        return returnValue

    def __overloaded_setMaterialOff_ptrNodePath(self):
    ...
    def __overloaded_setFog_ptrNodePath_ptrFog_int(self, fog, priority):
        returnValue = libpanda._inPkJyomIDI(self.this, fog.this, priority)
        return returnValue

    def __overloaded_setFog_ptrNodePath_ptrFog(self, fog):
        returnValue = libpanda._inPkJyovA0X(self.this, fog.this)
        return returnValue

    def __overloaded_setFogOff_ptrNodePath_int(self, priority):
        returnValue = libpanda._inPkJyo_qa5(self.this, priority)
        return returnValue

    def __overloaded_setFogOff_ptrNodePath(self):
    ...
    def __overloaded_setRenderModeWireframe_ptrNodePath_int(self, priority):
        returnValue = libpanda._inPkJyo3mJB(self.this, priority)
        return returnValue

    def __overloaded_setRenderModeWireframe_ptrNodePath(self):
        returnValue = libpanda._inPkJyoF5Vy(self.this)
        return returnValue

    def __overloaded_setRenderModeFilled_ptrNodePath_int(self, priority):
        returnValue = libpanda._inPkJyoFdFx(self.this, priority)
        return returnValue

    def __overloaded_setRenderModeFilled_ptrNodePath(self):
    ...
    def __overloaded_setTwoSided_ptrNodePath_bool_int(self, twoSided, priority):
        returnValue = libpanda._inPkJyoVKd_(self.this, twoSided, priority)
        return returnValue

    def __overloaded_setTwoSided_ptrNodePath_bool(self, twoSided):
    ...
    def __overloaded_setDepthTest_ptrNodePath_bool_int(self, depthTest, priority):
        returnValue = libpanda._inPkJyoY7DP(self.this, depthTest, priority)
        return returnValue

    def __overloaded_setDepthTest_ptrNodePath_bool(self, depthTest):
    ...
    def __overloaded_setDepthWrite_ptrNodePath_bool_int(self, depthWrite, priority):
        returnValue = libpanda._inPkJyoUxkt(self.this, depthWrite, priority)
        return returnValue

    def __overloaded_setDepthWrite_ptrNodePath_bool(self, depthWrite):
    ...
    def __overloaded_setBillboardAxis_ptrNodePath_ptrConstNodePath_float(self, camera, offset):
        returnValue = libpanda._inPkJyonoHV(self.this, camera.this, offset)
        return returnValue

    def __overloaded_setBillboardAxis_ptrNodePath_float(self, offset):
        returnValue = libpanda._inPkJyoMHYU(self.this, offset)
        return returnValue

    def __overloaded_setBillboardAxis_ptrNodePath(self):
        returnValue = libpanda._inPkJyowiDy(self.this)
        return returnValue

    def __overloaded_setBillboardPointEye_ptrNodePath_ptrConstNodePath_float(self, camera, offset):
        returnValue = libpanda._inPkJyo3opV(self.this, camera.this, offset)
        return returnValue

    def __overloaded_setBillboardPointEye_ptrNodePath_float(self, offset):
        returnValue = libpanda._inPkJyog0MU(self.this, offset)
        return returnValue

    def __overloaded_setBillboardPointEye_ptrNodePath(self):
        returnValue = libpanda._inPkJyoXCeP(self.this)
        return returnValue

    def __overloaded_setBillboardPointWorld_ptrNodePath_ptrConstNodePath_float(self, camera, offset):
        returnValue = libpanda._inPkJyogjg2(self.this, camera.this, offset)
        return returnValue

    def __overloaded_setBillboardPointWorld_ptrNodePath_float(self, offset):
        returnValue = libpanda._inPkJyoOaqP(self.this, offset)
        return returnValue

    def __overloaded_setBillboardPointWorld_ptrNodePath(self):
    ...
    def __overloaded_setCompass_ptrNodePath_ptrConstNodePath(self, reference):
        returnValue = libpanda._inPkJyoMfMs(self.this, reference.this)
        return returnValue

    def __overloaded_setCompass_ptrNodePath(self):
    ...
    def __overloaded_setTransparency_ptrNodePath_bool_int(self, transparency, priority):
        returnValue = libpanda._inPkJyoC6cb(self.this, transparency, priority)
        return returnValue

    def __overloaded_setTransparency_ptrNodePath_bool(self, transparency):
    ...
    def __overloaded_show_ptrNodePath(self):
        returnValue = libpanda._inPkJyoAwv_(self.this)
        return returnValue

    def __overloaded_show_ptrNodePath_ptrBitMask32(self, cameraMask):
        returnValue = libpanda._inPkJyo5Srv(self.this, cameraMask.this)
        return returnValue

    def __overloaded_hide_ptrNodePath(self):
        returnValue = libpanda._inPkJyooDIm(self.this)
        return returnValue

    def __overloaded_hide_ptrNodePath_ptrBitMask32(self, cameraMask):
        returnValue = libpanda._inPkJyonwFX(self.this, cameraMask.this)
        return returnValue

    def __overloaded_isHidden_ptrConstNodePath_ptrBitMask32(self, cameraMask):
        returnValue = libpanda._inPkJyo9FXE(self.this, cameraMask.this)
        return returnValue

    def __overloaded_isHidden_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyoYTUU(self.this)
        return returnValue

    def __overloaded_getHiddenAncestor_ptrConstNodePath_ptrBitMask32(self, cameraMask):
    ...
    def __overloaded_getHiddenAncestor_ptrConstNodePath(self):
    ...
    def __overloaded_prepareScene_ptrNodePath_ptrGraphicsStateGuardianBase_bool(self, gsg, forceRetainedMode):
        returnValue = libpanda._inPkJyoe_I2(self.this, gsg.this, forceRetainedMode)
        return returnValue

    def __overloaded_prepareScene_ptrNodePath_ptrGraphicsStateGuardianBase(self, gsg):
            ...
            if numArgs == 1:
                ...
                if isinstance(_args[0], types.StringType):
                    ...
                    if isinstance(_args[0], PandaNode.PandaNode):
                        return self.__overloaded_constructor_ptrPandaNode(_args[0])
                    else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], NodePath):
                        ...
                        if isinstance(_args[1], PandaNode.PandaNode):
                            return self.__overloaded_constructor_ptrConstNodePath_ptrPandaNode(_args[0], _args[1])
                        else:
            ...
            if isinstance(_args[0], VBase3.VBase3):
                ...
                if isinstance(_args[1], Quat.Quat):
                    ...
                    if isinstance(_args[2], VBase3.VBase3):
                        return self.__overloaded_setPosQuatScale_ptrNodePath_ptrConstLVecBase3f_ptrConstLQuaternionf_ptrConstLVecBase3f(_args[0], _args[1], _args[2])
                    else:
                    ...
                    if isinstance(_args[1], VBase3.VBase3):
                        ...
                        if isinstance(_args[2], Quat.Quat):
                            ...
                            if isinstance(_args[3], VBase3.VBase3):
                                return self.__overloaded_setPosQuatScale_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLQuaternionf_ptrConstLVecBase3f(_args[0], _args[1], _args[2], _args[3])
                            else:
    ...
    def getHpr(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getHpr_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    return self.__overloaded_getHpr_ptrConstNodePath_float(_args[0])
                else:
                    if isinstance(_args[0], NodePath):
                        return self.__overloaded_getHpr_ptrConstNodePath_ptrConstNodePath(_args[0])
                    else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], NodePath):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            return self.__overloaded_getHpr_ptrConstNodePath_ptrConstNodePath_float(_args[0], _args[1])
                        else:
    ...
    def setTexture(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Texture.Texture):
                return self.__overloaded_setTexture_ptrNodePath_ptrTexture(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Texture.Texture):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setTexture_ptrNodePath_ptrTexture_int(_args[0], _args[1])
                    else:
    ...
    def getPos(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getPos_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getPos_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
    ...
    def show(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_show_ptrNodePath()
        else:
            if numArgs == 1:
                import BitMask32
                if isinstance(_args[0], BitMask32.BitMask32):
                    return self.__overloaded_show_ptrNodePath_ptrBitMask32(_args[0])
                else:
    ...
    def setTransform(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], TransformState.TransformState):
                return self.__overloaded_setTransform_ptrConstNodePath_ptrConstTransformState(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    ...
                    if isinstance(_args[1], TransformState.TransformState):
                        return self.__overloaded_setTransform_ptrConstNodePath_ptrConstNodePath_ptrConstTransformState(_args[0], _args[1])
                    else:
    ...
    def setHpr(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return self.__overloaded_setHpr_ptrNodePath_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    import VBase3
                    if isinstance(_args[1], VBase3.VBase3):
                        return self.__overloaded_setHpr_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
                    ...
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                return self.__overloaded_setHpr_ptrNodePath_float_float_float(_args[0], _args[1], _args[2])
                            else:
                            ...
                            if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                                if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                        return self.__overloaded_setHpr_ptrNodePath_ptrConstNodePath_float_float_float(_args[0], _args[1], _args[2], _args[3])
                                    else:
    ...
    def setScale(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setScale_ptrNodePath_float(_args[0])
            else:
                if isinstance(_args[0], VBase3.VBase3):
                    return self.__overloaded_setScale_ptrNodePath_ptrConstLVecBase3f(_args[0])
                else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    import VBase3
                    if isinstance(_args[1], VBase3.VBase3):
                        return self.__overloaded_setScale_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
                ...
                if numArgs == 3:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                return self.__overloaded_setScale_ptrNodePath_float_float_float(_args[0], _args[1], _args[2])
                            else:
                                raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                    ...
                    if numArgs == 4:
                        if isinstance(_args[0], NodePath):
                            if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                                if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                        return self.__overloaded_setScale_ptrNodePath_ptrConstNodePath_float_float_float(_args[0], _args[1], _args[2], _args[3])
                                    else:
                                        raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                                else:
                                    raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def getX(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getX_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getX_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def instanceTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self.__overloaded_instanceTo_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_instanceTo_ptrConstNodePath_ptrConstNodePath_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def reparentTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self.__overloaded_reparentTo_ptrNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_reparentTo_ptrNodePath_ptrConstNodePath_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def wrtReparentTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self.__overloaded_wrtReparentTo_ptrNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_wrtReparentTo_ptrNodePath_ptrConstNodePath_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def lookAt(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Point3.Point3):
                return self.__overloaded_lookAt_ptrNodePath_ptrConstLPoint3f(_args[0])
            else:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_lookAt_ptrNodePath_ptrConstNodePath(_args[0])
                else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Point3.Point3):
                    ...
                    if isinstance(_args[1], Vec3.Vec3):
                        return self.__overloaded_lookAt_ptrNodePath_ptrConstLPoint3f_ptrConstLVector3f(_args[0], _args[1])
                    else:
                    ...
                    if isinstance(_args[0], NodePath):
                        ...
                        if isinstance(_args[1], Point3.Point3):
                            return self.__overloaded_lookAt_ptrNodePath_ptrConstNodePath_ptrConstLPoint3f(_args[0], _args[1])
                        else:
                ...
                if numArgs == 3:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                return self.__overloaded_lookAt_ptrNodePath_float_float_float(_args[0], _args[1], _args[2])
                            else:
                                raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                        ...
                        if isinstance(_args[0], NodePath):
                            ...
                            if isinstance(_args[1], Point3.Point3):
                                ...
                                if isinstance(_args[2], Vec3.Vec3):
                                    return self.__overloaded_lookAt_ptrNodePath_ptrConstNodePath_ptrConstLPoint3f_ptrConstLVector3f(_args[0], _args[1], _args[2])
                                else:
                    ...
                    if numArgs == 4:
                        if isinstance(_args[0], NodePath):
                            if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                                if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                        return self.__overloaded_lookAt_ptrNodePath_ptrConstNodePath_float_float_float(_args[0], _args[1], _args[2], _args[3])
                                    else:
                                        raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                                else:
                                    raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def headsUp(self, *_args):
        ...
        if numArgs == 1:
            import Point3
            if isinstance(_args[0], Point3.Point3):
                return self.__overloaded_headsUp_ptrNodePath_ptrConstLPoint3f(_args[0])
            else:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_headsUp_ptrNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Point3.Point3> <NodePath> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], Point3.Point3):
                    import Vec3
                    if isinstance(_args[1], Vec3.Vec3):
                        return self.__overloaded_headsUp_ptrNodePath_ptrConstLPoint3f_ptrConstLVector3f(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <Vec3.Vec3> '
                else:
                    if isinstance(_args[0], NodePath):
                        import Point3
                        if isinstance(_args[1], Point3.Point3):
                            return self.__overloaded_headsUp_ptrNodePath_ptrConstNodePath_ptrConstLPoint3f(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <Point3.Point3> '
                    else:
                        raise TypeError, 'Invalid argument 0, expected one of: <Point3.Point3> <NodePath> '
                ...
                if numArgs == 3:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                return self.__overloaded_headsUp_ptrNodePath_float_float_float(_args[0], _args[1], _args[2])
                            else:
                                raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                        ...
                        if isinstance(_args[0], NodePath):
                            ...
                            if isinstance(_args[1], Point3.Point3):
                                import Vec3
                                if isinstance(_args[2], Vec3.Vec3):
                                    return self.__overloaded_headsUp_ptrNodePath_ptrConstNodePath_ptrConstLPoint3f_ptrConstLVector3f(_args[0], _args[1], _args[2])
                                else:
                                    raise TypeError, 'Invalid argument 2, expected one of: <Vec3.Vec3> '
                            else:
                                raise TypeError, 'Invalid argument 1, expected one of: <Point3.Point3> '
                    ...
                    if numArgs == 4:
                        if isinstance(_args[0], NodePath):
                            if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                                if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                        return self.__overloaded_headsUp_ptrNodePath_ptrConstNodePath_float_float_float(_args[0], _args[1], _args[2], _args[3])
                                    else:
                                        raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                                else:
                                    raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def setFog(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Fog.Fog):
                return self.__overloaded_setFog_ptrNodePath_ptrFog(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Fog.Fog):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setFog_ptrNodePath_ptrFog_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Fog.Fog> '
    ...
    def getP(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getP_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getP_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setPosHpr(self, *_args):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], VBase3.VBase3):
                import VBase3
                if isinstance(_args[1], VBase3.VBase3):
                    return self.__overloaded_setPosHpr_ptrNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
            ...
            if numArgs == 3:
                if isinstance(_args[0], NodePath):
                    ...
                    if isinstance(_args[1], VBase3.VBase3):
                        import VBase3
                        if isinstance(_args[2], VBase3.VBase3):
                            return self.__overloaded_setPosHpr_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <VBase3.VBase3> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                                ...
                                if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                    if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                        if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                            return self.__overloaded_setPosHpr_ptrNodePath_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                                        else:
                                        ...
                                        if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                            if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                                if isinstance(_args[6], types.FloatType) or isinstance(_args[6], types.IntType):
                                                    return self.__overloaded_setPosHpr_ptrNodePath_ptrConstNodePath_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6])
                                                else:
    ...
    def getR(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getR_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getR_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setState(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], RenderState.RenderState):
                return self.__overloaded_setState_ptrConstNodePath_ptrConstRenderState(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    ...
                    if isinstance(_args[1], RenderState.RenderState):
                        return self.__overloaded_setState_ptrConstNodePath_ptrConstNodePath_ptrConstRenderState(_args[0], _args[1])
                    else:
    ...
    def setMat(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Mat4.Mat4):
                return self.__overloaded_setMat_ptrNodePath_ptrConstLMatrix4f(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    ...
                    if isinstance(_args[1], Mat4.Mat4):
                        return self.__overloaded_setMat_ptrNodePath_ptrConstNodePath_ptrConstLMatrix4f(_args[0], _args[1])
                    else:
    ...
    def getTransform(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getTransform_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getTransform_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setBin(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.StringType):
                if isinstance(_args[1], types.IntType):
                    return self.__overloaded_setBin_ptrNodePath_atomicstring_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                ...
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_setBin_ptrNodePath_atomicstring_int_int(_args[0], _args[1], _args[2])
                        else:
    ...
    def getZ(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getZ_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getZ_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setMaterial(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Material.Material):
                return self.__overloaded_setMaterial_ptrNodePath_ptrMaterial(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Material.Material):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setMaterial_ptrNodePath_ptrMaterial_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Material.Material> '
    ...
    def setQuat(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Quat.Quat):
                return self.__overloaded_setQuat_ptrNodePath_ptrConstLQuaternionf(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    import Quat
                    if isinstance(_args[1], Quat.Quat):
                        return self.__overloaded_setQuat_ptrNodePath_ptrConstNodePath_ptrConstLQuaternionf(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <Quat.Quat> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setDepthTest(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_setDepthTest_ptrNodePath_bool(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setDepthTest_ptrNodePath_bool_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def findAllTextures(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_findAllTextures_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.StringType):
                    return self.__overloaded_findAllTextures_ptrConstNodePath_atomicstring(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setHprScale(self, *_args):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], VBase3.VBase3):
                import VBase3
                if isinstance(_args[1], VBase3.VBase3):
                    return self.__overloaded_setHprScale_ptrNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
            ...
            if numArgs == 3:
                if isinstance(_args[0], NodePath):
                    ...
                    if isinstance(_args[1], VBase3.VBase3):
                        import VBase3
                        if isinstance(_args[2], VBase3.VBase3):
                            return self.__overloaded_setHprScale_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <VBase3.VBase3> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                        ...
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                    if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                        if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                            return self.__overloaded_setHprScale_ptrNodePath_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                                        else:
                                            raise TypeError, 'Invalid argument 5, expected one of: <types.FloatType> '
                                    else:
                                        raise TypeError, 'Invalid argument 4, expected one of: <types.FloatType> '
                                ...
                                if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                        if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                            if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                                if isinstance(_args[6], types.FloatType) or isinstance(_args[6], types.IntType):
                                                    return self.__overloaded_setHprScale_ptrNodePath_ptrConstNodePath_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6])
                                                else:
                                                    raise TypeError, 'Invalid argument 6, expected one of: <types.FloatType> '
                                            else:
                                                raise TypeError, 'Invalid argument 5, expected one of: <types.FloatType> '
    ...
    def copyTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self.__overloaded_copyTo_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_copyTo_ptrConstNodePath_ptrConstNodePath_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def ls(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_ls_ptrConstNodePath()
        else:
            if numArgs == 1:
                import Ostream
                if isinstance(_args[0], Ostream.Ostream):
                    return self.__overloaded_ls_ptrConstNodePath_ptrOstream(_args[0])
                else:
                ...
                if numArgs == 2:
                    ...
                    if isinstance(_args[0], Ostream.Ostream):
                        if isinstance(_args[1], types.IntType):
                            return self.__overloaded_ls_ptrConstNodePath_ptrOstream_int(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def setDepthWrite(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_setDepthWrite_ptrNodePath_bool(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setDepthWrite_ptrNodePath_bool_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def setCompass(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setCompass_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_setCompass_ptrNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def isHidden(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_isHidden_ptrConstNodePath()
        else:
            if numArgs == 1:
                import BitMask32
                if isinstance(_args[0], BitMask32.BitMask32):
                    return self.__overloaded_isHidden_ptrConstNodePath_ptrBitMask32(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <BitMask32.BitMask32> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def attachNewNode(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], types.StringType):
                return self.__overloaded_attachNewNode_ptrConstNodePath_atomicstring(_args[0])
            else:
                if isinstance(_args[0], PandaNode.PandaNode):
                    return self.__overloaded_attachNewNode_ptrConstNodePath_ptrPandaNode(_args[0])
                else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_attachNewNode_ptrConstNodePath_atomicstring_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    if isinstance(_args[0], PandaNode.PandaNode):
                        if isinstance(_args[1], types.IntType):
                            return self.__overloaded_attachNewNode_ptrConstNodePath_ptrPandaNode_int(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> <PandaNode.PandaNode> '
    ...
    def setColorScale(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setColorScale_ptrNodePath_ptrConstLVecBase4f(_args[0])
            else:
            ...
            if numArgs == 4:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setColorScale_ptrNodePath_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
                                raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def getState(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getState_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getState_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setSx(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setSx_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setSx_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setSy(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setSy_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setSy_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setSz(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setSz_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setSz_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setMaterialOff(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setMaterialOff_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setMaterialOff_ptrNodePath_int(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setH(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setH_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setH_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setBillboardPointWorld(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setBillboardPointWorld_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    return self.__overloaded_setBillboardPointWorld_ptrNodePath_float(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            else:
                if numArgs == 2:
                    if isinstance(_args[0], NodePath):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            return self.__overloaded_setBillboardPointWorld_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setP(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setP_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setP_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setTransparency(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_setTransparency_ptrNodePath_bool(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setTransparency_ptrNodePath_bool_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def setR(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setR_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setR_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setColorOff(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setColorOff_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setColorOff_ptrNodePath_int(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setBillboardPointEye(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setBillboardPointEye_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    return self.__overloaded_setBillboardPointEye_ptrNodePath_float(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            else:
                if numArgs == 2:
                    if isinstance(_args[0], NodePath):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            return self.__overloaded_setBillboardPointEye_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def hide(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_hide_ptrNodePath()
        else:
            if numArgs == 1:
                import BitMask32
                if isinstance(_args[0], BitMask32.BitMask32):
                    return self.__overloaded_hide_ptrNodePath_ptrBitMask32(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <BitMask32.BitMask32> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def getScale(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getScale_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getScale_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setRenderModeWireframe(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setRenderModeWireframe_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setRenderModeWireframe_ptrNodePath_int(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setX(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setX_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setX_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setY(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setY_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setY_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setZ(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setZ_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setZ_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setColor(self, *_args):
        ...
        if numArgs == 1:
            import VBase4
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setColor_ptrNodePath_ptrConstLVecBase4f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase4.VBase4> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], VBase4.VBase4):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setColor_ptrNodePath_ptrConstLVecBase4f_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase4.VBase4> '
                ...
                if numArgs == 3:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                return self.__overloaded_setColor_ptrNodePath_float_float_float(_args[0], _args[1], _args[2])
                            else:
                                raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                    ...
                    if numArgs == 4:
                        if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                            if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                                if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                        return self.__overloaded_setColor_ptrNodePath_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                                    else:
                                        raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                                else:
                                    raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                                    ...
                                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                        if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                            if isinstance(_args[4], types.IntType):
                                                return self.__overloaded_setColor_ptrNodePath_float_float_float_float_int(_args[0], _args[1], _args[2], _args[3], _args[4])
                                            else:
    ...
    def getSx(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getSx_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getSx_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def getSy(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getSy_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getSy_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def getSz(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getSz_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getSz_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
        ...
        if numArgs == 2:
            if isinstance(_args[0], NodePath):
                if isinstance(_args[1], types.StringType):
                    return self.__overloaded_instanceUnderNode_ptrConstNodePath_ptrConstNodePath_atomicstring(_args[0], _args[1])
                else:
            ...
            if numArgs == 3:
                if isinstance(_args[0], NodePath):
                    if isinstance(_args[1], types.StringType):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_instanceUnderNode_ptrConstNodePath_ptrConstNodePath_atomicstring_int(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.StringType> '
    ...
    def setTextureOff(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setTextureOff_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setTextureOff_ptrNodePath_int(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def getQuat(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getQuat_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getQuat_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def getY(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getY_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getY_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setPos(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return self.__overloaded_setPos_ptrNodePath_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], NodePath):
                    import VBase3
                    if isinstance(_args[1], VBase3.VBase3):
                        return self.__overloaded_setPos_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
                ...
                if numArgs == 3:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                return self.__overloaded_setPos_ptrNodePath_float_float_float(_args[0], _args[1], _args[2])
                            else:
                                raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                    ...
                    if numArgs == 4:
                        if isinstance(_args[0], NodePath):
                            if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                                if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                        return self.__overloaded_setPos_ptrNodePath_ptrConstNodePath_float_float_float(_args[0], _args[1], _args[2], _args[3])
                                    else:
                                        raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                                else:
                                    raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def setBillboardAxis(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setBillboardAxis_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    return self.__overloaded_setBillboardAxis_ptrNodePath_float(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            else:
                if numArgs == 2:
                    if isinstance(_args[0], NodePath):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            return self.__overloaded_setBillboardAxis_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def prepareScene(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], GraphicsStateGuardianBase.GraphicsStateGuardianBase):
                return self.__overloaded_prepareScene_ptrNodePath_ptrGraphicsStateGuardianBase(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], GraphicsStateGuardianBase.GraphicsStateGuardianBase):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_prepareScene_ptrNodePath_ptrGraphicsStateGuardianBase_bool(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <GraphicsStateGuardianBase.GraphicsStateGuardianBase> '
    ...
    def getHiddenAncestor(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getHiddenAncestor_ptrConstNodePath()
        else:
            if numArgs == 1:
                import BitMask32
                if isinstance(_args[0], BitMask32.BitMask32):
                    return self.__overloaded_getHiddenAncestor_ptrConstNodePath_ptrBitMask32(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <BitMask32.BitMask32> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setRenderModeFilled(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setRenderModeFilled_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setRenderModeFilled_ptrNodePath_int(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setFogOff(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setFogOff_ptrNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setFogOff_ptrNodePath_int(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def getH(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getH_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getH_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def getMat(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getMat_ptrConstNodePath()
        else:
            if numArgs == 1:
                if isinstance(_args[0], NodePath):
                    return self.__overloaded_getMat_ptrConstNodePath_ptrConstNodePath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
        ...
        if numArgs == 3:
            ...
            if isinstance(_args[0], VBase3.VBase3):
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    import VBase3
                    if isinstance(_args[2], VBase3.VBase3):
                        return self.__overloaded_setPosHprScale_ptrNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2])
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <VBase3.VBase3> '
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                ...
                if isinstance(_args[0], NodePath):
                    ...
                    if isinstance(_args[1], VBase3.VBase3):
                        ...
                        if isinstance(_args[2], VBase3.VBase3):
                            import VBase3
                            if isinstance(_args[3], VBase3.VBase3):
                                return self.__overloaded_setPosHprScale_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2], _args[3])
                            else:
                                raise TypeError, 'Invalid argument 3, expected one of: <VBase3.VBase3> '
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <VBase3.VBase3> '
                                            ...
                                            if isinstance(_args[6], types.FloatType) or isinstance(_args[6], types.IntType):
                                                if isinstance(_args[7], types.FloatType) or isinstance(_args[7], types.IntType):
                                                    if isinstance(_args[8], types.FloatType) or isinstance(_args[8], types.IntType):
                                                        return self.__overloaded_setPosHprScale_ptrNodePath_float_float_float_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8])
                                                    else:
                                                    ...
                                                    if isinstance(_args[7], types.FloatType) or isinstance(_args[7], types.IntType):
                                                        if isinstance(_args[8], types.FloatType) or isinstance(_args[8], types.IntType):
                                                            if isinstance(_args[9], types.FloatType) or isinstance(_args[9], types.IntType):
                                                                return self.__overloaded_setPosHprScale_ptrNodePath_ptrConstNodePath_float_float_float_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8], _args[9])
                                                            else:
    ...
    def setTwoSided(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_setTwoSided_ptrNodePath_bool(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setTwoSided_ptrNodePath_bool_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def __autoLerp(self, functorFunc, time, blendType, taskName):
        ...
        functor = functorFunc()
        lerp = AutonomousLerp.AutonomousLerp(functor, time, self.__getBlend(blendType), base.eventHandler)
        lerp.start()
        return lerp
