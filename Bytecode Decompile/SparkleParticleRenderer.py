...
class SparkleParticleRenderer(BaseParticleRenderer.BaseParticleRenderer, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLVecBase4f_ptrConstLVecBase4f_float_float___enum__SparkleParticleLifeScale___enum__ParticleRendererAlphaMode(self, center, edge, birthRadius, deathRadius, lifeScale, alphaMode):
        self.this = libpandaphysics._inPKBUAHOzb(center.this, edge.this, birthRadius, deathRadius, lifeScale, alphaMode)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstSparkleParticleRenderer(self, copy):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], SparkleParticleRenderer):
                    return self.__overloaded_constructor_ptrConstSparkleParticleRenderer(_args[0])
                else:
                                ...
                                if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                    if isinstance(_args[4], types.IntType):
                                        if isinstance(_args[5], types.IntType):
                                            return self.__overloaded_constructor_ptrConstLVecBase4f_ptrConstLVecBase4f_float_float___enum__SparkleParticleLifeScale___enum__ParticleRendererAlphaMode(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                                        else:
