...
class PGItem(PandaNode.PandaNode, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setFrame_ptrPGItem_ptrConstLVecBase4f(self, frame):
        returnValue = libpanda._inPWvimfDEN(self.this, frame.this)
        return returnValue

    def __overloaded_setFrame_ptrPGItem_float_float_float_float(self, left, right, bottom, top):
    ...
    def setFrame(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setFrame_ptrPGItem_ptrConstLVecBase4f(_args[0])
            else:
                    ...
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setFrame_ptrPGItem_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
