import types, libpanda, libpandaDowncasts, FFIExternalObject, ConnectionReader, QueuedReturnNetDatagram
...
class QueuedConnectionReader(ConnectionReader.ConnectionReader, QueuedReturnNetDatagram.QueuedReturnNetDatagram, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_getData_ptrQueuedConnectionReader_ptrDatagram(self, result):
        returnValue = libpanda._inP9ImM5yzz(self.this, result.this)
        return returnValue

    def __overloaded_getData_ptrQueuedConnectionReader_ptrNetDatagram(self, result):
    ...
    def getData(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Datagram.Datagram):
                return self.__overloaded_getData_ptrQueuedConnectionReader_ptrDatagram(_args[0])
            else:
                if isinstance(_args[0], NetDatagram.NetDatagram):
                    return self.__overloaded_getData_ptrQueuedConnectionReader_ptrNetDatagram(_args[0])
                else:
