...
class SmoothMover(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setScale_ptrSmoothMover_ptrConstLVecBase3f(self, scale):
        returnValue = libdirect._inPx5Y6VYzt(self.this, scale.this)
        return returnValue

    def __overloaded_setScale_ptrSmoothMover_float_float_float(self, sx, sy, sz):
    ...
    def __overloaded_setPos_ptrSmoothMover_ptrConstLVecBase3f(self, pos):
        returnValue = libdirect._inPx5Y6O99C(self.this, pos.this)
        return returnValue

    def __overloaded_setPos_ptrSmoothMover_float_float_float(self, x, y, z):
    ...
    def __overloaded_setHpr_ptrSmoothMover_ptrConstLVecBase3f(self, hpr):
        returnValue = libdirect._inPx5Y6HbNI(self.this, hpr.this)
        return returnValue

    def __overloaded_setHpr_ptrSmoothMover_float_float_float(self, h, p, r):
    ...
    def __overloaded_computeSmoothPosition_ptrSmoothMover(self):
        returnValue = libdirect._inPx5Y6NhMU(self.this)
        return returnValue

    def __overloaded_computeSmoothPosition_ptrSmoothMover_double(self, timestamp):
    ...
    def setPos(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase3.VBase3):
                return self.__overloaded_setPos_ptrSmoothMover_ptrConstLVecBase3f(_args[0])
            else:
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setPos_ptrSmoothMover_float_float_float(_args[0], _args[1], _args[2])
                        else:
    ...
    def setHpr(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return self.__overloaded_setHpr_ptrSmoothMover_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
        else:
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setHpr_ptrSmoothMover_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
    ...
    def computeSmoothPosition(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_computeSmoothPosition_ptrSmoothMover()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    return self.__overloaded_computeSmoothPosition_ptrSmoothMover_double(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            else:
    ...
    def setScale(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return self.__overloaded_setScale_ptrSmoothMover_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
        else:
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setScale_ptrSmoothMover_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
