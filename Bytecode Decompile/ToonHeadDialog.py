...
import DirectNotifyGlobal, ToontownDialog, ToonHead
...
class ToonHeadDialog(ToontownDialog.ToontownDialog):
    ...
    def __init__(self, dna, **kw):
        ...
        optiondefs = (
         (
          'dialogName', 'ToonHeadDialog', None), ('style', ToontownDialog.NoButtons, None), ('geom', head, None), ('geom_scale', 0.35, None), ('geom_pos', (-0.25, 0, 0), None), ('text_wordwrap', 9, None), ('fadeScreen', 0, None))
