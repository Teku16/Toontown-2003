...
class PGFrameStyle(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstPGFrameStyle(self, copy):
    ...
    def __overloaded_setColor_ptrPGFrameStyle_ptrConstLVecBase4f(self, color):
        returnValue = libpanda._inPWvimrDgP(self.this, color.this)
        return returnValue

    def __overloaded_setColor_ptrPGFrameStyle_float_float_float_float(self, r, g, b, a):
    ...
    def __overloaded_setWidth_ptrPGFrameStyle_ptrConstLVecBase2f(self, width):
        returnValue = libpanda._inPWvimIq9R(self.this, width.this)
        return returnValue

    def __overloaded_setWidth_ptrPGFrameStyle_float_float(self, x, y):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], PGFrameStyle):
                    return self.__overloaded_constructor_ptrConstPGFrameStyle(_args[0])
                else:
    ...
    def setWidth(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase2.VBase2):
                return self.__overloaded_setWidth_ptrPGFrameStyle_ptrConstLVecBase2f(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_setWidth_ptrPGFrameStyle_float_float(_args[0], _args[1])
                    else:
    ...
    def setColor(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setColor_ptrPGFrameStyle_ptrConstLVecBase4f(_args[0])
            else:
                    ...
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setColor_ptrPGFrameStyle_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
