...
class Mat4D(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLMatrix3d(self, upper3):
        self.this = libpanda._inPUZN3RSTZ(upper3.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstLMatrix3d_ptrConstLVecBase3d(self, upper3, trans):
        self.this = libpanda._inPUZN3y2xB(upper3.this, trans.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstLMatrix4d(self, other):
        self.this = libpanda._inPUZN3oOT1(other.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_double_double_double_double_double_double_double_double_double_double_double_double_double_double_double_double(self, e00, e01, e02, e03, e10, e11, e12, e13, e20, e21, e22, e23, e30, e31, e32, e33):
    ...
    def __overloaded_translateMat_ptrConstLVecBase3d(trans):
    ...
    __overloaded_translateMat_ptrConstLVecBase3d = staticmethod(__overloaded_translateMat_ptrConstLVecBase3d)

    def __overloaded_translateMat_double_double_double(tx, ty, tz):
    ...
    __overloaded_translateMat_double_double_double = staticmethod(__overloaded_translateMat_double_double_double)

    def __overloaded_rotateMat_double_ptrLVecBase3d___enum__CoordinateSystem(angle, axis, cs):
    ...
    __overloaded_rotateMat_double_ptrLVecBase3d___enum__CoordinateSystem = staticmethod(__overloaded_rotateMat_double_ptrLVecBase3d___enum__CoordinateSystem)

    def __overloaded_rotateMat_double_ptrLVecBase3d(angle, axis):
    ...
    __overloaded_rotateMat_double_ptrLVecBase3d = staticmethod(__overloaded_rotateMat_double_ptrLVecBase3d)

    def __overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d___enum__CoordinateSystem(angle, axis, cs):
    ...
    __overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d___enum__CoordinateSystem = staticmethod(__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d___enum__CoordinateSystem)

    def __overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d(angle, axis):
    ...
    __overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d = staticmethod(__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d)

    def __overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d_ptrLMatrix4d___enum__CoordinateSystem(angle, axis, resultMat, cs):
        returnValue = libpanda._inPUZN365kn(angle, axis.this, resultMat.this, cs)
        return returnValue

    __overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d_ptrLMatrix4d___enum__CoordinateSystem = staticmethod(__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d_ptrLMatrix4d___enum__CoordinateSystem)

    def __overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d_ptrLMatrix4d(angle, axis, resultMat):
        returnValue = libpanda._inPUZN3u6SM(angle, axis.this, resultMat.this)
        return returnValue

    __overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d_ptrLMatrix4d = staticmethod(__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d_ptrLMatrix4d)

    def __overloaded_scaleMat_ptrConstLVecBase3d(scale):
    ...
    __overloaded_scaleMat_ptrConstLVecBase3d = staticmethod(__overloaded_scaleMat_ptrConstLVecBase3d)

    def __overloaded_scaleMat_double(scale):
    ...
    __overloaded_scaleMat_double = staticmethod(__overloaded_scaleMat_double)

    def __overloaded_scaleMat_double_double_double(sx, sy, sz):
    ...
    __overloaded_scaleMat_double_double_double = staticmethod(__overloaded_scaleMat_double_double_double)
    ...
    def __overloaded_assign_ptrLMatrix4d_ptrConstLMatrix4d(self, other):
    ...
    def __overloaded_assign_ptrLMatrix4d_double(self, fillValue):
    ...
    def __overloaded_setRow_ptrLMatrix4d_int_ptrConstLVecBase3d(self, row, v):
        returnValue = libpanda._inPUZN34DFT(self.this, row, v.this)
        return returnValue

    def __overloaded_setRow_ptrLMatrix4d_int_ptrConstLVecBase4d(self, row, v):
        returnValue = libpanda._inPUZN3kD10(self.this, row, v.this)
        return returnValue

    def __overloaded_setCol_ptrLMatrix4d_int_ptrConstLVecBase3d(self, col, v):
        returnValue = libpanda._inPUZN3dmWa(self.this, col, v.this)
        return returnValue

    def __overloaded_setCol_ptrLMatrix4d_int_ptrConstLVecBase4d(self, col, v):
        returnValue = libpanda._inPUZN3JmG8(self.this, col, v.this)
        return returnValue

    def __overloaded_getRow_ptrConstLMatrix4d_ptrLVecBase4d_int(self, resultVec, row):
        returnValue = libpanda._inPUZN3Qxez(self.this, resultVec.this, row)
        return returnValue

    def __overloaded_getRow_ptrConstLMatrix4d_int(self, row):
    ...
    def __overloaded_getRow3_ptrConstLMatrix4d_ptrLVecBase3d_int(self, resultVec, row):
        returnValue = libpanda._inPUZN3fTWu(self.this, resultVec.this, row)
        return returnValue

    def __overloaded_getRow3_ptrConstLMatrix4d_int(self, row):
    ...
    def __overloaded___call___ptrLMatrix4d_int_int(self, row, col):
        returnValue = libpanda._inPUZN3ZgS1(self.this, row, col)
        return returnValue

    def __overloaded___call___ptrConstLMatrix4d_int_int(self, row, col):
    ...
    def __overloaded_begin_ptrLMatrix4d(self):
        returnValue = libpanda._inPUZN3jKXP(self.this)
        return returnValue

    def __overloaded_begin_ptrConstLMatrix4d(self):
        returnValue = libpanda._inPUZN3mQjW(self.this)
        return returnValue

    def __overloaded_end_ptrLMatrix4d(self):
        returnValue = libpanda._inPUZN3PBFI(self.this)
        return returnValue

    def __overloaded_end_ptrConstLMatrix4d(self):
    ...
    def __overloaded_compareTo_ptrConstLMatrix4d_ptrConstLMatrix4d(self, other):
        returnValue = libpanda._inPUZN3az9H(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLMatrix4d_ptrConstLMatrix4d_double(self, other, threshold):
    ...
    def __overloaded___mul___ptrConstLMatrix4d_ptrConstLMatrix4d(self, other):
    ...
    def __overloaded___mul___ptrConstLMatrix4d_double(self, scalar):
    ...
    def __overloaded___imul___ptrLMatrix4d_ptrConstLMatrix4d(self, other):
    ...
    def __overloaded___imul___ptrLMatrix4d_double(self, scalar):
    ...
    def __overloaded_almostEqual_ptrConstLMatrix4d_ptrConstLMatrix4d(self, other):
        returnValue = libpanda._inPUZN3qIgc(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLMatrix4d_ptrConstLMatrix4d_double(self, other, threshold):
    ...
    def __overloaded_write_ptrConstLMatrix4d_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPUZN3XBeC(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstLMatrix4d_ptrOstream(self, out):
    ...
    def scaleMat(*_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return Mat4D.__overloaded_scaleMat_double(_args[0])
            else:
                if isinstance(_args[0], VBase3D.VBase3D):
                    return Mat4D.__overloaded_scaleMat_ptrConstLVecBase3d(_args[0])
                else:
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return Mat4D.__overloaded_scaleMat_double_double_double(_args[0], _args[1], _args[2])
                        else:
    ...
    def translateMat(*_args):
        ...
        if numArgs == 1:
            import VBase3D
            if isinstance(_args[0], VBase3D.VBase3D):
                return Mat4D.__overloaded_translateMat_ptrConstLVecBase3d(_args[0])
            else:
            ...
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return Mat4D.__overloaded_translateMat_double_double_double(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                ...
                if numArgs == 2:
                    ...
                    if isinstance(_args[0], Mat3D.Mat3D):
                        ...
                        if isinstance(_args[1], VBase3D.VBase3D):
                            return self.__overloaded_constructor_ptrConstLMatrix3d_ptrConstLVecBase3d(_args[0], _args[1])
                        else:
                                                                            ...
                                                                            if isinstance(_args[13], types.FloatType) or isinstance(_args[13], types.IntType):
                                                                                if isinstance(_args[14], types.FloatType) or isinstance(_args[14], types.IntType):
                                                                                    if isinstance(_args[15], types.FloatType) or isinstance(_args[15], types.IntType):
                                                                                        return self.__overloaded_constructor_double_double_double_double_double_double_double_double_double_double_double_double_double_double_double_double(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8], _args[9], _args[10], _args[11], _args[12], _args[13], _args[14], _args[15])
                                                                                    else:
    ...
    def rotateMat(*_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                import VBase3D
                if isinstance(_args[1], VBase3D.VBase3D):
                    return Mat4D.__overloaded_rotateMat_double_ptrLVecBase3d(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3D.VBase3D> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], VBase3D.VBase3D):
                        if isinstance(_args[2], types.IntType):
                            return Mat4D.__overloaded_rotateMat_double_ptrLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                        else:
    ...
    def rotateMatNormaxis(*_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                import VBase3D
                if isinstance(_args[1], VBase3D.VBase3D):
                    return Mat4D.__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3D.VBase3D> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            ...
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], VBase3D.VBase3D):
                        if isinstance(_args[2], types.IntType):
                            return Mat4D.__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                        else:
                            if isinstance(_args[2], Mat4D):
                                return Mat4D.__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d_ptrLMatrix4d(_args[0], _args[1], _args[2])
                            else:
                        ...
                        if isinstance(_args[1], VBase3D.VBase3D):
                            if isinstance(_args[2], Mat4D):
                                if isinstance(_args[3], types.IntType):
                                    return Mat4D.__overloaded_rotateMatNormaxis_double_ptrConstLVecBase3d_ptrLMatrix4d___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3])
                                else:
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Mat4D):
                return self.__overloaded_almostEqual_ptrConstLMatrix4d_ptrConstLMatrix4d(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], Mat4D):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLMatrix4d_ptrConstLMatrix4d_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat4D> '
    ...
    def begin(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_begin_ptrConstLMatrix4d()
        else:
    ...
    def end(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_end_ptrConstLMatrix4d()
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 '
    ...
    def __imul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded___imul___ptrLMatrix4d_double(_args[0])
            else:
                if isinstance(_args[0], Mat4D):
                    return self.__overloaded___imul___ptrLMatrix4d_ptrConstLMatrix4d(_args[0])
                else:
    ...
    def getRow3(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_getRow3_ptrConstLMatrix4d_int(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], VBase3D.VBase3D):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_getRow3_ptrConstLMatrix4d_ptrLVecBase3d_int(_args[0], _args[1])
                    else:
    ...
    def getRow(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_getRow_ptrConstLMatrix4d_int(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], VBase4D.VBase4D):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_getRow_ptrConstLMatrix4d_ptrLVecBase4d_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstLMatrix4d_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstLMatrix4d_ptrOstream_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def __call__(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.IntType):
                    return self.__overloaded___call___ptrConstLMatrix4d_int_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def __mul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded___mul___ptrConstLMatrix4d_double(_args[0])
            else:
                if isinstance(_args[0], Mat4D):
                    return self.__overloaded___mul___ptrConstLMatrix4d_ptrConstLMatrix4d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <Mat4D> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Mat4D):
                return self.__overloaded_compareTo_ptrConstLMatrix4d_ptrConstLMatrix4d(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Mat4D> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], Mat4D):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLMatrix4d_ptrConstLMatrix4d_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat4D> '
    ...
    def setCol(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                import VBase4D, VBase3D
                if isinstance(_args[1], VBase4D.VBase4D):
                    return self.__overloaded_setCol_ptrLMatrix4d_int_ptrConstLVecBase4d(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase3D.VBase3D):
                        return self.__overloaded_setCol_ptrLMatrix4d_int_ptrConstLVecBase3d(_args[0], _args[1])
                    else:
    ...
    def setRow(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                import VBase4D, VBase3D
                if isinstance(_args[1], VBase4D.VBase4D):
                    return self.__overloaded_setRow_ptrLMatrix4d_int_ptrConstLVecBase4d(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase3D.VBase3D):
                        return self.__overloaded_setRow_ptrLMatrix4d_int_ptrConstLVecBase3d(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase4D.VBase4D> <VBase3D.VBase3D> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLMatrix4d_double(_args[0])
            else:
                if isinstance(_args[0], Mat4D):
                    return self.__overloaded_assign_ptrLMatrix4d_ptrConstLMatrix4d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <Mat4D> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '