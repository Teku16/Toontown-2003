...
class DocumentSpec(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstDocumentSpec(self, copy):
        self.this = libpandaexpress._inP2KOdqhhh(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstURLSpec(self, url):
    ...
    def __overloaded_write_ptrConstDocumentSpec_ptrOstream_int(self, out, indentLevel):
        returnValue = libpandaexpress._inP2KOdEH_O(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstDocumentSpec_ptrOstream(self, out):
                ...
                if isinstance(_args[0], types.StringType):
                    ...
                    if isinstance(_args[0], URLSpec.URLSpec):
                        ...
                        if isinstance(_args[0], DocumentSpec):
                            return self.__overloaded_constructor_ptrConstDocumentSpec(_args[0])
                        else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstDocumentSpec_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstDocumentSpec_ptrOstream_int(_args[0], _args[1])
                    else:
