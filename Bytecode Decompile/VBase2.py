...
class VBase2(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_assign_ptrLVecBase2f_ptrConstLVecBase2f(self, copy):
    ...
    def __overloaded_assign_ptrLVecBase2f_float(self, fillValue):
    ...
    def __overloaded___getitem___ptrLVecBase2f_int(self, i):
        returnValue = libpanda._inPUZN3b1X1(self.this, i)
        return returnValue

    def __overloaded___getitem___ptrConstLVecBase2f_int(self, i):
    ...
    def __overloaded_compareTo_ptrConstLVecBase2f_ptrConstLVecBase2f(self, other):
        returnValue = libpanda._inPUZN3KWAg(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLVecBase2f_ptrConstLVecBase2f_float(self, other, threshold):
        returnValue = libpanda._inPUZN3gmxE(self.this, other.this, threshold)
        return returnValue

    def __overloaded___sub___ptrConstLVecBase2f(self):
    ...
    def __overloaded___sub___ptrConstLVecBase2f_ptrConstLVecBase2f(self, other):
    ...
    def __overloaded_almostEqual_ptrConstLVecBase2f_ptrConstLVecBase2f(self, other):
        returnValue = libpanda._inPUZN3KeTt(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLVecBase2f_ptrConstLVecBase2f_float(self, other, threshold):
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase2):
                return self.__overloaded_almostEqual_ptrConstLVecBase2f_ptrConstLVecBase2f(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], VBase2):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLVecBase2f_ptrConstLVecBase2f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase2> '
    ...
    def __sub__(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded___sub___ptrConstLVecBase2f()
        else:
            if numArgs == 1:
                if isinstance(_args[0], VBase2):
                    return self.__overloaded___sub___ptrConstLVecBase2f_ptrConstLVecBase2f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase2> '
            else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLVecBase2f_float(_args[0])
            else:
                if isinstance(_args[0], VBase2):
                    return self.__overloaded_assign_ptrLVecBase2f_ptrConstLVecBase2f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase2> '
        else:
    ...
    def __getitem__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded___getitem___ptrConstLVecBase2f_int(_args[0])
            else:
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase2):
                return self.__overloaded_compareTo_ptrConstLVecBase2f_ptrConstLVecBase2f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase2> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], VBase2):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLVecBase2f_ptrConstLVecBase2f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase2> '
