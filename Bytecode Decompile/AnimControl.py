...
class AnimControl(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_play_ptrAnimControl_ptrConstEvent(self, stopEvent):
        returnValue = libpanda._inPn9gMVPKG(self.this, stopEvent.this)
        return returnValue

    def __overloaded_play_ptrAnimControl(self):
        returnValue = libpanda._inPn9gMp7rs(self.this)
        return returnValue

    def __overloaded_play_ptrAnimControl_int_int_ptrConstEvent(self, _from, to, stopEvent):
        returnValue = libpanda._inPn9gMId_s(self.this, _from, to, stopEvent.this)
        return returnValue

    def __overloaded_play_ptrAnimControl_int_int(self, _from, to):
        returnValue = libpanda._inPn9gMfBT0(self.this, _from, to)
        return returnValue

    def __overloaded_loop_ptrAnimControl_bool(self, restart):
        returnValue = libpanda._inPn9gMKXO_(self.this, restart)
        return returnValue

    def __overloaded_loop_ptrAnimControl_bool_int_int(self, restart, _from, to):
    ...
    def play(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_play_ptrAnimControl()
        else:
            if numArgs == 1:
                import Event
                if isinstance(_args[0], Event.Event):
                    return self.__overloaded_play_ptrAnimControl_ptrConstEvent(_args[0])
                else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.IntType):
                            return self.__overloaded_play_ptrAnimControl_int_int(_args[0], _args[1])
                        else:
                        ...
                        if isinstance(_args[0], types.IntType):
                            if isinstance(_args[1], types.IntType):
                                ...
                                if isinstance(_args[2], Event.Event):
                                    return self.__overloaded_play_ptrAnimControl_int_int_ptrConstEvent(_args[0], _args[1], _args[2])
                                else:
    ...
    def loop(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_loop_ptrAnimControl_bool(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            if numArgs == 3:
                if isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_loop_ptrAnimControl_bool_int_int(_args[0], _args[1], _args[2])
                        else:
