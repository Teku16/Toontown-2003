...
class CardMaker(Namable.Namable, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setFrame_ptrCardMaker_ptrConstLVecBase4f(self, frame):
        returnValue = libpanda._inPWs2xLOM1(self.this, frame.this)
        return returnValue

    def __overloaded_setFrame_ptrCardMaker_float_float_float_float(self, left, right, bottom, top):
        returnValue = libpanda._inPWs2x2xT3(self.this, left, right, bottom, top)
        return returnValue

    def __overloaded_setColor_ptrCardMaker_ptrConstLVecBase4f(self, color):
        returnValue = libpanda._inPWs2xolpK(self.this, color.this)
        return returnValue

    def __overloaded_setColor_ptrCardMaker_float_float_float_float(self, r, g, b, a):
    ...
    def setColor(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setColor_ptrCardMaker_ptrConstLVecBase4f(_args[0])
            else:
                    ...
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setColor_ptrCardMaker_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
    ...
    def setFrame(self, *_args):
        ...
        if numArgs == 1:
            import VBase4
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setFrame_ptrCardMaker_ptrConstLVecBase4f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase4.VBase4> '
        else:
            if numArgs == 4:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setFrame_ptrCardMaker_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
                                raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
