import string, whrandom, Localizer

class ChatGarbler:
    __module__ = __name__
    animalSounds = {'dog': Localizer.ChatGarblerDog, 'cat': Localizer.ChatGarblerCat, 'mouse': Localizer.ChatGarblerMouse, 'horse': Localizer.ChatGarblerHorse, 'rabbit': Localizer.ChatGarblerRabbit, 'fowl': Localizer.ChatGarblerFowl, 'default': Localizer.ChatGarblerDefault}
