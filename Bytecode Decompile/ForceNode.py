...
class ForceNode(PandaNode.PandaNode, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_removeForce_ptrForceNode_ptrBaseForce(self, f):
        returnValue = libpandaphysics._inP9fJJhgaF(self.this, f.this)
        return returnValue

    def __overloaded_removeForce_ptrForceNode_int(self, index):
    ...
    def removeForce(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_removeForce_ptrForceNode_int(_args[0])
            else:
                if isinstance(_args[0], BaseForce.BaseForce):
                    return self.__overloaded_removeForce_ptrForceNode_ptrBaseForce(_args[0])
                else:
