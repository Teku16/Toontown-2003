...
class LightAttrib(RenderAttrib.RenderAttrib, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_make___enum__Operation_ptrLight(op, light):
    ...
    __overloaded_make___enum__Operation_ptrLight = staticmethod(__overloaded_make___enum__Operation_ptrLight)

    def __overloaded_make___enum__Operation_ptrLight_ptrLight(op, light1, light2):
    ...
    __overloaded_make___enum__Operation_ptrLight_ptrLight = staticmethod(__overloaded_make___enum__Operation_ptrLight_ptrLight)

    def __overloaded_make___enum__Operation_ptrLight_ptrLight_ptrLight(op, light1, light2, light3):
    ...
    __overloaded_make___enum__Operation_ptrLight_ptrLight_ptrLight = staticmethod(__overloaded_make___enum__Operation_ptrLight_ptrLight_ptrLight)

    def __overloaded_make___enum__Operation_ptrLight_ptrLight_ptrLight_ptrLight(op, light1, light2, light3, light4):
    ...
    __overloaded_make___enum__Operation_ptrLight_ptrLight_ptrLight_ptrLight = staticmethod(__overloaded_make___enum__Operation_ptrLight_ptrLight_ptrLight_ptrLight)
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], Light.Light):
                    return LightAttrib.__overloaded_make___enum__Operation_ptrLight(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], Light.Light):
                        ...
                        if isinstance(_args[2], Light.Light):
                            return LightAttrib.__overloaded_make___enum__Operation_ptrLight_ptrLight(_args[0], _args[1], _args[2])
                        else:
                        ...
                        if isinstance(_args[1], Light.Light):
                            ...
                            if isinstance(_args[2], Light.Light):
                                ...
                                if isinstance(_args[3], Light.Light):
                                    return LightAttrib.__overloaded_make___enum__Operation_ptrLight_ptrLight_ptrLight(_args[0], _args[1], _args[2], _args[3])
                                else:
                                ...
                                if isinstance(_args[2], Light.Light):
                                    ...
                                    if isinstance(_args[3], Light.Light):
                                        ...
                                        if isinstance(_args[4], Light.Light):
                                            return LightAttrib.__overloaded_make___enum__Operation_ptrLight_ptrLight_ptrLight_ptrLight(_args[0], _args[1], _args[2], _args[3], _args[4])
                                        else:
