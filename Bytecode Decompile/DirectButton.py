...
class DirectButton(DirectFrame):
    ...
    def __init__(self, parent=aspect2d, **kw):
        optiondefs = (
         (
          'pgFunc', PGButton, None), ('numStates', 4, None), ('state', NORMAL, None), ('invertedFrames', (1,), None), ('command', None, None), ('extraArgs', [], None), ('commandButtons', (LMB,), self.setCommandButtons), ('rolloverSound', getDefaultRolloverSound(), self.setRolloverSound), ('clickSound', getDefaultClickSound(), self.setClickSound), ('pressEffect', 1, INITOPT))
