...
import ToontownGlobals, ToontownBattleGlobals, DirectNotifyGlobal, FSM, DistributedObject, State, BattleBase, ZoneUtil
...
class DistributedSuitInterior(DistributedObject.DistributedObject):
    ...
    def handleAnnounceGenerate(self, obj):
        ...
        self.sendUpdate('setAvatarJoined', [toonbase.localToon.getName(), toonbase.localToon.getStyle().makeNetString()])
