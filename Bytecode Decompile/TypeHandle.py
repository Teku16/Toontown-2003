...
class TypeHandle(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstTypeHandle(self, copy):
    ...
    def __overloaded_getName_ptrConstTypeHandle_ptrTypedObject(self, object):
        returnValue = libpandaexpress._inPJoxteQdg(self.this, object.this)
        return returnValue

    def __overloaded_getName_ptrConstTypeHandle(self):
        returnValue = libpandaexpress._inPJoxtiwj6(self.this)
        return returnValue

    def __overloaded_isDerivedFrom_ptrConstTypeHandle_ptrTypeHandle_ptrTypedObject(self, parent, object):
        returnValue = libpandaexpress._inPJoxtox87(self.this, parent.this, object.this)
        return returnValue

    def __overloaded_isDerivedFrom_ptrConstTypeHandle_ptrTypeHandle(self, parent):
        returnValue = libpandaexpress._inPJoxtviuC(self.this, parent.this)
        return returnValue

    def __overloaded_getNumParentClasses_ptrConstTypeHandle_ptrTypedObject(self, object):
        returnValue = libpandaexpress._inPJoxtiY1k(self.this, object.this)
        return returnValue

    def __overloaded_getNumParentClasses_ptrConstTypeHandle(self):
    ...
    def __overloaded_getNumChildClasses_ptrConstTypeHandle_ptrTypedObject(self, object):
        returnValue = libpandaexpress._inPJoxtbcCX(self.this, object.this)
        return returnValue

    def __overloaded_getNumChildClasses_ptrConstTypeHandle(self):
    ...
    def __overloaded_getParentTowards_ptrConstTypeHandle_ptrTypeHandle_ptrTypedObject(self, ancestor, object):
    ...
    def __overloaded_getParentTowards_ptrConstTypeHandle_ptrTypeHandle(self, ancestor):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], TypeHandle):
                    return self.__overloaded_constructor_ptrConstTypeHandle(_args[0])
                else:
    ...
    def getParentTowards(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], TypeHandle):
                return self.__overloaded_getParentTowards_ptrConstTypeHandle_ptrTypeHandle(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <TypeHandle> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], TypeHandle):
                    ...
                    if isinstance(_args[1], TypedObject.TypedObject):
                        return self.__overloaded_getParentTowards_ptrConstTypeHandle_ptrTypeHandle_ptrTypedObject(_args[0], _args[1])
                    else:
    ...
    def getName(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getName_ptrConstTypeHandle()
        else:
            if numArgs == 1:
                import TypedObject
                if isinstance(_args[0], TypedObject.TypedObject):
                    return self.__overloaded_getName_ptrConstTypeHandle_ptrTypedObject(_args[0])
                else:
    ...
    def getNumParentClasses(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getNumParentClasses_ptrConstTypeHandle()
        else:
            if numArgs == 1:
                import TypedObject
                if isinstance(_args[0], TypedObject.TypedObject):
                    return self.__overloaded_getNumParentClasses_ptrConstTypeHandle_ptrTypedObject(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <TypedObject.TypedObject> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def getNumChildClasses(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getNumChildClasses_ptrConstTypeHandle()
        else:
            if numArgs == 1:
                import TypedObject
                if isinstance(_args[0], TypedObject.TypedObject):
                    return self.__overloaded_getNumChildClasses_ptrConstTypeHandle_ptrTypedObject(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <TypedObject.TypedObject> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def isDerivedFrom(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], TypeHandle):
                return self.__overloaded_isDerivedFrom_ptrConstTypeHandle_ptrTypeHandle(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <TypeHandle> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], TypeHandle):
                    import TypedObject
                    if isinstance(_args[1], TypedObject.TypedObject):
                        return self.__overloaded_isDerivedFrom_ptrConstTypeHandle_ptrTypeHandle_ptrTypedObject(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <TypedObject.TypedObject> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <TypeHandle> '
