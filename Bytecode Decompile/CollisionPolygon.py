import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, CollisionPlane
...
class CollisionPolygon(CollisionPlane.CollisionPlane, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLPoint3f_ptrConstLPoint3f(self, begin, end):
    ...
    def __overloaded_constructor_ptrConstLPoint3f_ptrConstLPoint3f_ptrConstLPoint3f_ptrConstLPoint3f(self, a, b, c, d):
                        ...
                        if isinstance(_args[1], Point3.Point3):
                            ...
                            if isinstance(_args[2], Point3.Point3):
                                ...
                                if isinstance(_args[3], Point3.Point3):
                                    return self.__overloaded_constructor_ptrConstLPoint3f_ptrConstLPoint3f_ptrConstLPoint3f_ptrConstLPoint3f(_args[0], _args[1], _args[2], _args[3])
                                else:
