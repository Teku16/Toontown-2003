...
import whrandom, Localizer, DirectNotifyGlobal
CLOTHES_MAKETOON = 0
CLOTHES_TAILOR = 1
CLOTHES_CLOSET = 2
...
class ClothesGUI(PandaObject.PandaObject, StateData.StateData):
    ...
    def load(self):
        ...
        if self.type == CLOTHES_MAKETOON:
            ...
            botLPos = (-0.45, 0, 0.1)
            botRPos = (0.45, 0, 0.1)
        self.topLButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image_scale=(-1, 1, 1), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text=Localizer.ClothesShopShirt, text_scale=0.0625, text_pos=(0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=topLPos, command=self.swapTop, extraArgs=[-1])
        self.topRButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text=Localizer.ClothesShopShirt, text_scale=0.0625, text_pos=(-0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=topRPos, command=self.swapTop, extraArgs=[1])
        self.bottomLButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image_scale=(-1, 1, 1), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text='', text_scale=0.0625, text_pos=(0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=botLPos, command=self.swapBottom, extraArgs=[-1])
        self.bottomRButton = DirectButton(relief=None, image=(guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color=Vec4(0.5, 0.5, 0.5, 0.75), text='', text_scale=0.0625, text_pos=(-0.025, 0), text_fg=(0.8, 0.1, 0, 1), pos=botRPos, command=self.swapBottom, extraArgs=[1])
