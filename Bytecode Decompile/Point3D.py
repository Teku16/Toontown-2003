...
class Point3D(VBase3D.VBase3D, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_assign_ptrLPoint3d_ptrConstLVecBase3d(self, copy):
    ...
    def __overloaded_assign_ptrLPoint3d_double(self, fillValue):
    ...
    def __overloaded___sub___ptrConstLPoint3d(self):
    ...
    def __overloaded___sub___ptrConstLPoint3d_ptrConstLPoint3d(self, other):
    ...
    def __overloaded___sub___ptrConstLPoint3d_ptrConstLVecBase3d(self, other):
    ...
    def __overloaded___sub___ptrConstLPoint3d_ptrConstLVector3d(self, other):
    ...
    def __overloaded___add___ptrConstLPoint3d_ptrConstLVecBase3d(self, other):
    ...
    def __overloaded___add___ptrConstLPoint3d_ptrConstLVector3d(self, other):
    ...
    def origin(*_args):
        numArgs = len(_args)
        if numArgs == 0:
            return Point3D.__overloaded_origin()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return Point3D.__overloaded_origin___enum__CoordinateSystem(_args[0])
                else:
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        return Point3D.__overloaded_rfu_double_double_double(_args[0], _args[1], _args[2])
                    else:
                    ...
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.IntType):
                                return Point3D.__overloaded_rfu_double_double_double___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3])
                            else:
    ...
    def __sub__(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded___sub___ptrConstLPoint3d()
        else:
            if numArgs == 1:
                import VBase3D, Vec3D
                if isinstance(_args[0], VBase3D.VBase3D):
                    return self.__overloaded___sub___ptrConstLPoint3d_ptrConstLVecBase3d(_args[0])
                else:
                    if isinstance(_args[0], Vec3D.Vec3D):
                        return self.__overloaded___sub___ptrConstLPoint3d_ptrConstLVector3d(_args[0])
                    else:
                        if isinstance(_args[0], Point3D):
                            return self.__overloaded___sub___ptrConstLPoint3d_ptrConstLPoint3d(_args[0])
                        else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            import VBase3D
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLPoint3d_double(_args[0])
            else:
                if isinstance(_args[0], VBase3D.VBase3D):
                    return self.__overloaded_assign_ptrLPoint3d_ptrConstLVecBase3d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase3D.VBase3D> '
        else:
    ...
    def __add__(self, *_args):
        ...
        if numArgs == 1:
            import VBase3D, Vec3D
            if isinstance(_args[0], VBase3D.VBase3D):
                return self.__overloaded___add___ptrConstLPoint3d_ptrConstLVecBase3d(_args[0])
            else:
                if isinstance(_args[0], Vec3D.Vec3D):
                    return self.__overloaded___add___ptrConstLPoint3d_ptrConstLVector3d(_args[0])
                else:
