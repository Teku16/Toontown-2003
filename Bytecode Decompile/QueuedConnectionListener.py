import types, libpanda, libpandaDowncasts, FFIExternalObject, ConnectionListener, QueuedReturnConnectionListenerData
...
class QueuedConnectionListener(ConnectionListener.ConnectionListener, QueuedReturnConnectionListenerData.QueuedReturnConnectionListenerData, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_getNewConnection_ptrQueuedConnectionListener_ptrPointerToConnection(self, newConnection):
        returnValue = libpanda._inP9ImMwbmC(self.this, newConnection.this)
        return returnValue

    def __overloaded_getNewConnection_ptrQueuedConnectionListener_ptrPointerToConnection_ptrNetAddress_ptrPointerToConnection(self, rendezvous, address, newConnection):
    ...
    def getNewConnection(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], PointerToConnection.PointerToConnection):
                return self.__overloaded_getNewConnection_ptrQueuedConnectionListener_ptrPointerToConnection(_args[0])
            else:
                ...
                if isinstance(_args[0], PointerToConnection.PointerToConnection):
                    ...
                    if isinstance(_args[1], NetAddress.NetAddress):
                        ...
                        if isinstance(_args[2], PointerToConnection.PointerToConnection):
                            return self.__overloaded_getNewConnection_ptrQueuedConnectionListener_ptrPointerToConnection_ptrNetAddress_ptrPointerToConnection(_args[0], _args[1], _args[2])
                        else:
