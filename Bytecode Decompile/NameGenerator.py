...
import whrandom, string, copy, ToontownGlobals, Localizer, os, DirectNotifyGlobal
...
class NameGenerator:
    ...
    def randomName(self, boy=0, girl=0):
        ...
        if not boy and not girl:
            ...
            girl = not boy
        uberFlag = whrandom.choice(['title-first', 'title-last', 'first', 'last', 'first-last', 'title-first-last'])
        titleFlag = 0
