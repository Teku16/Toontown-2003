...
import DirectNotifyGlobal, Place, PandaObject, StateData, FSM, State, Task, ToontownGlobals, Localizer
...
class ToonInterior(Place.Place):
    ...
    def __init__(self, loader, parentFSMState, doneEvent):
        ...
        self.fsm = FSM.FSM('ToonInterior', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'stickerBook', 'doorOut', 'DFA', 'teleportOut', 'quest', 'purchase']),
    ...
    def enter(self, requestStatus):
        ...
        base.playMusic(self.loader.activityMusic, looping=1, volume=0.7)
