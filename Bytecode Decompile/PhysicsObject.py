import types, libpandaphysics, libpandaphysicsDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, TypedReferenceCount
...
class PhysicsObject(TypedReferenceCount.TypedReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstPhysicsObject(self, copy):
    ...
    def __overloaded_setPosition_ptrPhysicsObject_ptrConstLPoint3f(self, pos):
        returnValue = libpandaphysics._inP9fJJ2gAg(self.this, pos.this)
        return returnValue

    def __overloaded_setPosition_ptrPhysicsObject_float_float_float(self, x, y, z):
    ...
    def __overloaded_setVelocity_ptrPhysicsObject_ptrConstLVector3f(self, vel):
        returnValue = libpandaphysics._inP9fJJZTzH(self.this, vel.this)
        return returnValue

    def __overloaded_setVelocity_ptrPhysicsObject_float_float_float(self, x, y, z):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], PhysicsObject):
                    return self.__overloaded_constructor_ptrConstPhysicsObject(_args[0])
                else:
    ...
    def setPosition(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Point3.Point3):
                return self.__overloaded_setPosition_ptrPhysicsObject_ptrConstLPoint3f(_args[0])
            else:
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setPosition_ptrPhysicsObject_float_float_float(_args[0], _args[1], _args[2])
                        else:
    ...
    def setVelocity(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Vec3.Vec3):
                return self.__overloaded_setVelocity_ptrPhysicsObject_ptrConstLVector3f(_args[0])
            else:
            ...
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setVelocity_ptrPhysicsObject_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
