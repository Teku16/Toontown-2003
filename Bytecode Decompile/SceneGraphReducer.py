...
class SceneGraphReducer(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_applyAttribs_ptrSceneGraphReducer_ptrPandaNode_ptrConstAccumulatedAttribs_int_ptrGeomTransformer(self, node, attribs, attribTypes, transformer):
        returnValue = libpanda._inPkJyo8UjV(self.this, node.this, attribs.this, attribTypes, transformer.this)
        return returnValue

    def __overloaded_applyAttribs_ptrSceneGraphReducer_ptrPandaNode_int(self, node, attribTypes):
        returnValue = libpanda._inPkJyoTFiF(self.this, node.this, attribTypes)
        return returnValue

    def __overloaded_applyAttribs_ptrSceneGraphReducer_ptrPandaNode(self, node):
    ...
    def applyAttribs(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], PandaNode.PandaNode):
                return self.__overloaded_applyAttribs_ptrSceneGraphReducer_ptrPandaNode(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], PandaNode.PandaNode):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_applyAttribs_ptrSceneGraphReducer_ptrPandaNode_int(_args[0], _args[1])
                    else:
                        ...
                        if isinstance(_args[1], AccumulatedAttribs.AccumulatedAttribs):
                            if isinstance(_args[2], types.IntType):
                                ...
                                if isinstance(_args[3], GeomTransformer.GeomTransformer):
                                    return self.__overloaded_applyAttribs_ptrSceneGraphReducer_ptrPandaNode_ptrConstAccumulatedAttribs_int_ptrGeomTransformer(_args[0], _args[1], _args[2], _args[3])
                                else:
