...
class VBase4(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_assign_ptrLVecBase4f_ptrConstLVecBase4f(self, copy):
    ...
    def __overloaded_assign_ptrLVecBase4f_float(self, fillValue):
    ...
    def __overloaded___getitem___ptrLVecBase4f_int(self, i):
        returnValue = libpanda._inPUZN3Ay34(self.this, i)
        return returnValue

    def __overloaded___getitem___ptrConstLVecBase4f_int(self, i):
    ...
    def __overloaded_compareTo_ptrConstLVecBase4f_ptrConstLVecBase4f(self, other):
        returnValue = libpanda._inPUZN3iXnx(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLVecBase4f_ptrConstLVecBase4f_float(self, other, threshold):
        returnValue = libpanda._inPUZN3IZYW(self.this, other.this, threshold)
        return returnValue

    def __overloaded___sub___ptrConstLVecBase4f(self):
    ...
    def __overloaded___sub___ptrConstLVecBase4f_ptrConstLVecBase4f(self, other):
    ...
    def __overloaded_almostEqual_ptrConstLVecBase4f_ptrConstLVecBase4f(self, other):
        returnValue = libpanda._inPUZN3zKzg(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLVecBase4f_ptrConstLVecBase4f_float(self, other, threshold):
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase4):
                return self.__overloaded_almostEqual_ptrConstLVecBase4f_ptrConstLVecBase4f(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], VBase4):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLVecBase4f_ptrConstLVecBase4f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase4> '
    ...
    def __sub__(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded___sub___ptrConstLVecBase4f()
        else:
            if numArgs == 1:
                if isinstance(_args[0], VBase4):
                    return self.__overloaded___sub___ptrConstLVecBase4f_ptrConstLVecBase4f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase4> '
            else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLVecBase4f_float(_args[0])
            else:
                if isinstance(_args[0], VBase4):
                    return self.__overloaded_assign_ptrLVecBase4f_ptrConstLVecBase4f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase4> '
        else:
    ...
    def __getitem__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded___getitem___ptrConstLVecBase4f_int(_args[0])
            else:
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase4):
                return self.__overloaded_compareTo_ptrConstLVecBase4f_ptrConstLVecBase4f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase4> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], VBase4):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLVecBase4f_ptrConstLVecBase4f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase4> '
