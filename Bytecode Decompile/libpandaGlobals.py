import types, libpanda, DSearchPath, Mat3D, Vec3D, Mat3, Vec3, Mat4D, Mat4, QuatD, Quat, Point2D, Point2, Point3D, Point3, VBase3D, VBase3, VBase4D, VBase4, Vec2D, Vec2, PandaNode, AnimControlCollection
...
def lookAt(*_args):
    numArgs = len(_args)
    if numArgs == 2:
        import QuatD, Quat, Mat4D, Mat4, Mat3D, Mat3
...
def __mul__(*_args):
    numArgs = len(_args)
    if numArgs == 2:
        import Vec3D, Vec3, Vec2D, Vec2, VBase4D, VBase4, VBase3D, VBase3, Point3D, Point3, Point2D, Point2, Mat4D, Mat4, Mat3D, Mat3
