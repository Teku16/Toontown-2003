import types, libpanda, libpandaDowncasts, FFIExternalObject, PointerToBaseRefCountObjvectorLVecBase4f
...
class PTAColorf(PointerToBaseRefCountObjvectorLVecBase4f.PointerToBaseRefCountObjvectorLVecBase4f, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstPTAColorf(self, copy):
        self.this = libpanda._inPUZN3yy4B(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_unsignedint_ptrConstLVecBase4f(self, n, value):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], PTAColorf):
                    return self.__overloaded_constructor_ptrConstPTAColorf(_args[0])
                else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], types.IntType):
                        ...
                        if isinstance(_args[1], VBase4.VBase4):
                            return self.__overloaded_constructor_unsignedint_ptrConstLVecBase4f(_args[0], _args[1])
                        else:
