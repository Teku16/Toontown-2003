...
import DirectNotifyGlobal, FSM, DistributedObject, State, DNADoor, random, ToonInteriorColors, CollisionSphere, CollisionNode, ZoneUtil, AvatarDNA, ToonHead, HouseGlobals
...
class DistributedHouseInterior(DistributedObject.DistributedObject):
    ...
    def setup(self):
        ...
        self.__setupClosetNode()
        self.__setupBankNode()
        self.__colorWalls()
        self.__setupWindowBoxes()
        self.fsm.request('toon')

    def __colorWalls(self):
        sideWallNames = [
         'wall_side_top', 'wall_side_middle', 'wall_side_bottom']
        frontWallNames = ['wall_front_top', 'wall_front_middle', 'wall_front_bottom']
        frontWindows = ['windowcut_c', 'windowcut_e', 'windowcut_f']
        sideWindows = ['windowcut_a', 'windowcut_b', 'windowcut_d']
        woods = ['wall_side_top', 'wall_side_bottom', 'wall_front_top', 'wall_front_bottom', 'floor']
    ...
    def __setupWindowBoxesHardCoded(self):
        ...
        windowC.hide()
        toonbase.localToon.windows = [nodeA, nodeB, nodeC]

    def __setupFurniture(self):
        bedModels = [
         'phase_5.5/models/estate/regular_bed.bam', 'phase_5.5/models/estate/girly_bed.bam', 'phase_5.5/models/estate/bathtub_bed.bam']
        fireplaceModels = [
         'phase_5.5/models/estate/FireplaceSq.bam', 'phase_5.5/models/estate/FireplaceGirlee.bam', 'phase_5.5/models/estate/FireplaceRound.bam']
        instrumentModels = [
         'phase_5.5/models/estate/Piano.bam', 'phase_5.5/models/estate/Organ.bam']
        chairModels = [
        ...
        bed.setPosHpr(-21.9712, 5.00176, 0.025, 135, 0, 0)
        fireplace.reparentTo(self.interior)
        fireplace.setPosHpr(16.0425, -8.75871, 0.025, -90, 0, 0)
        chair.reparentTo(self.interior)
        chair.setScale(12)
        chair.setPosHpr(3.73875, -1.82998, 0.025, 22.5, 0, 0)
        chair2 = chair.copyTo(self.interior)
        chair2.setScale(12)
        chair2.setPosHpr(8.82943, 0, 0.025, -45, 0, 0)
    ...
    def handleEnterSphere(self, collEntry):
        messenger.send('enterCloset', [collEntry])