...
class PStatCollector(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstPStatCollector_atomicstring(self, parent, name):
        self.this = libpanda._inPiqKx0IR6(parent.this, name)
        self.userManagesMemory = 1

    def __overloaded_constructor_atomicstring_ptrPStatClient(self, name, client):
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    ...
                    if isinstance(_args[1], PStatClient.PStatClient):
                        return self.__overloaded_constructor_atomicstring_ptrPStatClient(_args[0], _args[1])
                    else:
                    ...
                    if isinstance(_args[0], PStatCollector):
                        if isinstance(_args[1], types.StringType):
                            return self.__overloaded_constructor_ptrConstPStatCollector_atomicstring(_args[0], _args[1])
                        else:
