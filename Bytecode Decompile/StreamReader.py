...
class StreamReader(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstStreamReader(self, copy):
        self.this = libpandaexpress._inPJoxtEpUz(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrIstream_bool(self, _in, ownsStream):
    ...
    def constructor(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], StreamReader):
                return self.__overloaded_constructor_ptrConstStreamReader(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Istream.Istream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_constructor_ptrIstream_bool(_args[0], _args[1])
                    else:
