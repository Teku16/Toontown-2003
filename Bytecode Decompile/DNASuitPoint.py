...
class DNASuitPoint(TypedReferenceCount.TypedReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_int___enum__DNASuitPointType_ptrLPoint3f_int(self, index, type, pos, lbIndex):
        self.this = libtoontown._inPet4yraal(index, type, pos.this, lbIndex)
        self.userManagesMemory = 1

    def __overloaded_constructor_int___enum__DNASuitPointType_ptrLPoint3f(self, index, type, pos):
    ...
    def __overloaded_write_ptrConstDNASuitPoint_ptrOstream_int(self, out, indentLevel):
        returnValue = libtoontown._inPet4yv_3h(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstDNASuitPoint_ptrOstream(self, out):
            ...
            if isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.IntType):
                    ...
                    if isinstance(_args[2], Point3.Point3):
                        return self.__overloaded_constructor_int___enum__DNASuitPointType_ptrLPoint3f(_args[0], _args[1], _args[2])
                    else:
                    ...
                    if isinstance(_args[1], types.IntType):
                        ...
                        if isinstance(_args[2], Point3.Point3):
                            if isinstance(_args[3], types.IntType):
                                return self.__overloaded_constructor_int___enum__DNASuitPointType_ptrLPoint3f_int(_args[0], _args[1], _args[2], _args[3])
                            else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstDNASuitPoint_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstDNASuitPoint_ptrOstream_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
