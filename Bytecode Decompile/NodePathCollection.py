...
class NodePathCollection(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstNodePathCollection(self, copy):
    ...
    def __overloaded_ls_ptrConstNodePathCollection(self):
        returnValue = libpanda._inPkJyowQA8(self.this)
        return returnValue

    def __overloaded_ls_ptrConstNodePathCollection_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPkJyoQtqi(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_ls_ptrConstNodePathCollection_ptrOstream(self, out):
    ...
    def __overloaded_write_ptrConstNodePathCollection_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPkJyocn9H(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstNodePathCollection_ptrOstream(self, out):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], NodePathCollection):
                    return self.__overloaded_constructor_ptrConstNodePathCollection(_args[0])
                else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstNodePathCollection_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstNodePathCollection_ptrOstream_int(_args[0], _args[1])
                    else:
    ...
    def ls(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_ls_ptrConstNodePathCollection()
        else:
            if numArgs == 1:
                import Ostream
                if isinstance(_args[0], Ostream.Ostream):
                    return self.__overloaded_ls_ptrConstNodePathCollection_ptrOstream(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
            else:
                if numArgs == 2:
                    ...
                    if isinstance(_args[0], Ostream.Ostream):
                        if isinstance(_args[1], types.IntType):
                            return self.__overloaded_ls_ptrConstNodePathCollection_ptrOstream_int(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
