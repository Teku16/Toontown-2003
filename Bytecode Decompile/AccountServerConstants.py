...
import DirectNotifyGlobal, TTAccount, HTTPUtil
...
class AccountServerConstants(RemoteValueSet):
    ...
    def __init__(self):
        ...
        self.defaults = {'minNameLength': '4', 'minPwLength': '6', 'allowNewAccounts': '1', 'creditCardUpFront': '0', 'priceFirstMonth': '9.95', 'pricePerMonth': '7.95'}
