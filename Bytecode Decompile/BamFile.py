...
class BamFile(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_openRead_ptrBamFile_ptrConstFilename_bool(self, filename, reportErrors):
        returnValue = libpanda._inPkJyoZ5gF(self.this, filename.this, reportErrors)
        return returnValue

    def __overloaded_openRead_ptrBamFile_ptrConstFilename(self, filename):
    ...
    def __overloaded_openWrite_ptrBamFile_ptrConstFilename_bool(self, filename, reportErrors):
        returnValue = libpanda._inPkJyoXyE3(self.this, filename.this, reportErrors)
        return returnValue

    def __overloaded_openWrite_ptrBamFile_ptrConstFilename(self, filename):
    ...
    def openRead(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Filename.Filename):
                return self.__overloaded_openRead_ptrBamFile_ptrConstFilename(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Filename.Filename):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_openRead_ptrBamFile_ptrConstFilename_bool(_args[0], _args[1])
                    else:
    ...
    def openWrite(self, *_args):
        ...
        if numArgs == 1:
            import Filename
            if isinstance(_args[0], Filename.Filename):
                return self.__overloaded_openWrite_ptrBamFile_ptrConstFilename(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Filename.Filename> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], Filename.Filename):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_openWrite_ptrBamFile_ptrConstFilename_bool(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Filename.Filename> '
