...
class LRotationd(QuatD.QuatD, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLVector3d_double(self, parameter0, parameter1):
        self.this = libpanda._inPUZN3Idpy(parameter0.this, parameter1)
        self.userManagesMemory = 1

    def __overloaded_constructor_double_double_double(self, parameter0, parameter1, parameter2):
    ...
    def __overloaded___mul___ptrConstLRotationd_ptrConstLQuaterniond(self, other):
    ...
    def __overloaded___mul___ptrConstLRotationd_ptrConstLRotationd(self, other):
                ...
                if numArgs == 2:
                    ...
                    if isinstance(_args[0], Vec3D.Vec3D):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            return self.__overloaded_constructor_ptrConstLVector3d_double(_args[0], _args[1])
                        else:
    ...
    def __mul__(self, *_args):
        ...
        if numArgs == 1:
            import QuatD
            if isinstance(_args[0], QuatD.QuatD):
                return self.__overloaded___mul___ptrConstLRotationd_ptrConstLQuaterniond(_args[0])
            else:
                if isinstance(_args[0], LRotationd):
                    return self.__overloaded___mul___ptrConstLRotationd_ptrConstLRotationd(_args[0])
                else:
