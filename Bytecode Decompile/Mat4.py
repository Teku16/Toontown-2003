...
class Mat4(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLMatrix3f(self, upper3):
        self.this = libpanda._inPUZN3fs5c(upper3.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstLMatrix3f_ptrConstLVecBase3f(self, upper3, trans):
        self.this = libpanda._inPUZN37_z9(upper3.this, trans.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrConstLMatrix4f(self, other):
        self.this = libpanda._inPUZN3U354(other.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float(self, e00, e01, e02, e03, e10, e11, e12, e13, e20, e21, e22, e23, e30, e31, e32, e33):
    ...
    def __overloaded_translateMat_ptrConstLVecBase3f(trans):
    ...
    __overloaded_translateMat_ptrConstLVecBase3f = staticmethod(__overloaded_translateMat_ptrConstLVecBase3f)

    def __overloaded_translateMat_float_float_float(tx, ty, tz):
    ...
    __overloaded_translateMat_float_float_float = staticmethod(__overloaded_translateMat_float_float_float)

    def __overloaded_rotateMat_float_ptrLVecBase3f___enum__CoordinateSystem(angle, axis, cs):
    ...
    __overloaded_rotateMat_float_ptrLVecBase3f___enum__CoordinateSystem = staticmethod(__overloaded_rotateMat_float_ptrLVecBase3f___enum__CoordinateSystem)

    def __overloaded_rotateMat_float_ptrLVecBase3f(angle, axis):
    ...
    __overloaded_rotateMat_float_ptrLVecBase3f = staticmethod(__overloaded_rotateMat_float_ptrLVecBase3f)

    def __overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f___enum__CoordinateSystem(angle, axis, cs):
    ...
    __overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f___enum__CoordinateSystem = staticmethod(__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f___enum__CoordinateSystem)

    def __overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f(angle, axis):
    ...
    __overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f = staticmethod(__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f)

    def __overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f_ptrLMatrix4f___enum__CoordinateSystem(angle, axis, resultMat, cs):
        returnValue = libpanda._inPUZN3e71s(angle, axis.this, resultMat.this, cs)
        return returnValue

    __overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f_ptrLMatrix4f___enum__CoordinateSystem = staticmethod(__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f_ptrLMatrix4f___enum__CoordinateSystem)

    def __overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f_ptrLMatrix4f(angle, axis, resultMat):
        returnValue = libpanda._inPUZN3RMA0(angle, axis.this, resultMat.this)
        return returnValue

    __overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f_ptrLMatrix4f = staticmethod(__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f_ptrLMatrix4f)

    def __overloaded_scaleMat_ptrConstLVecBase3f(scale):
    ...
    __overloaded_scaleMat_ptrConstLVecBase3f = staticmethod(__overloaded_scaleMat_ptrConstLVecBase3f)

    def __overloaded_scaleMat_float(scale):
    ...
    __overloaded_scaleMat_float = staticmethod(__overloaded_scaleMat_float)

    def __overloaded_scaleMat_float_float_float(sx, sy, sz):
    ...
    __overloaded_scaleMat_float_float_float = staticmethod(__overloaded_scaleMat_float_float_float)
    ...
    def __overloaded_assign_ptrLMatrix4f_ptrConstLMatrix4f(self, other):
    ...
    def __overloaded_assign_ptrLMatrix4f_float(self, fillValue):
    ...
    def __overloaded_setRow_ptrLMatrix4f_int_ptrConstLVecBase3f(self, row, v):
        returnValue = libpanda._inPUZN32ZkG(self.this, row, v.this)
        return returnValue

    def __overloaded_setRow_ptrLMatrix4f_int_ptrConstLVecBase4f(self, row, v):
        returnValue = libpanda._inPUZN3iZUo(self.this, row, v.this)
        return returnValue

    def __overloaded_setCol_ptrLMatrix4f_int_ptrConstLVecBase3f(self, col, v):
        returnValue = libpanda._inPUZN3b83N(self.this, col, v.this)
        return returnValue

    def __overloaded_setCol_ptrLMatrix4f_int_ptrConstLVecBase4f(self, col, v):
        returnValue = libpanda._inPUZN338nv(self.this, col, v.this)
        return returnValue

    def __overloaded_getRow_ptrConstLMatrix4f_ptrLVecBase4f_int(self, resultVec, row):
        returnValue = libpanda._inPUZN3o__u(self.this, resultVec.this, row)
        return returnValue

    def __overloaded_getRow_ptrConstLMatrix4f_int(self, row):
    ...
    def __overloaded_getRow3_ptrConstLMatrix4f_ptrLVecBase3f_int(self, resultVec, row):
        returnValue = libpanda._inPUZN3SF7x(self.this, resultVec.this, row)
        return returnValue

    def __overloaded_getRow3_ptrConstLMatrix4f_int(self, row):
    ...
    def __overloaded___call___ptrLMatrix4f_int_int(self, row, col):
        returnValue = libpanda._inPUZN3Ahy4(self.this, row, col)
        return returnValue

    def __overloaded___call___ptrConstLMatrix4f_int_int(self, row, col):
    ...
    def __overloaded_begin_ptrLMatrix4f(self):
        returnValue = libpanda._inPUZN3KK3S(self.this)
        return returnValue

    def __overloaded_begin_ptrConstLMatrix4f(self):
        returnValue = libpanda._inPUZN3BQDa(self.this)
        return returnValue

    def __overloaded_end_ptrLMatrix4f(self):
        returnValue = libpanda._inPUZN3m_kL(self.this)
        return returnValue

    def __overloaded_end_ptrConstLMatrix4f(self):
    ...
    def __overloaded_compareTo_ptrConstLMatrix4f_ptrConstLMatrix4f(self, other):
        returnValue = libpanda._inPUZN3zB6N(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLMatrix4f_ptrConstLMatrix4f_float(self, other, threshold):
    ...
    def __overloaded___mul___ptrConstLMatrix4f_ptrConstLMatrix4f(self, other):
    ...
    def __overloaded___mul___ptrConstLMatrix4f_float(self, scalar):
    ...
    def __overloaded___imul___ptrLMatrix4f_ptrConstLMatrix4f(self, other):
    ...
    def __overloaded___imul___ptrLMatrix4f_float(self, scalar):
    ...
    def __overloaded_almostEqual_ptrConstLMatrix4f_ptrConstLMatrix4f(self, other):
        returnValue = libpanda._inPUZN37Lgj(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLMatrix4f_ptrConstLMatrix4f_float(self, other, threshold):
    ...
    def __overloaded_write_ptrConstLMatrix4f_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPUZN3wC_F(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstLMatrix4f_ptrOstream(self, out):
    ...
    def scaleMat(*_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return Mat4.__overloaded_scaleMat_float(_args[0])
            else:
                if isinstance(_args[0], VBase3.VBase3):
                    return Mat4.__overloaded_scaleMat_ptrConstLVecBase3f(_args[0])
                else:
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return Mat4.__overloaded_scaleMat_float_float_float(_args[0], _args[1], _args[2])
                        else:
    ...
    def translateMat(*_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return Mat4.__overloaded_translateMat_ptrConstLVecBase3f(_args[0])
            else:
            ...
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return Mat4.__overloaded_translateMat_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                ...
                if numArgs == 2:
                    ...
                    if isinstance(_args[0], Mat3.Mat3):
                        ...
                        if isinstance(_args[1], VBase3.VBase3):
                            return self.__overloaded_constructor_ptrConstLMatrix3f_ptrConstLVecBase3f(_args[0], _args[1])
                        else:
                                                                            ...
                                                                            if isinstance(_args[13], types.FloatType) or isinstance(_args[13], types.IntType):
                                                                                if isinstance(_args[14], types.FloatType) or isinstance(_args[14], types.IntType):
                                                                                    if isinstance(_args[15], types.FloatType) or isinstance(_args[15], types.IntType):
                                                                                        return self.__overloaded_constructor_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8], _args[9], _args[10], _args[11], _args[12], _args[13], _args[14], _args[15])
                                                                                    else:
    ...
    def rotateMat(*_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                import VBase3
                if isinstance(_args[1], VBase3.VBase3):
                    return Mat4.__overloaded_rotateMat_float_ptrLVecBase3f(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], VBase3.VBase3):
                        if isinstance(_args[2], types.IntType):
                            return Mat4.__overloaded_rotateMat_float_ptrLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                        else:
    ...
    def rotateMatNormaxis(*_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                import VBase3
                if isinstance(_args[1], VBase3.VBase3):
                    return Mat4.__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            ...
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], VBase3.VBase3):
                        if isinstance(_args[2], types.IntType):
                            return Mat4.__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                        else:
                            if isinstance(_args[2], Mat4):
                                return Mat4.__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f_ptrLMatrix4f(_args[0], _args[1], _args[2])
                            else:
                        ...
                        if isinstance(_args[1], VBase3.VBase3):
                            if isinstance(_args[2], Mat4):
                                if isinstance(_args[3], types.IntType):
                                    return Mat4.__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f_ptrLMatrix4f___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3])
                                else:
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Mat4):
                return self.__overloaded_almostEqual_ptrConstLMatrix4f_ptrConstLMatrix4f(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], Mat4):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLMatrix4f_ptrConstLMatrix4f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat4> '
    ...
    def begin(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_begin_ptrConstLMatrix4f()
        else:
    ...
    def end(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_end_ptrConstLMatrix4f()
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 '
    ...
    def __imul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded___imul___ptrLMatrix4f_float(_args[0])
            else:
                if isinstance(_args[0], Mat4):
                    return self.__overloaded___imul___ptrLMatrix4f_ptrConstLMatrix4f(_args[0])
                else:
    ...
    def getRow3(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_getRow3_ptrConstLMatrix4f_int(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], VBase3.VBase3):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_getRow3_ptrConstLMatrix4f_ptrLVecBase3f_int(_args[0], _args[1])
                    else:
    ...
    def getRow(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_getRow_ptrConstLMatrix4f_int(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], VBase4.VBase4):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_getRow_ptrConstLMatrix4f_ptrLVecBase4f_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstLMatrix4f_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstLMatrix4f_ptrOstream_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def __call__(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.IntType):
                    return self.__overloaded___call___ptrConstLMatrix4f_int_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def __mul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded___mul___ptrConstLMatrix4f_float(_args[0])
            else:
                if isinstance(_args[0], Mat4):
                    return self.__overloaded___mul___ptrConstLMatrix4f_ptrConstLMatrix4f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <Mat4> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Mat4):
                return self.__overloaded_compareTo_ptrConstLMatrix4f_ptrConstLMatrix4f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Mat4> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], Mat4):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLMatrix4f_ptrConstLMatrix4f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat4> '
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], VBase4.VBase4):
                    return self.__overloaded_setCol_ptrLMatrix4f_int_ptrConstLVecBase4f(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase3.VBase3):
                        return self.__overloaded_setCol_ptrLMatrix4f_int_ptrConstLVecBase3f(_args[0], _args[1])
                    else:
    ...
    def setRow(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                import VBase4, VBase3
                if isinstance(_args[1], VBase4.VBase4):
                    return self.__overloaded_setRow_ptrLMatrix4f_int_ptrConstLVecBase4f(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase3.VBase3):
                        return self.__overloaded_setRow_ptrLMatrix4f_int_ptrConstLVecBase3f(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase4.VBase4> <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLMatrix4f_float(_args[0])
            else:
                if isinstance(_args[0], Mat4):
                    return self.__overloaded_assign_ptrLMatrix4f_ptrConstLMatrix4f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <Mat4> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '