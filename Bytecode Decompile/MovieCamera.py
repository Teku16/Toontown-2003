...
import DirectNotifyGlobal, whrandom, MovieUtil
...
def chooseHealShot(heals, attackDuration):
    ...
    track = Track([openShot, closeShot])
    return track
...
def chooseDropCloseShot(drops, suitDropsDict, openDuration, openName, attackDuration):
    ...
    track = apply(choice, [av, duration])
    return track
    return
...
def chooseSuitShot(attack, attackDuration):
                ...
                if name == BRAIN_STORM:
                    ...
                    if name == BUZZ_WORD:
                        ...
                        if name == CALCULATE:
                            ...
                            if name == CANNED:
                                camIvals.append(defaultCamera(openShotDuration=2.9))
                            else:
                                if name == CHOMP:
                                    camIvals.append(defaultCamera(openShotDuration=2.8))
                                else:
                                    if name == CLIPON_TIE:
                                        ...
                                        if name == CRUNCH:
                                            camIvals.append(defaultCamera(openShotDuration=3.4))
                                        else:
                                            if name == DEMOTION:
                                                                                    ...
                                                                                    if name == HALF_WINDSOR:
                                                                                        ...
                                                                                        if name == HEAD_SHRINK:
                                                                                            ...
                                                                                            if name == GLOWER_POWER:
                                                                                                ...
                                                                                                if name == GUILT_TRIP:
                                                                                                    camIvals.append(defaultCamera(openShotDuration=0.9))
                                                                                                else:
                                                                                                    if name == HANG_UP:
                                                                                                                                ...
                                                                                                                                if name == PARADIGM_SHIFT:
                                                                                                                                    ...
                                                                                                                                    if name == PECKING_ORDER:
                                                                                                                                        ...
                                                                                                                                        if name == PLAY_HARDBALL:
                                                                                                                                            ...
                                                                                                                                            if name == PICK_POCKET:
                                                                                                                                                camIvals.append(apply(allGroupLowShot, [suit, 2.7]))
                                                                                                                                            else:
                                                                                                                                                if name == PINK_SLIP:
                                                                                                                                                    camIvals.append(defaultCamera(openShotDuration=2.8))
                                                                                                                                                else:
                                                                                                                                                    if name == POUND_KEY:
                                                                                                                                                        ...
                                                                                                                                                        if name == POWER_TIE:
                                                                                                                                                            ...
                                                                                                                                                            if name == POWER_TRIP:
                                                                                                                                                                camIvals.append(defaultCamera(openShotDuration=1.1))
                                                                                                                                                            else:
                                                                                                                                                                if name == QUAKE:
                                                                                                                                                                    shakeIntensity = 5.15
                                                                                                                                                                    quake = 1
                                                                                                                                                                    camIvals.append(apply(suitCameraShakeShot, [suit, attackDuration, shakeIntensity, quake]))
                                                                                                                                                                else:
                                                                                                                                                                                            ...
                                                                                                                                                                                            if name == RUB_OUT:
                                                                                                                                                                                                ...
                                                                                                                                                                                                if name == SACKED:
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if name == SCHMOOZE:
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        if name == SHAKE:
                                                                                                                                                                                                            shakeIntensity = 1.75
                                                                                                                                                                                                            camIvals.append(apply(suitCameraShakeShot, [suit, attackDuration, shakeIntensity]))
                                                                                                                                                                                                        else:
                                                                                                                                                                                                            if name == SHRED:
    ...
    return MultiTrack([camTrack, pbpTrack])
...
def chooseSuitCloseShot(attack, openDuration, openName, attackDuration):
    ...
    if diedTrack == None:
        ...
        mtrack = MultiTrack([track, diedTrack])
        return mtrack
    return
...
def focusShot(x, y, z, duration, target, other=None, splitFocusPoint=None, name='focusShot'):
    ivals = []
    if other:
        ivals.append(FunctionInterval(camera.setPos, extraArgs=[other, Point3(x, y, z)]))
    else:
        ivals.append(FunctionInterval(camera.setPos, extraArgs=[Point3(x, y, z)]))
    if splitFocusPoint:
        (
         ivals.append(FunctionInterval(focusCameraBetweenPoints, extraArgs=[target, splitFocusPoint])),)
    else:
        ivals.append(FunctionInterval(camera.lookAt, extraArgs=[target]))
...
def heldShot(x, y, z, h, p, r, duration, name='heldShot'):
    intervalList = []
    intervalList.append(FunctionInterval(camera.setPosHpr, extraArgs=[x, y, z, h, p, r]))
...
def heldRelativeShot(other, x, y, z, h, p, r, duration, name='heldRelativeShot'):
    intervalList = []
    intervalList.append(FunctionInterval(camera.setPosHpr, extraArgs=[other, x, y, z, h, p, r]))
    intervalList.append(WaitInterval(duration))
    track = Track(intervalList, name)
    return track
...
def motionShot(x, y, z, h, p, r, duration, other=None, name='motionShot'):
    if other:
        posTrack = Track([LerpPosInterval(camera, duration, pos=Point3(x, y, z), other=other)])
        hprTrack = Track([LerpHprInterval(camera, duration, hpr=Point3(h, p, r), other=other)])
    else:
        posTrack = Track([LerpPosInterval(camera, duration, pos=Point3(x, y, z))])
        hprTrack = Track([LerpHprInterval(camera, duration, hpr=Point3(h, p, r))])
    return MultiTrack([posTrack, hprTrack])
...
def suitCameraShakeShot(avatar, duration, shakeIntensity, quake=0):
    ...
    def shakeCameraIvals(intensity, shakeWaitInterval=shakeWaitInterval, quake=quake, shakeDuration=shakeDuration, numShakes=numShakes):
        vertShakeTrack = Track([WaitInterval(shakeWaitInterval), FunctionInterval(camera.setZ, extraArgs=[camera.getZ() + intensity / 2]), WaitInterval(shakeDuration / 2), FunctionInterval(camera.setZ, extraArgs=[camera.getZ() - intensity]), WaitInterval(shakeDuration / 2), FunctionInterval(camera.setZ, extraArgs=[camera.getZ() + intensity / 2])])
        horizShakeTrack = Track([WaitInterval(shakeWaitInterval - shakeDuration / 2), FunctionInterval(camera.setY, extraArgs=[camera.getY() + intensity / 4]), WaitInterval(shakeDuration / 2), FunctionInterval(camera.setY, extraArgs=[camera.getY() - intensity / 2]), WaitInterval(shakeDuration / 2), FunctionInterval(camera.setY, extraArgs=[camera.getY() + intensity / 4]), WaitInterval(shakeDuration / 2), FunctionInterval(camera.lookAt, extraArgs=[Point3(0, 0, 0)])])
        ivals = []
        for i in range(0, numShakes):
            if quake == 0:
                ivals.append(vertShakeTrack)
            else:
                ivals.append(MultiTrack([vertShakeTrack, horizShakeTrack]))
    ...
    intervalList.append(FunctionInterval(camera.setPos, extraArgs=[x, -5, z]))
    intervalList.append(FunctionInterval(camera.lookAt, extraArgs=[Point3(0, 0, 0)]))
...
def avatarSideFollowAttack(suit, toon, duration, battle):
    windupDuration = duration * (0.1 + whrandom.random() * 0.1)
    ...
    initialY = finalY = whrandom.randint(-3, 0)
    initialZ = suitHeight * 0.5 + whrandom.random() * suitHeight
    finalZ = toonHeight * 0.5 + whrandom.random() * toonHeight
    if whrandom.random() > 0.5:
        initialX = -initialX
        finalX = -finalX
    return Track([focusShot(initialX, initialY, initialZ, windupDuration, suitCentralPoint), focusMoveShot(finalX, finalY, finalZ, projectDuration, toonCentralPoint), WaitInterval(impactDuration)])
...
def randomCameraSelection(suit, attack, attackDuration, openShotDuration):
    ...
    if openShotDuration > attackDuration:
        openShotDuration = attackDuration
    closeShotDuration = attackDuration - openShotDuration
    openShot = apply(whrandom.choice(shotChoices), [suit, openShotDuration])
