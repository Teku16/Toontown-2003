...
import Quests, ToontownGlobals, ToontownBattleGlobals, Localizer, Toon
MAX_FRAMES = 18
...
class TrackPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        self.title = DirectLabel(parent=self, relief=None, text=Localizer.TrackPageTitle, text_scale=0.1, pos=(0, 0, 0.65))
        self.subtitle = DirectLabel(parent=self, relief=None, text=Localizer.TrackPageSubtitle, text_scale=0.05, text_fg=(0.5, 0.1, 0.1, 1), pos=(0, 0, 0.56))
