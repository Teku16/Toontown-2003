...
class HTTPClient(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstHTTPClient(self, copy):
    ...
    def __overloaded_getProxiesForUrl_ptrConstHTTPClient_ptrConstURLSpec(self, url):
        returnValue = libpandaexpress._inP2KOdIHk7(self.this, url.this)
        return returnValue

    def __overloaded_getProxiesForUrl_ptrConstHTTPClient_ptrConstURLSpec_ptrVectorURLSpec(self, url, proxies):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], HTTPClient):
                    return self.__overloaded_constructor_ptrConstHTTPClient(_args[0])
                else:
    ...
    def getProxiesForUrl(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], URLSpec.URLSpec):
                return self.__overloaded_getProxiesForUrl_ptrConstHTTPClient_ptrConstURLSpec(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], URLSpec.URLSpec):
                    ...
                    if isinstance(_args[1], VectorURLSpec.VectorURLSpec):
                        return self.__overloaded_getProxiesForUrl_ptrConstHTTPClient_ptrConstURLSpec_ptrVectorURLSpec(_args[0], _args[1])
                    else:
