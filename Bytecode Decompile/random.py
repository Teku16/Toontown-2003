...
__all__ = [
 'Random', 'seed', 'random', 'uniform', 'randint', 'choice', 'randrange', 'shuffle', 'normalvariate', 'lognormvariate', 'cunifvariate', 'expovariate', 'vonmisesvariate', 'gammavariate', 'stdgamma', 'gauss', 'betavariate', 'paretovariate', 'weibullvariate', 'getstate', 'setstate', 'jumpahead', 'whseed']
...
class Random:
    ...
    def __whseed(self, x=0, y=0, z=0):
        ...
        if 0 <= x < 256 and 0 <= y < 256 and not 0 <= z < 256:
