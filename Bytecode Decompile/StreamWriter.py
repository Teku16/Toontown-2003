...
class StreamWriter(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstStreamWriter(self, copy):
        self.this = libpandaexpress._inPJoxt8OZ1(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrOstream(self, out):
    ...
    def constructor(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], StreamWriter):
                return self.__overloaded_constructor_ptrConstStreamWriter(_args[0])
            else:
                if isinstance(_args[0], Ostream.Ostream):
                    return self.__overloaded_constructor_ptrOstream(_args[0])
                else:
