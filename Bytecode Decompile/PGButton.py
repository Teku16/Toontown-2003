import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, PGItem
...
class PGButton(PGItem.PGItem, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setup_ptrPGButton_ptrConstNodePath(self, ready):
        returnValue = libpanda._inPWvimpw8O(self.this, ready.this)
        return returnValue

    def __overloaded_setup_ptrPGButton_ptrConstNodePath_ptrConstNodePath(self, ready, depressed):
        returnValue = libpanda._inPWvimAoE3(self.this, ready.this, depressed.this)
        return returnValue

    def __overloaded_setup_ptrPGButton_ptrConstNodePath_ptrConstNodePath_ptrConstNodePath(self, ready, depressed, rollover):
        returnValue = libpanda._inPWvim8enX(self.this, ready.this, depressed.this, rollover.this)
        return returnValue

    def __overloaded_setup_ptrPGButton_ptrConstNodePath_ptrConstNodePath_ptrConstNodePath_ptrConstNodePath(self, ready, depressed, rollover, inactive):
        returnValue = libpanda._inPWvimNB5Z(self.this, ready.this, depressed.this, rollover.this, inactive.this)
        return returnValue

    def __overloaded_setup_ptrPGButton_atomicstring(self, label):
    ...
    def setup(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.StringType):
                return self.__overloaded_setup_ptrPGButton_atomicstring(_args[0])
            else:
                if isinstance(_args[0], NodePath.NodePath):
                    return self.__overloaded_setup_ptrPGButton_ptrConstNodePath(_args[0])
                else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], NodePath.NodePath):
                    ...
                    if isinstance(_args[1], NodePath.NodePath):
                        return self.__overloaded_setup_ptrPGButton_ptrConstNodePath_ptrConstNodePath(_args[0], _args[1])
                    else:
                    ...
                    if isinstance(_args[0], NodePath.NodePath):
                        ...
                        if isinstance(_args[1], NodePath.NodePath):
                            ...
                            if isinstance(_args[2], NodePath.NodePath):
                                return self.__overloaded_setup_ptrPGButton_ptrConstNodePath_ptrConstNodePath_ptrConstNodePath(_args[0], _args[1], _args[2])
                            else:
                            ...
                            if isinstance(_args[1], NodePath.NodePath):
                                ...
                                if isinstance(_args[2], NodePath.NodePath):
                                    ...
                                    if isinstance(_args[3], NodePath.NodePath):
                                        return self.__overloaded_setup_ptrPGButton_ptrConstNodePath_ptrConstNodePath_ptrConstNodePath_ptrConstNodePath(_args[0], _args[1], _args[2], _args[3])
                                    else:
