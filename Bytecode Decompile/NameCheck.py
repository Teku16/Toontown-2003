import string, Localizer, NPCToons, DirectNotifyGlobal
...
def checkName(name):
    ...
    checks = [longEnough, emptyName, printableChars, badCharacters, hasLetters, hasVowels, monoLetter, checkDashes, checkCommas, checkPeriods, checkApostrophes, tooManyWords, allCaps, mixedCase, npcNames]
    symmetricChecks = [
     npcNames]
