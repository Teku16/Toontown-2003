...
import DistributedAvatar, Suit, ToontownGlobals, DistributedBattle, FSM, State, SuitTimings, SuitBase, DistributedSuitPlanner, AvatarDNA, DirectNotifyGlobal, SuitDialog, BattleProps, math, copy
...
class DistributedSuit(DistributedAvatar.DistributedAvatar, Suit.Suit, SuitBase.SuitBase):
    ...
    def beginSupaFlyMove(self, pos, moveIn, trackName):
        ...
        if moveIn:
            ...
            funcIntProp2 = FunctionInterval(base.playSfx, openEnded=1, extraArgs=[self.propInSound, 0, 1, None, 0.0, self])
            ...
            funcIntProp2 = FunctionInterval(base.playSfx, openEnded=1, extraArgs=[self.propOutSound, 0, 1, 1.0, 0.0, self])
    ...
    def enableBattleDetect(self, name):
        ...
        if self.bSphere:
            ...
            self.accept('enter' + self.bSphereName, self.__handleToonCollision)
        return Task.done
        return
