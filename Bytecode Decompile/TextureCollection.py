...
class TextureCollection(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstTextureCollection(self, copy):
    ...
    def __overloaded_write_ptrConstTextureCollection_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPkJyofS_c(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstTextureCollection_ptrOstream(self, out):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], TextureCollection):
                    return self.__overloaded_constructor_ptrConstTextureCollection(_args[0])
                else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstTextureCollection_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstTextureCollection_ptrOstream_int(_args[0], _args[1])
                    else:
