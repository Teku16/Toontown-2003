...
class ButtonThrower(DataNode.DataNode, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_hasThrowButton_ptrConstButtonThrower_ptrConstButtonHandle(self, button):
        returnValue = libpanda._inPziw5UvSd(self.this, button.this)
        return returnValue

    def __overloaded_hasThrowButton_ptrConstButtonThrower_ptrConstModifierButtons_ptrConstButtonHandle(self, mods, button):
    ...
    def hasThrowButton(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], ButtonHandle.ButtonHandle):
                return self.__overloaded_hasThrowButton_ptrConstButtonThrower_ptrConstButtonHandle(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], ModifierButtons.ModifierButtons):
                    ...
                    if isinstance(_args[1], ButtonHandle.ButtonHandle):
                        return self.__overloaded_hasThrowButton_ptrConstButtonThrower_ptrConstModifierButtons_ptrConstButtonHandle(_args[0], _args[1])
                    else:
