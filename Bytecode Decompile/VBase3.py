...
class VBase3(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_assign_ptrLVecBase3f_ptrConstLVecBase3f(self, copy):
    ...
    def __overloaded_assign_ptrLVecBase3f_float(self, fillValue):
    ...
    def __overloaded___getitem___ptrLVecBase3f_int(self, i):
        returnValue = libpanda._inPUZN301HX(self.this, i)
        return returnValue

    def __overloaded___getitem___ptrConstLVecBase3f_int(self, i):
    ...
    def __overloaded_compareTo_ptrConstLVecBase3f_ptrConstLVecBase3f(self, other):
        returnValue = libpanda._inPUZN3_3zo(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLVecBase3f_ptrConstLVecBase3f_float(self, other, threshold):
        returnValue = libpanda._inPUZN38GlN(self.this, other.this, threshold)
        return returnValue

    def __overloaded___sub___ptrConstLVecBase3f(self):
    ...
    def __overloaded___sub___ptrConstLVecBase3f_ptrConstLVecBase3f(self, other):
    ...
    def __overloaded_almostEqual_ptrConstLVecBase3f_ptrConstLVecBase3f(self, other):
        returnValue = libpanda._inPUZN32ADH(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLVecBase3f_ptrConstLVecBase3f_float(self, other, threshold):
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase3):
                return self.__overloaded_almostEqual_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], VBase3):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLVecBase3f_ptrConstLVecBase3f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase3> '
    ...
    def __sub__(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded___sub___ptrConstLVecBase3f()
        else:
            if numArgs == 1:
                if isinstance(_args[0], VBase3):
                    return self.__overloaded___sub___ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase3> '
            else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLVecBase3f_float(_args[0])
            else:
                if isinstance(_args[0], VBase3):
                    return self.__overloaded_assign_ptrLVecBase3f_ptrConstLVecBase3f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase3> '
        else:
    ...
    def __getitem__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded___getitem___ptrConstLVecBase3f_int(_args[0])
            else:
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase3):
                return self.__overloaded_compareTo_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], VBase3):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLVecBase3f_ptrConstLVecBase3f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase3> '
