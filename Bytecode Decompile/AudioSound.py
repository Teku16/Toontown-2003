...
class AudioSound(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setLoop_ptrAudioSound_bool(self, loop):
        returnValue = libpanda._inPPC2_tQm7(self.this, loop)
        return returnValue

    def __overloaded_setLoop_ptrAudioSound(self):
    ...
    def __overloaded_setLoopCount_ptrAudioSound_longUnsignedlongint(self, loopCount):
        returnValue = libpanda._inPPC2_ZahU(self.this, loopCount)
        return returnValue

    def __overloaded_setLoopCount_ptrAudioSound(self):
    ...
    def __overloaded_setTime_ptrAudioSound_float(self, startTime):
        returnValue = libpanda._inPPC2_sxJX(self.this, startTime)
        return returnValue

    def __overloaded_setTime_ptrAudioSound(self):
    ...
    def __overloaded_setVolume_ptrAudioSound_float(self, volume):
        returnValue = libpanda._inPPC2_f1I3(self.this, volume)
        return returnValue

    def __overloaded_setVolume_ptrAudioSound(self):
    ...
    def __overloaded_setBalance_ptrAudioSound_float(self, balanceRight):
        returnValue = libpanda._inPPC2_mpIq(self.this, balanceRight)
        return returnValue

    def __overloaded_setBalance_ptrAudioSound(self):
    ...
    def __overloaded_setActive_ptrAudioSound_bool(self, flag):
        returnValue = libpanda._inPPC2__M0J(self.this, flag)
        return returnValue

    def __overloaded_setActive_ptrAudioSound(self):
    ...
    def setLoopCount(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setLoopCount_ptrAudioSound()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setLoopCount_ptrAudioSound_longUnsignedlongint(_args[0])
                else:
    ...
    def setTime(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setTime_ptrAudioSound()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    return self.__overloaded_setTime_ptrAudioSound_float(_args[0])
                else:
    ...
    def setBalance(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setBalance_ptrAudioSound()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    return self.__overloaded_setBalance_ptrAudioSound_float(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setActive(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setActive_ptrAudioSound()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setActive_ptrAudioSound_bool(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setLoop(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setLoop_ptrAudioSound()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_setLoop_ptrAudioSound_bool(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setVolume(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_setVolume_ptrAudioSound()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    return self.__overloaded_setVolume_ptrAudioSound_float(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            else:
                raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '