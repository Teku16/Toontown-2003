...
class DNAStorage(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_storeSuitPoint_ptrDNAStorage___enum__DNASuitPointType_ptrLPoint3f(self, type, pos):
    ...
    def __overloaded_storeSuitPoint_ptrDNAStorage_ptrDNASuitPoint(self, parameter1):
    ...
    def __overloaded_storeSuitEdge_ptrDNAStorage_ptrDNASuitEdge(self, parameter1):
    ...
    def __overloaded_storeSuitEdge_ptrDNAStorage_int_int_atomicstring(self, startIndex, endIndex, zoneId):
    ...
    def __overloaded_removeDNAGroup_ptrDNAStorage_ptrDNAGroup(self, parameter1):
        returnValue = libtoontown._inPet4yfgHa(self.this, parameter1.this)
        return returnValue

    def __overloaded_removeDNAGroup_ptrDNAStorage_ptrPandaNode(self, parameter1):
    ...
    def storeSuitPoint(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], DNASuitPoint.DNASuitPoint):
                return self.__overloaded_storeSuitPoint_ptrDNAStorage_ptrDNASuitPoint(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], Point3.Point3):
                        return self.__overloaded_storeSuitPoint_ptrDNAStorage___enum__DNASuitPointType_ptrLPoint3f(_args[0], _args[1])
                    else:
    ...
    def removeDNAGroup(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            import PandaNode, DNAGroup
            if isinstance(_args[0], PandaNode.PandaNode):
                return self.__overloaded_removeDNAGroup_ptrDNAStorage_ptrPandaNode(_args[0])
            else:
                if isinstance(_args[0], DNAGroup.DNAGroup):
                    return self.__overloaded_removeDNAGroup_ptrDNAStorage_ptrDNAGroup(_args[0])
                else:
    ...
    def storeSuitEdge(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], DNASuitEdge.DNASuitEdge):
                return self.__overloaded_storeSuitEdge_ptrDNAStorage_ptrDNASuitEdge(_args[0])
            else:
                ...
                if isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.StringType):
                            return self.__overloaded_storeSuitEdge_ptrDNAStorage_int_int_atomicstring(_args[0], _args[1], _args[2])
                        else:
