...
class Point2(VBase2.VBase2, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_assign_ptrLPoint2f_ptrConstLVecBase2f(self, copy):
    ...
    def __overloaded_assign_ptrLPoint2f_float(self, fillValue):
    ...
    def __overloaded___sub___ptrConstLPoint2f(self):
    ...
    def __overloaded___sub___ptrConstLPoint2f_ptrConstLVecBase2f(self, other):
    ...
    def __overloaded___sub___ptrConstLPoint2f_ptrConstLVector2f(self, other):
    ...
    def __overloaded___add___ptrConstLPoint2f_ptrConstLVecBase2f(self, other):
    ...
    def __overloaded___add___ptrConstLPoint2f_ptrConstLVector2f(self, other):
    ...
    def __sub__(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded___sub___ptrConstLPoint2f()
        else:
            if numArgs == 1:
                import VBase2, Vec2
                if isinstance(_args[0], VBase2.VBase2):
                    return self.__overloaded___sub___ptrConstLPoint2f_ptrConstLVecBase2f(_args[0])
                else:
                    if isinstance(_args[0], Vec2.Vec2):
                        return self.__overloaded___sub___ptrConstLPoint2f_ptrConstLVector2f(_args[0])
                    else:
                        if isinstance(_args[0], Point2):
                            return self.__overloaded___sub___ptrConstLPoint2f_ptrConstLPoint2f(_args[0])
                        else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            import VBase2
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLPoint2f_float(_args[0])
            else:
                if isinstance(_args[0], VBase2.VBase2):
                    return self.__overloaded_assign_ptrLPoint2f_ptrConstLVecBase2f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase2.VBase2> '
        else:
    ...
    def __add__(self, *_args):
        ...
        if numArgs == 1:
            import VBase2, Vec2
            if isinstance(_args[0], VBase2.VBase2):
                return self.__overloaded___add___ptrConstLPoint2f_ptrConstLVecBase2f(_args[0])
            else:
                if isinstance(_args[0], Vec2.Vec2):
                    return self.__overloaded___add___ptrConstLPoint2f_ptrConstLVector2f(_args[0])
                else:
