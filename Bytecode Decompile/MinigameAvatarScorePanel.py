...
class MinigameAvatarScorePanel(DirectFrame):
    ...
    def __init__(self, avId, avName):
        ...
        self.scoreText = DirectLabel(self, relief=None, text='0', text_scale=0.1, pos=(0.1, 0.0, -0.09))
        if self.avatar:
            ...
            self.laffMeter = None
        self.nameText = DirectLabel(self, relief=None, text=avName, text_scale=0.055, text_pos=(0.0, 0.06), text_wordwrap=7.5, text_shadow=(1, 1, 1, 1))
        self.show()
        return
