...
class Mat3(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLMatrix3f(self, other):
        self.this = libpanda._inPUZN3tN2u(other.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_float_float_float_float_float_float_float_float_float(self, e00, e01, e02, e10, e11, e12, e20, e21, e22):
    ...
    def __overloaded_translateMat_ptrConstLVecBase2f(trans):
    ...
    __overloaded_translateMat_ptrConstLVecBase2f = staticmethod(__overloaded_translateMat_ptrConstLVecBase2f)

    def __overloaded_translateMat_float_float(tx, ty):
    ...
    __overloaded_translateMat_float_float = staticmethod(__overloaded_translateMat_float_float)

    def __overloaded_rotateMat_float(angle):
    ...
    __overloaded_rotateMat_float = staticmethod(__overloaded_rotateMat_float)
    ...
    def __overloaded_scaleMat_ptrConstLVecBase2f(scale):
    ...
    __overloaded_scaleMat_ptrConstLVecBase2f = staticmethod(__overloaded_scaleMat_ptrConstLVecBase2f)
    ...
    def __overloaded_scaleMat_float_float(sx, sy):
    ...
    __overloaded_scaleMat_float_float = staticmethod(__overloaded_scaleMat_float_float)
    ...
    def __overloaded_assign_ptrLMatrix3f_ptrConstLMatrix3f(self, other):
    ...
    def __overloaded_assign_ptrLMatrix3f_float(self, fillValue):
    ...
    def __overloaded_setRow_ptrLMatrix3f_int_ptrConstLVecBase2f(self, row, v):
        returnValue = libpanda._inPUZN3K5w9(self.this, row, v.this)
        return returnValue

    def __overloaded_setRow_ptrLMatrix3f_int_ptrConstLVecBase3f(self, row, v):
        returnValue = libpanda._inPUZN355gf(self.this, row, v.this)
        return returnValue

    def __overloaded_setCol_ptrLMatrix3f_int_ptrConstLVecBase2f(self, col, v):
        returnValue = libpanda._inPUZN3vDEF(self.this, col, v.this)
        return returnValue

    def __overloaded_setCol_ptrLMatrix3f_int_ptrConstLVecBase3f(self, col, v):
        returnValue = libpanda._inPUZN3bc0m(self.this, col, v.this)
        return returnValue

    def __overloaded_getRow_ptrConstLMatrix3f_ptrLVecBase3f_int(self, resultVec, row):
        returnValue = libpanda._inPUZN3dfDX(self.this, resultVec.this, row)
        return returnValue

    def __overloaded_getRow_ptrConstLMatrix3f_int(self, row):
    ...
    def __overloaded___call___ptrLMatrix3f_int_int(self, row, col):
        returnValue = libpanda._inPUZN3HBvR(self.this, row, col)
        return returnValue

    def __overloaded___call___ptrConstLMatrix3f_int_int(self, row, col):
    ...
    def __overloaded_compareTo_ptrConstLMatrix3f_ptrConstLMatrix3f(self, other):
        returnValue = libpanda._inPUZN3FM0m(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLMatrix3f_ptrConstLMatrix3f_float(self, other, threshold):
    ...
    def __overloaded___mul___ptrConstLMatrix3f_ptrConstLMatrix3f(self, other):
    ...
    def __overloaded___mul___ptrConstLMatrix3f_float(self, scalar):
    ...
    def __overloaded___imul___ptrLMatrix3f_ptrConstLMatrix3f(self, other):
    ...
    def __overloaded___imul___ptrLMatrix3f_float(self, scalar):
    ...
    def __overloaded_almostEqual_ptrConstLMatrix3f_ptrConstLMatrix3f(self, other):
        returnValue = libpanda._inPUZN35LZV(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLMatrix3f_ptrConstLMatrix3f_float(self, other, threshold):
    ...
    def __overloaded_write_ptrConstLMatrix3f_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPUZN3xi6e(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstLMatrix3f_ptrOstream(self, out):
    ...
    def scaleMat(*_args):
        numArgs = len(_args)
        if numArgs == 1:
            import VBase3, VBase2
            if isinstance(_args[0], VBase3.VBase3):
                return Mat3.__overloaded_scaleMat_ptrConstLVecBase3f(_args[0])
            else:
                if isinstance(_args[0], VBase2.VBase2):
                    return Mat3.__overloaded_scaleMat_ptrConstLVecBase2f(_args[0])
                else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return Mat3.__overloaded_scaleMat_float_float(_args[0], _args[1])
                    else:
                    ...
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                return Mat3.__overloaded_scaleMat_float_float_float(_args[0], _args[1], _args[2])
                            else:
    ...
    def translateMat(*_args):
        ...
        if numArgs == 1:
            import VBase2
            if isinstance(_args[0], VBase2.VBase2):
                return Mat3.__overloaded_translateMat_ptrConstLVecBase2f(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return Mat3.__overloaded_translateMat_float_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    return Mat3.__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[1], VBase3.VBase3):
                        if isinstance(_args[2], types.IntType):
                            return Mat3.__overloaded_rotateMatNormaxis_float_ptrConstLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                        else:
    ...
    def rotateMat(*_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return Mat3.__overloaded_rotateMat_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    import VBase3
                    if isinstance(_args[1], VBase3.VBase3):
                        return Mat3.__overloaded_rotateMat_float_ptrLVecBase3f(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
                ...
                if numArgs == 3:
                    if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                        ...
                        if isinstance(_args[1], VBase3.VBase3):
                            if isinstance(_args[2], types.IntType):
                                return Mat3.__overloaded_rotateMat_float_ptrLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                            else:
                                raise TypeError, 'Invalid argument 2, expected one of: <types.IntType> '
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                                            ...
                                            if isinstance(_args[6], types.FloatType) or isinstance(_args[6], types.IntType):
                                                if isinstance(_args[7], types.FloatType) or isinstance(_args[7], types.IntType):
                                                    if isinstance(_args[8], types.FloatType) or isinstance(_args[8], types.IntType):
                                                        return self.__overloaded_constructor_float_float_float_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8])
                                                    else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstLMatrix3f_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstLMatrix3f_ptrOstream_int(_args[0], _args[1])
                    else:
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Mat3):
                return self.__overloaded_almostEqual_ptrConstLMatrix3f_ptrConstLMatrix3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Mat3> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], Mat3):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLMatrix3f_ptrConstLMatrix3f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat3> '
    ...
    def __imul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded___imul___ptrLMatrix3f_float(_args[0])
            else:
                if isinstance(_args[0], Mat3):
                    return self.__overloaded___imul___ptrLMatrix3f_ptrConstLMatrix3f(_args[0])
                else:
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Mat3):
                return self.__overloaded_compareTo_ptrConstLMatrix3f_ptrConstLMatrix3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Mat3> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], Mat3):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLMatrix3f_ptrConstLMatrix3f_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat3> '
    ...
    def __call__(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.IntType):
                    return self.__overloaded___call___ptrConstLMatrix3f_int_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
    ...
    def setRow(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                import VBase3, VBase2
                if isinstance(_args[1], VBase3.VBase3):
                    return self.__overloaded_setRow_ptrLMatrix3f_int_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase2.VBase2):
                        return self.__overloaded_setRow_ptrLMatrix3f_int_ptrConstLVecBase2f(_args[0], _args[1])
                    else:
    ...
    def setCol(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.IntType):
                import VBase3, VBase2
                if isinstance(_args[1], VBase3.VBase3):
                    return self.__overloaded_setCol_ptrLMatrix3f_int_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                    if isinstance(_args[1], VBase2.VBase2):
                        return self.__overloaded_setCol_ptrLMatrix3f_int_ptrConstLVecBase2f(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> <VBase2.VBase2> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLMatrix3f_float(_args[0])
            else:
                if isinstance(_args[0], Mat3):
                    return self.__overloaded_assign_ptrLMatrix3f_ptrConstLMatrix3f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <Mat3> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def getRow(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_getRow_ptrConstLMatrix3f_int(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], VBase3.VBase3):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_getRow_ptrConstLMatrix3f_ptrLVecBase3f_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
    ...
    def __mul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded___mul___ptrConstLMatrix3f_float(_args[0])
            else:
                if isinstance(_args[0], Mat3):
                    return self.__overloaded___mul___ptrConstLMatrix3f_ptrConstLMatrix3f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <Mat3> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '