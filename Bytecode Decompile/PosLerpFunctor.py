import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, SimpleLerpFunctorLPoint3f
...
class PosLerpFunctor(SimpleLerpFunctorLPoint3f.SimpleLerpFunctorLPoint3f, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f(self, np, start, end):
        self.this = libpanda._inPkJyoU2Ej(np.this, start.this, end.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrNodePath(self, np, start, end, wrt):
            ...
            if isinstance(_args[0], NodePath.NodePath):
                ...
                if isinstance(_args[1], Point3.Point3):
                    ...
                    if isinstance(_args[2], Point3.Point3):
                        return self.__overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f(_args[0], _args[1], _args[2])
                    else:
                    ...
                    if isinstance(_args[1], Point3.Point3):
                        ...
                        if isinstance(_args[2], Point3.Point3):
                            ...
                            if isinstance(_args[3], NodePath.NodePath):
                                return self.__overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrNodePath(_args[0], _args[1], _args[2], _args[3])
                            else:
