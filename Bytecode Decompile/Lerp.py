...
class Lerp(TypedReferenceCount.TypedReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLerp(self, parameter0):
        self.this = libpanda._inPgRdzQD6d(parameter0.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrLerpFunctor_float_ptrLerpBlendType(self, func, endt, blend):
        self.this = libpanda._inPgRdzt6jr(func.this, endt, blend.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrLerpFunctor_float_float_ptrLerpBlendType(self, func, startt, endt, blend):
    ...
    def constructor(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Lerp):
                return self.__overloaded_constructor_ptrConstLerp(_args[0])
            else:
                ...
                if isinstance(_args[0], LerpFunctor.LerpFunctor):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        ...
                        if isinstance(_args[2], LerpBlendType.LerpBlendType):
                            return self.__overloaded_constructor_ptrLerpFunctor_float_ptrLerpBlendType(_args[0], _args[1], _args[2])
                        else:
                        ...
                        if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                            if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                                ...
                                if isinstance(_args[3], LerpBlendType.LerpBlendType):
                                    return self.__overloaded_constructor_ptrLerpFunctor_float_float_ptrLerpBlendType(_args[0], _args[1], _args[2], _args[3])
                                else:
