...
class CollisionRay(CollisionSolid.CollisionSolid, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstLPoint3f_ptrConstLVector3f(self, origin, direction):
        self.this = libpanda._inPHwcauWsc(origin.this, direction.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_float_float_float_float_float_float(self, ox, oy, oz, dx, dy, dz):
    ...
    def __overloaded_setOrigin_ptrCollisionRay_ptrConstLPoint3f(self, origin):
        returnValue = libpanda._inPHwcaVQg4(self.this, origin.this)
        return returnValue

    def __overloaded_setOrigin_ptrCollisionRay_float_float_float(self, x, y, z):
    ...
    def __overloaded_setDirection_ptrCollisionRay_ptrConstLVector3f(self, direction):
        returnValue = libpanda._inPHwcaEnJ_(self.this, direction.this)
        return returnValue

    def __overloaded_setDirection_ptrCollisionRay_float_float_float(self, x, y, z):
    ...
    def __overloaded_setFromLens_ptrCollisionRay_ptrLensNode_ptrConstLPoint2f(self, camera, point):
        returnValue = libpanda._inPHwcaAz4_(self.this, camera.this, point.this)
        return returnValue

    def __overloaded_setFromLens_ptrCollisionRay_ptrLensNode_float_float(self, camera, px, py):
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Point3.Point3):
                    ...
                    if isinstance(_args[1], Vec3.Vec3):
                        return self.__overloaded_constructor_ptrConstLPoint3f_ptrConstLVector3f(_args[0], _args[1])
                    else:
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], LensNode.LensNode):
                ...
                if isinstance(_args[1], Point2.Point2):
                    return self.__overloaded_setFromLens_ptrCollisionRay_ptrLensNode_ptrConstLPoint2f(_args[0], _args[1])
                else:
            ...
            if numArgs == 3:
                ...
                if isinstance(_args[0], LensNode.LensNode):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setFromLens_ptrCollisionRay_ptrLensNode_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
    ...
    def setDirection(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Vec3.Vec3):
                return self.__overloaded_setDirection_ptrCollisionRay_ptrConstLVector3f(_args[0])
            else:
            ...
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setDirection_ptrCollisionRay_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
    ...
    def setOrigin(self, *_args):
        ...
        if numArgs == 1:
            import Point3
            if isinstance(_args[0], Point3.Point3):
                return self.__overloaded_setOrigin_ptrCollisionRay_ptrConstLPoint3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Point3.Point3> '
        else:
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setOrigin_ptrCollisionRay_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
