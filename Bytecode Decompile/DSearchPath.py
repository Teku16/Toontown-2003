...
class DSearchPath(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstDSearchPath(self, copy):
        self.this = libpandaexpress._inPJoxtzohW(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_atomicstring_atomicstring(self, path, delimiters):
        self.this = libpandaexpress._inPJoxtuuI2(path, delimiters)
        self.userManagesMemory = 1

    def __overloaded_constructor_atomicstring(self, path):
    ...
    def __overloaded_searchPath_ptrConstFilename_atomicstring_atomicstring(filename, path, delimiters):
    ...
    __overloaded_searchPath_ptrConstFilename_atomicstring_atomicstring = staticmethod(__overloaded_searchPath_ptrConstFilename_atomicstring_atomicstring)
    ...
    __overloaded_searchPath_ptrConstFilename_atomicstring = staticmethod(__overloaded_searchPath_ptrConstFilename_atomicstring)
    ...
    def __overloaded_appendPath_ptrDSearchPath_ptrConstDSearchPath(self, path):
        returnValue = libpandaexpress._inPJoxtAcLB(self.this, path.this)
        return returnValue

    def __overloaded_appendPath_ptrDSearchPath_atomicstring_atomicstring(self, path, delimiters):
        returnValue = libpandaexpress._inPJoxtzDyg(self.this, path, delimiters)
        return returnValue

    def __overloaded_appendPath_ptrDSearchPath_atomicstring(self, path):
    ...
    def __overloaded_output_ptrConstDSearchPath_ptrOstream_atomicstring(self, out, separator):
        returnValue = libpandaexpress._inPJoxtfyrW(self.this, out.this, separator)
        return returnValue

    def __overloaded_output_ptrConstDSearchPath_ptrOstream(self, out):
        returnValue = libpandaexpress._inPJoxtx5QI(self.this, out.this)
        return returnValue

    def __overloaded_write_ptrConstDSearchPath_ptrOstream_int(self, out, indentLevel):
        returnValue = libpandaexpress._inPJoxtFTuw(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstDSearchPath_ptrOstream(self, out):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], Filename.Filename):
                if isinstance(_args[1], types.StringType):
                    return DSearchPath.__overloaded_searchPath_ptrConstFilename_atomicstring(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], Filename.Filename):
                    if isinstance(_args[1], types.StringType):
                        if isinstance(_args[2], types.StringType):
                            return DSearchPath.__overloaded_searchPath_ptrConstFilename_atomicstring_atomicstring(_args[0], _args[1], _args[2])
                        else:
            ...
            if numArgs == 1:
                if isinstance(_args[0], types.StringType):
                    ...
                    if isinstance(_args[0], DSearchPath):
                        return self.__overloaded_constructor_ptrConstDSearchPath(_args[0])
                    else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], types.StringType):
                        if isinstance(_args[1], types.StringType):
                            return self.__overloaded_constructor_atomicstring_atomicstring(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <types.StringType> '
                    else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstDSearchPath_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstDSearchPath_ptrOstream_int(_args[0], _args[1])
                    else:
    ...
    def output(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_output_ptrConstDSearchPath_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.StringType):
                        return self.__overloaded_output_ptrConstDSearchPath_ptrOstream_atomicstring(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.StringType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def appendPath(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return self.__overloaded_appendPath_ptrDSearchPath_atomicstring(_args[0])
            else:
                if isinstance(_args[0], DSearchPath):
                    return self.__overloaded_appendPath_ptrDSearchPath_ptrConstDSearchPath(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> <DSearchPath> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.StringType):
                        return self.__overloaded_appendPath_ptrDSearchPath_atomicstring_atomicstring(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.StringType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
