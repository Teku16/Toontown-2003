import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, TypedWritableReferenceCount, BoundedObject
...
class CollisionSolid(TypedWritableReferenceCount.TypedWritableReferenceCount, BoundedObject.BoundedObject, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_write_ptrConstCollisionSolid_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPHwcasNak(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstCollisionSolid_ptrOstream(self, out):
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstCollisionSolid_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstCollisionSolid_ptrOstream_int(_args[0], _args[1])
                    else:
