...
class VBase4D(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_assign_ptrLVecBase4d_ptrConstLVecBase4d(self, copy):
    ...
    def __overloaded_assign_ptrLVecBase4d_double(self, fillValue):
    ...
    def __overloaded___getitem___ptrLVecBase4d_int(self, i):
        returnValue = libpanda._inPUZN3mm3I(self.this, i)
        return returnValue

    def __overloaded___getitem___ptrConstLVecBase4d_int(self, i):
    ...
    def __overloaded_compareTo_ptrConstLVecBase4d_ptrConstLVecBase4d(self, other):
        returnValue = libpanda._inPUZN31LH_(self.this, other.this)
        return returnValue

    def __overloaded_compareTo_ptrConstLVecBase4d_ptrConstLVecBase4d_double(self, other, threshold):
        returnValue = libpanda._inPUZN3319I(self.this, other.this, threshold)
        return returnValue

    def __overloaded___sub___ptrConstLVecBase4d(self):
    ...
    def __overloaded___sub___ptrConstLVecBase4d_ptrConstLVecBase4d(self, other):
    ...
    def __overloaded_almostEqual_ptrConstLVecBase4d_ptrConstLVecBase4d(self, other):
        returnValue = libpanda._inPUZN3doqw(self.this, other.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLVecBase4d_ptrConstLVecBase4d_double(self, other, threshold):
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase4D):
                return self.__overloaded_almostEqual_ptrConstLVecBase4d_ptrConstLVecBase4d(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], VBase4D):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLVecBase4d_ptrConstLVecBase4d_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase4D> '
    ...
    def __sub__(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded___sub___ptrConstLVecBase4d()
        else:
            if numArgs == 1:
                if isinstance(_args[0], VBase4D):
                    return self.__overloaded___sub___ptrConstLVecBase4d_ptrConstLVecBase4d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase4D> '
            else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_assign_ptrLVecBase4d_double(_args[0])
            else:
                if isinstance(_args[0], VBase4D):
                    return self.__overloaded_assign_ptrLVecBase4d_ptrConstLVecBase4d(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase4D> '
        else:
    ...
    def __getitem__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded___getitem___ptrConstLVecBase4d_int(_args[0])
            else:
    ...
    def compareTo(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], VBase4D):
                return self.__overloaded_compareTo_ptrConstLVecBase4d_ptrConstLVecBase4d(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase4D> '
        else:
            if numArgs == 2:
                if isinstance(_args[0], VBase4D):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_compareTo_ptrConstLVecBase4d_ptrConstLVecBase4d_double(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <VBase4D> '
