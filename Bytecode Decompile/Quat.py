...
class Quat(VBase4.VBase4, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded___mul___ptrLQuaternionf_ptrConstLMatrix3f(self, parameter1):
    ...
    def __overloaded___mul___ptrLQuaternionf_ptrConstLMatrix4f(self, parameter1):
    ...
    def __overloaded___mul___ptrConstLQuaternionf_ptrConstLQuaternionf(self, parameter1):
    ...
    def __overloaded_almostEqual_ptrConstLQuaternionf_ptrConstLQuaternionf(self, parameter1):
        returnValue = libpanda._inPUZN3rHMU(self.this, parameter1.this)
        return returnValue

    def __overloaded_almostEqual_ptrConstLQuaternionf_ptrConstLQuaternionf_float(self, parameter1, parameter2):
    ...
    def __overloaded_extractToMatrix_ptrConstLQuaternionf_ptrLMatrix3f(self, m):
        returnValue = libpanda._inPUZN3XnH2(self.this, m.this)
        return returnValue

    def __overloaded_extractToMatrix_ptrConstLQuaternionf_ptrLMatrix4f(self, m):
        returnValue = libpanda._inPUZN3PWR2(self.this, m.this)
        return returnValue

    def __overloaded_setFromMatrix_ptrLQuaternionf_ptrConstLMatrix3f(self, m):
        returnValue = libpanda._inPUZN3adwD(self.this, m.this)
        return returnValue

    def __overloaded_setFromMatrix_ptrLQuaternionf_ptrConstLMatrix4f(self, m):
    ...
    def almostEqual(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], Quat):
                return self.__overloaded_almostEqual_ptrConstLQuaternionf_ptrConstLQuaternionf(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], Quat):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        return self.__overloaded_almostEqual_ptrConstLQuaternionf_ptrConstLQuaternionf_float(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Quat> '
    ...
    def extractToMatrix(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Mat4.Mat4):
                return self.__overloaded_extractToMatrix_ptrConstLQuaternionf_ptrLMatrix4f(_args[0])
            else:
                if isinstance(_args[0], Mat3.Mat3):
                    return self.__overloaded_extractToMatrix_ptrConstLQuaternionf_ptrLMatrix3f(_args[0])
                else:
    ...
    def __mul__(self, *_args):
        ...
        if numArgs == 1:
            import Mat4, Mat3
            if isinstance(_args[0], Quat):
                return self.__overloaded___mul___ptrConstLQuaternionf_ptrConstLQuaternionf(_args[0])
            else:
                if isinstance(_args[0], Mat4.Mat4):
                    return self.__overloaded___mul___ptrLQuaternionf_ptrConstLMatrix4f(_args[0])
                else:
                    if isinstance(_args[0], Mat3.Mat3):
                        return self.__overloaded___mul___ptrLQuaternionf_ptrConstLMatrix3f(_args[0])
                    else:
    ...
    def setFromMatrix(self, *_args):
        ...
        if numArgs == 1:
            import Mat4, Mat3
            if isinstance(_args[0], Mat4.Mat4):
                return self.__overloaded_setFromMatrix_ptrLQuaternionf_ptrConstLMatrix4f(_args[0])
            else:
                if isinstance(_args[0], Mat3.Mat3):
                    return self.__overloaded_setFromMatrix_ptrLQuaternionf_ptrConstLMatrix3f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Mat4.Mat4> <Mat3.Mat3> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '