...
class DNABattleCell(TypedReferenceCount.TypedReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_traverse_ptrDNABattleCell_ptrNodePath_ptrDNAStorage_int(self, parent, store, editing):
    ...
    def __overloaded_traverse_ptrDNABattleCell_ptrNodePath_ptrDNAStorage(self, parent, store):
    ...
    def __overloaded_write_ptrConstDNABattleCell_ptrOstream_ptrDNAStorage_int(self, out, store, indentLevel):
        returnValue = libtoontown._inPet4yFXoo(self.this, out.this, store.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstDNABattleCell_ptrOstream_ptrDNAStorage(self, out, store):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                ...
                if isinstance(_args[1], DNAStorage.DNAStorage):
                    return self.__overloaded_write_ptrConstDNABattleCell_ptrOstream_ptrDNAStorage(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    ...
                    if isinstance(_args[1], DNAStorage.DNAStorage):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_write_ptrConstDNABattleCell_ptrOstream_ptrDNAStorage_int(_args[0], _args[1], _args[2])
                        else:
    ...
    def traverse(self, *_args):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], NodePath.NodePath):
                import DNAStorage
                if isinstance(_args[1], DNAStorage.DNAStorage):
                    return self.__overloaded_traverse_ptrDNABattleCell_ptrNodePath_ptrDNAStorage(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <DNAStorage.DNAStorage> '
            else:
            ...
            if numArgs == 3:
                ...
                if isinstance(_args[0], NodePath.NodePath):
                    ...
                    if isinstance(_args[1], DNAStorage.DNAStorage):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_traverse_ptrDNABattleCell_ptrNodePath_ptrDNAStorage_int(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <DNAStorage.DNAStorage> '
