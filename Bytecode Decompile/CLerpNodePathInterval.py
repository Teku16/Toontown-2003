...
class CLerpNodePathInterval(CLerpInterval.CLerpInterval, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setStartScale_ptrCLerpNodePathInterval_ptrConstLVecBase3f(self, scale):
        returnValue = libdirect._inPSpsCMMwu(self.this, scale.this)
        return returnValue

    def __overloaded_setStartScale_ptrCLerpNodePathInterval_float(self, scale):
        returnValue = libdirect._inPSpsCLfsN(self.this, scale)
        return returnValue

    def __overloaded_setEndScale_ptrCLerpNodePathInterval_ptrConstLVecBase3f(self, scale):
        returnValue = libdirect._inPSpsCv_6i(self.this, scale.this)
        return returnValue

    def __overloaded_setEndScale_ptrCLerpNodePathInterval_float(self, scale):
    ...
    def setEndScale(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setEndScale_ptrCLerpNodePathInterval_float(_args[0])
            else:
                if isinstance(_args[0], VBase3.VBase3):
                    return self.__overloaded_setEndScale_ptrCLerpNodePathInterval_ptrConstLVecBase3f(_args[0])
                else:
    ...
    def setStartScale(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self.__overloaded_setStartScale_ptrCLerpNodePathInterval_float(_args[0])
            else:
                if isinstance(_args[0], VBase3.VBase3):
                    return self.__overloaded_setStartScale_ptrCLerpNodePathInterval_ptrConstLVecBase3f(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase3.VBase3> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '