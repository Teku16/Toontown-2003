...
class PosHprLerpFunctor(LerpFunctor.LerpFunctor, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f(self, np, pstart, pend, hstart, hend):
        self.this = libpanda._inPkJyo_6uU(np.this, pstart.this, pend.this, hstart.this, hend.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(self, np, pstart, pend, hstart, hend, wrt):
        self.this = libpanda._inPkJyoK66r(np.this, pstart.this, pend.this, hstart.this, hend.this, wrt.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float(self, np, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez):
        self.this = libpanda._inPkJyoB14f(np.this, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float_ptrNodePath(self, np, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez, wrt):
                    ...
                    if isinstance(_args[2], Point3.Point3):
                        ...
                        if isinstance(_args[3], VBase3.VBase3):
                            ...
                            if isinstance(_args[4], VBase3.VBase3):
                                return self.__overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f(_args[0], _args[1], _args[2], _args[3], _args[4])
                            else:
                            ...
                            if isinstance(_args[3], VBase3.VBase3):
                                ...
                                if isinstance(_args[4], VBase3.VBase3):
                                    ...
                                    if isinstance(_args[5], NodePath.NodePath):
                                        return self.__overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                                    else:
