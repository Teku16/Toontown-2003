...
class FrustumD(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_makeOrtho2D_ptrFrustumd(self):
        returnValue = libpanda._inPSkjPEiT5(self.this)
        return returnValue

    def __overloaded_makeOrtho2D_ptrFrustumd_double_double_double_double(self, l, r, t, b):
        returnValue = libpanda._inPSkjPPyqK(self.this, l, r, t, b)
        return returnValue

    def __overloaded_makeOrtho_ptrFrustumd_double_double(self, fnear, ffar):
        returnValue = libpanda._inPSkjPnaj7(self.this, fnear, ffar)
        return returnValue

    def __overloaded_makeOrtho_ptrFrustumd_double_double_double_double_double_double(self, fnear, ffar, l, r, t, b):
    ...
    def makeOrtho2D(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_makeOrtho2D_ptrFrustumd()
        else:
            if numArgs == 4:
                    ...
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_makeOrtho2D_ptrFrustumd_double_double_double_double(_args[0], _args[1], _args[2], _args[3])
                            else:
    ...
    def makeOrtho(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    return self.__overloaded_makeOrtho_ptrFrustumd_double_double(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
                            ...
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                    if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                        return self.__overloaded_makeOrtho_ptrFrustumd_double_double_double_double_double_double(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                                    else:
