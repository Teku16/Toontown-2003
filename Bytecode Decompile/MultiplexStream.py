import types, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, Ostream
...
class MultiplexStream(Ostream.Ostream, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_addOstream_ptrMultiplexStream_ptrOstream_bool(self, out, deleteLater):
        returnValue = libpandaexpress._inP2KOdWXC6(self.this, out.this, deleteLater)
        return returnValue

    def __overloaded_addOstream_ptrMultiplexStream_ptrOstream(self, out):
    ...
    def addOstream(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_addOstream_ptrMultiplexStream_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_addOstream_ptrMultiplexStream_ptrOstream_bool(_args[0], _args[1])
                    else:
