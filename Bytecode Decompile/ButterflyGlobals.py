...
unusedIndexes = [
 [
  range(0, len(ButterflyPoints[TTC][0])), range(0, len(ButterflyPoints[TTC][1])), range(0, len(ButterflyPoints[TTC][2])), range(0, len(ButterflyPoints[TTC][3]))], [range(0, len(ButterflyPoints[DG][0]))], [range(0, len(ButterflyPoints[ESTATE][0])), range(0, len(ButterflyPoints[ESTATE][1])), range(0, len(ButterflyPoints[ESTATE][2])), range(0, len(ButterflyPoints[ESTATE][3]))]]
usedIndexes = [[[], [], [], []], [[]], [[], [], [], []]]
estateIndexes = {}
...
def generateEstateIndices(avId):
    estateIndexes[avId] = (
     [
      range(0, len(ButterflyPoints[ESTATE][0])), range(0, len(ButterflyPoints[ESTATE][1])), range(0, len(ButterflyPoints[ESTATE][2])), range(0, len(ButterflyPoints[ESTATE][3]))], [[], [], [], []])
...
def getFirstRoute(playground, area, avId=None):
    ...
    return (
     curPos, curIndex, destPos, destIndex, time)
