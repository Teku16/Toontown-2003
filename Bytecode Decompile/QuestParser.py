...
import DirectNotifyGlobal, BlinkingArrows, ToonHeadFrame, AvatarDNA, Char, Suit, Localizer
...
def init():
    globalVarDict.update({'render': render, 'camera': camera, 'hidden': hidden, 'aspect2d': aspect2d, 'localToon': toonbase.localToon, 'laffMeter': toonbase.localToon.laffMeter, 'inventory': toonbase.localToon.inventory, 'bFriendsList': toonbase.localToon.bFriendsList, 'book': toonbase.localToon.book, 'bookPrevArrow': toonbase.localToon.book.prevArrow, 'bookNextArrow': toonbase.localToon.book.nextArrow, 'bookOpenButton': toonbase.localToon.book.bookOpenButton, 'bookCloseButton': toonbase.localToon.book.bookCloseButton, 'chatNormalButton': toonbase.localToon.chatMgr.normalButton, 'chatQtButton': toonbase.localToon.chatMgr.qtButton, 'arrows': BlinkingArrows.BlinkingArrows()})
