...
class NametagGroup(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setChat_ptrNametagGroup_atomicstring_int_int(self, chat, chatFlags, pageNumber):
        returnValue = libtoontown._inPPj7bAWyM(self.this, chat, chatFlags, pageNumber)
        return returnValue

    def __overloaded_setChat_ptrNametagGroup_atomicstring_int(self, chat, chatFlags):
    ...
    def __overloaded_getChat_ptrConstNametagGroup(self):
        returnValue = libtoontown._inPPj7bQXZv(self.this)
        return returnValue

    def __overloaded_getChat_ptrConstNametagGroup_int(self, pageNumber):
    ...
    def getChat(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getChat_ptrConstNametagGroup()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_getChat_ptrConstNametagGroup_int(_args[0])
                else:
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.StringType):
                if isinstance(_args[1], types.IntType):
                    return self.__overloaded_setChat_ptrNametagGroup_atomicstring_int(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.IntType):
                            return self.__overloaded_setChat_ptrNametagGroup_atomicstring_int_int(_args[0], _args[1], _args[2])
                        else:
