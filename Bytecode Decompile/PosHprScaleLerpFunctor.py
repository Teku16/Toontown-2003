...
class PosHprScaleLerpFunctor(LerpFunctor.LerpFunctor, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(self, np, pstart, pend, hstart, hend, sstart, send):
        self.this = libpanda._inPkJyoP4RJ(np.this, pstart.this, pend.this, hstart.this, hend.this, sstart.this, send.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(self, np, pstart, pend, hstart, hend, sstart, send, wrt):
        self.this = libpanda._inPkJyosRMm(np.this, pstart.this, pend.this, hstart.this, hend.this, sstart.this, send.this, wrt.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float(self, np, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez):
        self.this = libpanda._inPkJyohyws(np.this, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_ptrNodePath(self, np, psx, psy, psz, pex, pey, pez, hsx, hsy, hsz, hex, hey, hez, ssx, ssy, ssz, sex, sey, sez, wrt):
                            ...
                            if isinstance(_args[4], VBase3.VBase3):
                                ...
                                if isinstance(_args[5], VBase3.VBase3):
                                    ...
                                    if isinstance(_args[6], VBase3.VBase3):
                                        return self.__overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6])
                                    else:
                                    ...
                                    if isinstance(_args[5], VBase3.VBase3):
                                        ...
                                        if isinstance(_args[6], VBase3.VBase3):
                                            ...
                                            if isinstance(_args[7], NodePath.NodePath):
                                                return self.__overloaded_constructor_ptrNodePath_ptrLPoint3f_ptrLPoint3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7])
                                            else:
