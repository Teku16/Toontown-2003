...
import DirectNotifyGlobal, Place, PandaObject, StateData, FSM, State, Task, Toon, StateData, House, QuietZoneState, ZoneUtil, SkyUtil, Estate, HouseGlobals
...
class EstateLoader(StateData.StateData):
    ...
    def __popupKickoutMessage(self, msg):
        ...
        self.popupInfo = DirectFrame(parent=hidden, relief=None, state='normal', text=msg, frameSize=(-1, 1, -1, 1), text_wordwrap=10, geom=getDefaultDialogGeom(), geom_color=GlobalDialogColor, geom_scale=(0.88, 1, 0.75), geom_pos=(0, 0, -0.08), text_scale=0.08, text_pos=(0, 0.1))
        DirectButton(self.popupInfo, image=okButtonImage, relief=None, text=Localizer.EstatePopupOK, text_scale=0.05, text_pos=(0.0, -0.1), textMayChange=0, pos=(0.0, 0.0, -0.3), command=self.__handleKickoutOk)
        buttons.removeNode()
