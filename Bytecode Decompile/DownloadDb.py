...
class DownloadDb(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrFilename_ptrFilename(self, serverFile, clientFile):
        self.this = libpandaexpress._inP2KOdW1U1(serverFile.this, clientFile.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_ptrRamfile_ptrFilename(self, serverFile, clientFile):
    ...
    def __overloaded_readDb_ptrDownloadDb_ptrFilename_bool(self, file, wantServerInfo):
    ...
    def __overloaded_readDb_ptrDownloadDb_ptrRamfile_bool(self, file, wantServerInfo):
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ramfile.Ramfile):
                    ...
                    if isinstance(_args[1], Filename.Filename):
                        return self.__overloaded_constructor_ptrRamfile_ptrFilename(_args[0], _args[1])
                    else:
                    ...
                    if isinstance(_args[0], Filename.Filename):
                        import Filename
                        if isinstance(_args[1], Filename.Filename):
                            return self.__overloaded_constructor_ptrFilename_ptrFilename(_args[0], _args[1])
                        else:
                            raise TypeError, 'Invalid argument 1, expected one of: <Filename.Filename> '
                    else:
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], Ramfile.Ramfile):
                if isinstance(_args[1], types.IntType):
                    return self.__overloaded_readDb_ptrDownloadDb_ptrRamfile_bool(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                if isinstance(_args[0], Filename.Filename):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_readDb_ptrDownloadDb_ptrFilename_bool(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ramfile.Ramfile> <Filename.Filename> '
