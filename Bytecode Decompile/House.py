...
import DirectNotifyGlobal, Place, PandaObject, StateData, FSM, State, Task, ToontownGlobals, Localizer, AvatarDNA
    ...
    def __init__(self, loader, avId, parentFSMState, doneEvent):
        ...
        self.fsm = FSM.FSM('House', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'stickerBook', 'doorOut', 'DFA', 'teleportOut', 'quest', 'purchase', 'banking']),
