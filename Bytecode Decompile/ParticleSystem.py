import types, libpandaphysics, libpandaphysicsDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, Physical
...
class ParticleSystem(Physical.Physical, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstParticleSystem(self, copy):
        self.this = libpandaphysics._inPKBUA17Eu(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_int(self, poolSize):
            ...
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[0], ParticleSystem):
                        return self.__overloaded_constructor_ptrConstParticleSystem(_args[0])
                    else:
