import types, libpanda, libpandaDowncasts, libpandaexpress, libpandaexpressDowncasts, FFIExternalObject, PandaNode, TextEncoder
...
class TextNode(PandaNode.PandaNode, TextEncoder.TextEncoder, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setTextColor_ptrTextNode_ptrConstLVecBase4f(self, textColor):
        returnValue = libpanda._inPmUk__L_O(self.this, textColor.this)
        return returnValue

    def __overloaded_setTextColor_ptrTextNode_float_float_float_float(self, r, g, b, a):
    ...
    def __overloaded_setFrameColor_ptrTextNode_ptrConstLVecBase4f(self, frameColor):
        returnValue = libpanda._inPmUk_E8Bv(self.this, frameColor.this)
        return returnValue

    def __overloaded_setFrameColor_ptrTextNode_float_float_float_float(self, r, g, b, a):
    ...
    def __overloaded_setCardColor_ptrTextNode_ptrConstLVecBase4f(self, cardColor):
        returnValue = libpanda._inPmUk_wpf9(self.this, cardColor.this)
        return returnValue

    def __overloaded_setCardColor_ptrTextNode_float_float_float_float(self, r, g, b, a):
    ...
    def __overloaded_setShadowColor_ptrTextNode_ptrConstLVecBase4f(self, shadowColor):
        returnValue = libpanda._inPmUk_NFJk(self.this, shadowColor.this)
        return returnValue

    def __overloaded_setShadowColor_ptrTextNode_float_float_float_float(self, r, g, b, a):
    ...
    def __overloaded_setText_ptrTextNode_atomicstring(self, text):
        returnValue = libpanda._inPmUk_hRrL(self.this, text)
        return returnValue

    def __overloaded_setText_ptrTextNode_atomicstring___enum__Encoding(self, text, encoding):
    ...
    def __overloaded_calcWidth_ptrConstTextNode_atomicstring(self, line):
        returnValue = libpanda._inPmUk_33Il(self.this, line)
        return returnValue

    def __overloaded_calcWidth_ptrConstTextNode_int(self, character):
    ...
    def __overloaded_write_ptrConstTextNode_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPmUk_JFnr(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstTextNode_ptrOstream(self, out):
    ...
    def __overloaded_getText_ptrConstTextEncoder(self):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToTextEncoder()
        returnValue = libpandaexpress._inPJoxtp9Te(upcastSelf.this)
        return returnValue

    def __overloaded_getText_ptrConstTextEncoder___enum__Encoding(self, encoding):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToTextEncoder()
    ...
    def __overloaded_getEncodedChar_ptrConstTextEncoder_int(self, index):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToTextEncoder()
        returnValue = libpandaexpress._inPJoxtPGUu(upcastSelf.this, index)
        return returnValue

    def __overloaded_getEncodedChar_ptrConstTextEncoder_int___enum__Encoding(self, index, encoding):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToTextEncoder()
    ...
    def getEncodedChar(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_getEncodedChar_ptrConstTextEncoder_int(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_getEncodedChar_ptrConstTextEncoder_int___enum__Encoding(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
    ...
    def getText(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self.__overloaded_getText_ptrConstTextEncoder()
        else:
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_getText_ptrConstTextEncoder___enum__Encoding(_args[0])
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
            else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstTextNode_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstTextNode_ptrOstream_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def calcWidth(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_calcWidth_ptrConstTextNode_int(_args[0])
            else:
                if isinstance(_args[0], types.StringType):
                    return self.__overloaded_calcWidth_ptrConstTextNode_atomicstring(_args[0])
                else:
    ...
    def setShadowColor(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setShadowColor_ptrTextNode_ptrConstLVecBase4f(_args[0])
            else:
                    ...
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setShadowColor_ptrTextNode_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
    ...
    def setText(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return self.__overloaded_setText_ptrTextNode_atomicstring(_args[0])
            else:
            ...
            if numArgs == 2:
                if isinstance(_args[0], types.StringType):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_setText_ptrTextNode_atomicstring___enum__Encoding(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
    ...
    def setCardColor(self, *_args):
        ...
        if numArgs == 1:
            import VBase4
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setCardColor_ptrTextNode_ptrConstLVecBase4f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase4.VBase4> '
        else:
            if numArgs == 4:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setCardColor_ptrTextNode_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
                                raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def setFrameColor(self, *_args):
        ...
        if numArgs == 1:
            import VBase4
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setFrameColor_ptrTextNode_ptrConstLVecBase4f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase4.VBase4> '
        else:
            if numArgs == 4:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setFrameColor_ptrTextNode_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
                                raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def setTextColor(self, *_args):
        ...
        if numArgs == 1:
            import VBase4
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setTextColor_ptrTextNode_ptrConstLVecBase4f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase4.VBase4> '
        else:
            if numArgs == 4:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                                return self.__overloaded_setTextColor_ptrTextNode_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                            else:
                                raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
