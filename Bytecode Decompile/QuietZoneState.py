...
import ToontownGlobals, DirectNotifyGlobal, PandaObject, StateData, FSM, State
...
class QuietZoneState(PandaObject.PandaObject, StateData.StateData):
    ...
    def enter(self, requestStatus):
        ...
        self.fsm.request('waitForQuietZoneResponse', [requestStatus])
    ...
    def enterWaitForSetZoneResponse(self, requestStatus):
        messenger.send('enterWaitForSetZoneResponse', [requestStatus])
