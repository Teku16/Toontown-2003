...
class UniqueIdAllocator(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_longUnsignedlongint_longUnsignedlongint(self, min, max):
        self.this = libpanda._inPelbozTyP(min, max)
        self.userManagesMemory = 1

    def __overloaded_constructor_longUnsignedlongint(self, min):
    ...
    def __overloaded_output_ptrConstUniqueIdAllocator_ptrOstream_bool(self, os, verbose):
        returnValue = libpanda._inPelboqDb_(self.this, os.this, verbose)
        return returnValue

    def __overloaded_output_ptrConstUniqueIdAllocator_ptrOstream(self, os):
        ...
        if numArgs == 0:
            ...
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    return self.__overloaded_constructor_longUnsignedlongint(_args[0])
                else:
                ...
                if numArgs == 2:
                    if isinstance(_args[0], types.IntType):
                        if isinstance(_args[1], types.IntType):
                            return self.__overloaded_constructor_longUnsignedlongint_longUnsignedlongint(_args[0], _args[1])
                        else:
    ...
    def output(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_output_ptrConstUniqueIdAllocator_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_output_ptrConstUniqueIdAllocator_ptrOstream_bool(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
