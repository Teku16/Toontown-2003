...
class DirectScrolledList(DirectFrame):
    ...
    def __init__(self, parent=aspect2d, **kw):
        ...
        optiondefs = (
         (
          'items', [], None), ('command', None, None), ('extraArgs', [], None), ('itemMakeFunction', None, None), ('itemMakeExtraArgs', [], None), ('numItemsVisible', 1, self.setNumItemsVisible), ('scrollSpeed', 8, self.setScrollSpeed), ('forceHeight', None, self.setForceHeight))
