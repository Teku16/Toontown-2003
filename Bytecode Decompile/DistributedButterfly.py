...
import DirectNotifyGlobal, DistributedObject, FSM, State, NodePath, Mopath, ToontownGlobals, Actor, ButterflyGlobals, RandomNumGen, random
...
class DistributedButterfly(DistributedObject.DistributedObject):
    ...
    id = 0
    wingTypes = (
     'wings_1', 'wings_2', 'wings_3', 'wings_4', 'wings_5', 'wings_6')
    yellowColors = (
