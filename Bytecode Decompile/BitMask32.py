...
class BitMask32(FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_constructor_ptrConstBitMask32(self, copy):
        self.this = libpanda._inPelbo7gMO(copy.this)
        self.userManagesMemory = 1

    def __overloaded_constructor_unsignedint(self, initValue):
    ...
    def __overloaded_outputBinary_ptrConstBitMask32_ptrOstream_int(self, out, spacesEvery):
        returnValue = libpanda._inPelboAOXy(self.this, out.this, spacesEvery)
        return returnValue

    def __overloaded_outputBinary_ptrConstBitMask32_ptrOstream(self, out):
        returnValue = libpanda._inPelbo9596(self.this, out.this)
        return returnValue

    def __overloaded_outputHex_ptrConstBitMask32_ptrOstream_int(self, out, spacesEvery):
        returnValue = libpanda._inPelboHJUc(self.this, out.this, spacesEvery)
        return returnValue

    def __overloaded_outputHex_ptrConstBitMask32_ptrOstream(self, out):
        returnValue = libpanda._inPelbo6TeI(self.this, out.this)
        return returnValue

    def __overloaded_write_ptrConstBitMask32_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPelboA_7k(self.this, out.this, indentLevel)
        return returnValue

    def __overloaded_write_ptrConstBitMask32_ptrOstream(self, out):
            ...
            if numArgs == 1:
                if isinstance(_args[0], types.IntType):
                    ...
                    if isinstance(_args[0], BitMask32):
                        return self.__overloaded_constructor_ptrConstBitMask32(_args[0])
                    else:
    ...
    def outputBinary(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_outputBinary_ptrConstBitMask32_ptrOstream(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_outputBinary_ptrConstBitMask32_ptrOstream_int(_args[0], _args[1])
                    else:
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_write_ptrConstBitMask32_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_write_ptrConstBitMask32_ptrOstream_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def outputHex(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self.__overloaded_outputHex_ptrConstBitMask32_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], Ostream.Ostream):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_outputHex_ptrConstBitMask32_ptrOstream_int(_args[0], _args[1])
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
                else:
                    raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
