...
import FSM, State, Localizer, CatchGameGlobals, Toon, Suit, MinigameAvatarScorePanel, ToontownTimer, ToontownGlobals, CatchGameToonSD, Trajectory, math, DistributedSmoothNode, MinigameGlobals
...
class DistributedCatchGame(DistributedMinigame):
    ...
    DropObjectPlurals = {'apple': Localizer.CatchGameApples, 'orange': Localizer.CatchGameOranges, 'pear': Localizer.CatchGamePears, 'coconut': Localizer.CatchGameCoconuts, 'watermelon': Localizer.CatchGameWatermelons, 'pineapple': Localizer.CatchGamePineapples, 'anvil': Localizer.CatchGameAnvils}
    ...
    def getInstructions(self):
        return Localizer.CatchGameInstructions % {'fruit': self.DropObjectPlurals[self.fruitName], 'badThing': self.DropObjectPlurals['anvil']}
    ...
    def onstage(self):
        ...
        self.toonCollNodes = [self.ltLegsCollNode, self.ltHeadCollNode, self.ltLHandCollNode, self.ltRHandCollNode]
    ...
    def setEveryoneDone(self):
        ...
        if self.fruitsCaught >= self.numFruits:
            ...
            perfectTextSubnode = hidden.attachNewNode(self.__genText(Localizer.CatchGamePerfect))
