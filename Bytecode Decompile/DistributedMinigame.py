...
import ToontownGlobals, DistributedObject, DirectNotifyGlobal, FSM, State, AvatarDNA, MinigameRulesPanel, Toon, RandomNumGen, Localizer, random, MinigameGlobals, DelayDelete, PythonUtil, Emote
...
class DistributedMinigame(DistributedObject.DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.waitingStartLabel = DirectLabel(text=Localizer.MinigameWaitingForOtherPlayers, text_fg=VBase4(1, 1, 1, 1), relief=None, pos=(-0.6, 0, -0.75), scale=0.075)
    ...
    def handleAnnounceGenerate(self, obj):
        ...
        self.__delayDelete = DelayDelete.DelayDelete(self)
    ...
    def setGameReady(self):
        ...
        for avId in self.remoteAvIdList:
            ...
            self.acceptOnce(avatar.uniqueName('disable'), self.handleDisabledAvatar, [avId])
