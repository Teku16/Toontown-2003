...
class Transitions:
    ...
    def fadeIn(self, t=0.5, block=0):
        ...
        if t == 0:
            ...
            task = Task.sequence(self.fade.lerpColor(0, 0, 0, 1, 0, 0, 0, 0, t), Task.Task(self.__fadeInLerpDone))
            if not block:
    ...
    def irisIn(self, t=0.5, block=0):
        ...
        if t == 0:
            ...
            task = Task.sequence(self.iris.lerpScale(0.18, 0.18, 0.18, t, blendType='noBlend'), Task.Task(self.__irisInLerpDone))
            if not block:
