...
class RenderState(TypedWritableReferenceCount.TypedWritableReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_int(attrib1, attrib2, attrib3, attrib4, override):
    ...
    __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_int = staticmethod(__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_int)

    def __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib(attrib1, attrib2, attrib3, attrib4):
    ...
    __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib = staticmethod(__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib)

    def __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_int(attrib1, attrib2, attrib3, override):
    ...
    __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_int = staticmethod(__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_int)

    def __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib(attrib1, attrib2, attrib3):
    ...
    __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib = staticmethod(__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib)

    def __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_int(attrib1, attrib2, override):
    ...
    __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_int = staticmethod(__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_int)

    def __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib(attrib1, attrib2):
    ...
    __overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib = staticmethod(__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib)

    def __overloaded_make_ptrConstRenderAttrib_int(attrib, override):
    ...
    __overloaded_make_ptrConstRenderAttrib_int = staticmethod(__overloaded_make_ptrConstRenderAttrib_int)

    def __overloaded_make_ptrConstRenderAttrib(attrib):
    ...
    __overloaded_make_ptrConstRenderAttrib = staticmethod(__overloaded_make_ptrConstRenderAttrib)
    ...
    def __overloaded_getAttrib_ptrConstRenderState_ptrTypeHandle(self, type):
    ...
    def __overloaded_getAttrib_ptrConstRenderState_int(self, n):
    ...
    def __overloaded_addAttrib_ptrConstRenderState_ptrConstRenderAttrib_int(self, attrib, override):
    ...
    def __overloaded_addAttrib_ptrConstRenderState_ptrConstRenderAttrib(self, attrib):
    ...
    def make(*_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], RenderAttrib.RenderAttrib):
                return RenderState.__overloaded_make_ptrConstRenderAttrib(_args[0])
            else:
            ...
            if numArgs == 2:
                ...
                if isinstance(_args[0], RenderAttrib.RenderAttrib):
                    ...
                    if isinstance(_args[1], types.IntType):
                        return RenderState.__overloaded_make_ptrConstRenderAttrib_int(_args[0], _args[1])
                    else:
                        if isinstance(_args[1], RenderAttrib.RenderAttrib):
                            return RenderState.__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib(_args[0], _args[1])
                        else:
                    ...
                    if isinstance(_args[0], RenderAttrib.RenderAttrib):
                        ...
                        if isinstance(_args[1], RenderAttrib.RenderAttrib):
                            ...
                            if isinstance(_args[2], types.IntType):
                                return RenderState.__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_int(_args[0], _args[1], _args[2])
                            else:
                                if isinstance(_args[2], RenderAttrib.RenderAttrib):
                                    return RenderState.__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib(_args[0], _args[1], _args[2])
                                else:
                            ...
                            if isinstance(_args[1], RenderAttrib.RenderAttrib):
                                ...
                                if isinstance(_args[2], RenderAttrib.RenderAttrib):
                                    ...
                                    if isinstance(_args[3], types.IntType):
                                        return RenderState.__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_int(_args[0], _args[1], _args[2], _args[3])
                                    else:
                                        if isinstance(_args[3], RenderAttrib.RenderAttrib):
                                            return RenderState.__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib(_args[0], _args[1], _args[2], _args[3])
                                        else:
                                    ...
                                    if isinstance(_args[2], RenderAttrib.RenderAttrib):
                                        ...
                                        if isinstance(_args[3], RenderAttrib.RenderAttrib):
                                            if isinstance(_args[4], types.IntType):
                                                return RenderState.__overloaded_make_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_ptrConstRenderAttrib_int(_args[0], _args[1], _args[2], _args[3], _args[4])
                                            else:
    ...
    def getAttrib(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.IntType):
                return self.__overloaded_getAttrib_ptrConstRenderState_int(_args[0])
            else:
                if isinstance(_args[0], TypeHandle.TypeHandle):
                    return self.__overloaded_getAttrib_ptrConstRenderState_ptrTypeHandle(_args[0])
                else:
    ...
    def addAttrib(self, *_args):
        ...
        if numArgs == 1:
            import RenderAttrib
            if isinstance(_args[0], RenderAttrib.RenderAttrib):
                return self.__overloaded_addAttrib_ptrConstRenderState_ptrConstRenderAttrib(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <RenderAttrib.RenderAttrib> '
        else:
            if numArgs == 2:
                ...
                if isinstance(_args[0], RenderAttrib.RenderAttrib):
                    if isinstance(_args[1], types.IntType):
                        return self.__overloaded_addAttrib_ptrConstRenderState_ptrConstRenderAttrib_int(_args[0], _args[1])
                    else:
