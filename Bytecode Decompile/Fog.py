...
class Fog(PandaNode.PandaNode, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded_setColor_ptrFog_ptrConstLVecBase4f(self, color):
        returnValue = libpanda._inPkJyo2g2n(self.this, color.this)
        return returnValue

    def __overloaded_setColor_ptrFog_float_float_float(self, r, g, b):
    ...
    def __overloaded_setLinearOnsetPoint_ptrFog_ptrConstLPoint3f(self, linearOnsetPoint):
        returnValue = libpanda._inPkJyo6RcW(self.this, linearOnsetPoint.this)
        return returnValue

    def __overloaded_setLinearOnsetPoint_ptrFog_float_float_float(self, x, y, z):
    ...
    def __overloaded_setLinearOpaquePoint_ptrFog_ptrConstLPoint3f(self, linearOpaquePoint):
        returnValue = libpanda._inPkJyoEhA1(self.this, linearOpaquePoint.this)
        return returnValue

    def __overloaded_setLinearOpaquePoint_ptrFog_float_float_float(self, x, y, z):
    ...
    def setLinearOpaquePoint(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Point3.Point3):
                return self.__overloaded_setLinearOpaquePoint_ptrFog_ptrConstLPoint3f(_args[0])
            else:
                ...
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setLinearOpaquePoint_ptrFog_float_float_float(_args[0], _args[1], _args[2])
                        else:
    ...
    def setColor(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase4.VBase4):
                return self.__overloaded_setColor_ptrFog_ptrConstLVecBase4f(_args[0])
            else:
            ...
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setColor_ptrFog_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
    ...
    def setLinearOnsetPoint(self, *_args):
        ...
        if numArgs == 1:
            import Point3
            if isinstance(_args[0], Point3.Point3):
                return self.__overloaded_setLinearOnsetPoint_ptrFog_ptrConstLPoint3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Point3.Point3> '
        else:
            if numArgs == 3:
                if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                    if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                        if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                            return self.__overloaded_setLinearOnsetPoint_ptrFog_float_float_float(_args[0], _args[1], _args[2])
                        else:
                            raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
