...
class LOrientationf(Quat.Quat, FFIExternalObject.FFIExternalObject):
    ...
    def __overloaded___mul___ptrConstLOrientationf_ptrConstLOrientationf(self, other):
    ...
    def __overloaded___mul___ptrConstLOrientationf_ptrConstLQuaternionf(self, other):
    ...
    def __mul__(self, *_args):
        ...
        if numArgs == 1:
            import Quat
            if isinstance(_args[0], Quat.Quat):
                return self.__overloaded___mul___ptrConstLOrientationf_ptrConstLQuaternionf(_args[0])
            else:
                if isinstance(_args[0], LOrientationf):
                    return self.__overloaded___mul___ptrConstLOrientationf_ptrConstLOrientationf(_args[0])
                else:
