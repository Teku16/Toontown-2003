...
import math, whrandom, Point3, DirectNotifyGlobal, SuitBattleGlobals, SuitTimings, AvatarDNA, Localizer
...
class SuitBase:
    ...
    def setLevel(self, level):
        self.level = level
        nameWLevel = Localizer.SuitBaseNameWithLevel % {'name': self.name, 'dept': self.getStyleDept(), 'level': self.getActualLevel()}
