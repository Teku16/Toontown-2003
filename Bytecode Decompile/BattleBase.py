...
from Timer import *
import math, DirectNotifyGlobal
TOON_ID_COL = 0
TOON_TRACK_COL = 1
TOON_LVL_COL = 2
TOON_TGT_COL = 3
...
class BattleBase:
    ...
    toonPendingPoints = (
     (
      Point3(-3, -8, 0), -5), (Point3(0, -9, 0), 0), (Point3(3, -8, 0), 5))
    posA = Point3(0, 10, 0)
    ...
    def buildJoinPointList(self, avPos, destPos, toon=0):
        ...
        if toon == 1:
            if nearestP == BattleBase.posE:
                ...
                if BattleBase.toonCwise.count(nearestP) == 1:
